...
public final class StateMaseterService extends Worker {
    ...
    /* JADX INFO: renamed from: com.nic.mparivahan.PushNotification.StateMaseterService$a, reason: from kotlin metadata */
    public static final class Companion {
        ...
        public final void a(Context context) {
            ...
            iy7.c(context).a((ih4) ((ih4.a) new ih4.a(StateMaseterService.class).h(new lx0.a().b(s44.CONNECTED).a())).a());
        }
    }
    ...
    public static final class b implements Callback {
        ...
        public void onResponse(Call call, Response response) {
            ...
            try {
                ...
                Object objFromJson = new Gson().fromJson(strValueOf, (Class<Object>) StateMaster.class);
                Intrinsics.checkNotNullExpressionValue(objFromJson, "fromJson(...)");
                StateMaster stateMaster = (StateMaster) objFromJson;
                if (stateMaster.getStatusCode().equals("MSTR001")) {
                    dl4 dl4Var = new dl4(this.b);
                    dl4Var.l(strValueOf);
                    dl4Var.f(stateMaster.getStates().get(0).isNgmp());
                }
    ...
    public StateMaseterService(Context context, WorkerParameters workerParams) {
    ...
    public final void r(Context context) {
        ...
        VersionService.INSTANCE.a(context).getStateMasterList(aVar.d(ls3VarB, string), (String) objectRef.element).enqueue(new b(objectRef, context));
    }
}
