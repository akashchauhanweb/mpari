...
public final class HexExtensionsKt {
    ...
    public static final int formattedStringLength(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        if (RangesKt___RangesKt.intRangeContains((ClosedRange<Integer>) new IntRange(0, IntCompanionObject.MAX_VALUE), j)) {
            return (int) j;
        }
        throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m226toStringimpl(ULong.m180constructorimpl(j))));
    }
