...
public final class ie {
    ...
    public ie(RelativeLayout relativeLayout, NestedScrollView nestedScrollView, AppCompatTextView appCompatTextView, RecyclerView recyclerView, AppCompatEditText appCompatEditText, ProgressBar progressBar, MyTextView myTextView, AppCompatTextView appCompatTextView2, d47 d47Var, AppCompatTextView appCompatTextView3) {
                                ...
                                if (appCompatTextView2 != null) {
                                    ...
                                    if (viewA != null) {
                                        ...
                                        if (appCompatTextView3 != null) {
                                            return new ie((RelativeLayout) view, nestedScrollView, appCompatTextView, recyclerView, appCompatEditText, progressBar, myTextView, appCompatTextView2, d47VarA, appCompatTextView3);
                                        }
                                    }
                                }
                            }
    ...
    public static ie d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_notice_search_list, viewGroup, false);
        if (z) {
