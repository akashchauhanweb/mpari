...
public final class SaveFireBaseTokenService extends Worker {
    ...
    public SaveFireBaseTokenService(Context context, WorkerParameters workerParams) {
    ...
    public c.a p() {
        try {
            StringsKt__StringsJVMKt.equals(new v82(this.context).a(), "0", true);
        } catch (Exception e) {
            e.printStackTrace();
