...
public abstract class yw1 {
    ...
    public static Drawable d(Drawable drawable, ColorStateList colorStateList, PorterDuff.Mode mode, boolean z) {
        if (drawable == null) {
            return null;
        }
    ...
    public static ColorStateList f(Drawable drawable) {
        ...
        if (Build.VERSION.SDK_INT < 29 || !uw1.a(drawable)) {
            return null;
        }
        return vw1.a(drawable).getColorStateList();
    }
