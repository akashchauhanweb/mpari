...
public final /* data */ class StateMaster {
    ...
    public static /* synthetic */ StateMaster copy$default(StateMaster stateMaster, ArrayList arrayList, String str, String str2, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public final StateMaster copy(ArrayList<State> states, String statusCode, String statusDesc) {
        Intrinsics.checkNotNullParameter(states, "states");
        Intrinsics.checkNotNullParameter(statusCode, "statusCode");
        Intrinsics.checkNotNullParameter(statusDesc, "statusDesc");
        return new StateMaster(states, statusCode, statusDesc);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.states, stateMaster.states) && Intrinsics.areEqual(this.statusCode, stateMaster.statusCode) && Intrinsics.areEqual(this.statusDesc, stateMaster.statusDesc);
    }
