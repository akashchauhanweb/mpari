...
public final /* data */ class TempSubmitResponse implements Serializable {
    ...
    public final TempSubmitResponse copy(ApiMessage apiMessage, Data data) {
        return new TempSubmitResponse(apiMessage, data);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TempSubmitResponse)) {
            return false;
        }
        TempSubmitResponse tempSubmitResponse = (TempSubmitResponse) other;
        return Intrinsics.areEqual(this.apiMessage, tempSubmitResponse.apiMessage) && Intrinsics.areEqual(this.data, tempSubmitResponse.data);
    }
