...
public class URangesKt___URangesKt {
    ...
    public static final short m1259coerceAtLeast5PvTz6A(short s, short s2) {
    ...
    public static final int m1260coerceAtLeastJ1ME1BU(int i, int i2) {
    ...
    public static final byte m1261coerceAtLeastKr8caGY(byte b, byte b2) {
    ...
    public static final long m1262coerceAtLeasteb3DHEI(long j, long j2) {
    ...
    public static final short m1263coerceAtMost5PvTz6A(short s, short s2) {
        return Intrinsics.compare(s & UShort.MAX_VALUE, 65535 & s2) > 0 ? s2 : s;
    }
    ...
    public static final int m1264coerceAtMostJ1ME1BU(int i, int i2) {
        return Integer.compareUnsigned(i, i2) > 0 ? i2 : i;
    }
    ...
    public static final byte m1265coerceAtMostKr8caGY(byte b, byte b2) {
        return Intrinsics.compare(b & UByte.MAX_VALUE, b2 & UByte.MAX_VALUE) > 0 ? b2 : b;
    }
    ...
    public static final long m1266coerceAtMosteb3DHEI(long j, long j2) {
        return Long.compareUnsigned(j, j2) > 0 ? j2 : j;
    }
    ...
    public static final long m1267coerceInJPwROB0(long j, ClosedRange<ULong> range) {
        Intrinsics.checkNotNullParameter(range, "range");
        if (range instanceof ClosedFloatingPointRange) {
            return ((ULong) RangesKt___RangesKt.coerceIn(ULong.m174boximpl(j), (ClosedFloatingPointRange<ULong>) range)).getData();
        }
        if (!range.isEmpty()) {
    ...
    public static final short m1268coerceInVKSA0NQ(short s, short s2, short s3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) UShort.m331toStringimpl(s3)) + " is less than minimum " + ((Object) UShort.m331toStringimpl(s2)) + '.');
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: coerceIn-WZ9TVnA, reason: not valid java name */
    public static final int m1269coerceInWZ9TVnA(int i, int i2, int i3) {
        if (Integer.compareUnsigned(i2, i3) <= 0) {
            return Integer.compareUnsigned(i, i2) < 0 ? i2 : Integer.compareUnsigned(i, i3) > 0 ? i3 : i;
        }
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) UInt.m147toStringimpl(i3)) + " is less than minimum " + ((Object) UInt.m147toStringimpl(i2)) + '.');
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: coerceIn-b33U2AM, reason: not valid java name */
    public static final byte m1270coerceInb33U2AM(byte b, byte b2, byte b3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) UByte.m68toStringimpl(b3)) + " is less than minimum " + ((Object) UByte.m68toStringimpl(b2)) + '.');
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: coerceIn-sambcqE, reason: not valid java name */
    public static final long m1271coerceInsambcqE(long j, long j2, long j3) {
        if (Long.compareUnsigned(j2, j3) <= 0) {
            return Long.compareUnsigned(j, j2) < 0 ? j2 : Long.compareUnsigned(j, j3) > 0 ? j3 : j;
        }
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) ULong.m226toStringimpl(j3)) + " is less than minimum " + ((Object) ULong.m226toStringimpl(j2)) + '.');
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: coerceIn-wuiCnnA, reason: not valid java name */
    public static final int m1272coerceInwuiCnnA(int i, ClosedRange<UInt> range) {
        Intrinsics.checkNotNullParameter(range, "range");
        if (range instanceof ClosedFloatingPointRange) {
            return ((UInt) RangesKt___RangesKt.coerceIn(UInt.m95boximpl(i), (ClosedFloatingPointRange<UInt>) range)).getData();
        }
        if (!range.isEmpty()) {
    ...
    public static final boolean m1273contains68kG9v0(UIntRange contains, byte b) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1244containsWZ4Q5Ns(UInt.m101constructorimpl(b & UByte.MAX_VALUE));
    }
    ...
    private static final boolean m1274containsGYNo2lE(ULongRange contains, ULong uLong) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return uLong != null && contains.m1253containsVKZWuLQ(uLong.getData());
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: contains-Gab390E, reason: not valid java name */
    public static final boolean m1275containsGab390E(ULongRange contains, int i) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1253containsVKZWuLQ(ULong.m180constructorimpl(((long) i) & 4294967295L));
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: contains-ULb-yJY, reason: not valid java name */
    public static final boolean m1276containsULbyJY(ULongRange contains, byte b) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1253containsVKZWuLQ(ULong.m180constructorimpl(((long) b) & 255));
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: contains-ZsK3CEQ, reason: not valid java name */
    public static final boolean m1277containsZsK3CEQ(UIntRange contains, short s) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1244containsWZ4Q5Ns(UInt.m101constructorimpl(s & UShort.MAX_VALUE));
    }
    ...
    private static final boolean m1278containsbiwQdVI(UIntRange contains, UInt uInt) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return uInt != null && contains.m1244containsWZ4Q5Ns(uInt.getData());
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: contains-fz5IDCE, reason: not valid java name */
    public static final boolean m1279containsfz5IDCE(UIntRange contains, long j) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return ULong.m180constructorimpl(j >>> 32) == 0 && contains.m1244containsWZ4Q5Ns(UInt.m101constructorimpl((int) j));
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: contains-uhHAxoY, reason: not valid java name */
    public static final boolean m1280containsuhHAxoY(ULongRange contains, short s) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1253containsVKZWuLQ(ULong.m180constructorimpl(((long) s) & 65535));
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: downTo-5PvTz6A, reason: not valid java name */
    public static final UIntProgression m1281downTo5PvTz6A(short s, short s2) {
        return UIntProgression.INSTANCE.m1241fromClosedRangeNkh28Cs(UInt.m101constructorimpl(s & UShort.MAX_VALUE), UInt.m101constructorimpl(s2 & UShort.MAX_VALUE), -1);
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: downTo-J1ME1BU, reason: not valid java name */
    public static final UIntProgression m1282downToJ1ME1BU(int i, int i2) {
        return UIntProgression.INSTANCE.m1241fromClosedRangeNkh28Cs(i, i2, -1);
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: downTo-Kr8caGY, reason: not valid java name */
    public static final UIntProgression m1283downToKr8caGY(byte b, byte b2) {
        return UIntProgression.INSTANCE.m1241fromClosedRangeNkh28Cs(UInt.m101constructorimpl(b & UByte.MAX_VALUE), UInt.m101constructorimpl(b2 & UByte.MAX_VALUE), -1);
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: downTo-eb3DHEI, reason: not valid java name */
    public static final ULongProgression m1284downToeb3DHEI(long j, long j2) {
        return ULongProgression.INSTANCE.m1250fromClosedRange7ftBX0g(j, j2, -1L);
    }
    ...
    public static final UInt firstOrNull(UIntProgression uIntProgression) {
        ...
        return UInt.m95boximpl(uIntProgression.getFirst());
    }
    ...
    public static final UInt lastOrNull(UIntProgression uIntProgression) {
        ...
        return UInt.m95boximpl(uIntProgression.getLast());
    }
    ...
    public static final UIntProgression reversed(UIntProgression uIntProgression) {
        Intrinsics.checkNotNullParameter(uIntProgression, "<this>");
        return UIntProgression.INSTANCE.m1241fromClosedRangeNkh28Cs(uIntProgression.getLast(), uIntProgression.getFirst(), -uIntProgression.getStep());
    }
    ...
    public static final UIntProgression step(UIntProgression uIntProgression, int i) {
        ...
        return companion.m1241fromClosedRangeNkh28Cs(first, last, i);
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: until-5PvTz6A, reason: not valid java name */
    public static final UIntRange m1285until5PvTz6A(short s, short s2) {
    ...
    public static UIntRange m1286untilJ1ME1BU(int i, int i2) {
        return Integer.compareUnsigned(i2, 0) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange(i, UInt.m101constructorimpl(i2 - 1), null);
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    /* JADX INFO: renamed from: until-Kr8caGY, reason: not valid java name */
    public static final UIntRange m1287untilKr8caGY(byte b, byte b2) {
    ...
    public static ULongRange m1288untileb3DHEI(long j, long j2) {
        return Long.compareUnsigned(j2, 0L) <= 0 ? ULongRange.INSTANCE.getEMPTY() : new ULongRange(j, ULong.m180constructorimpl(j2 - ULong.m180constructorimpl(((long) 1) & 4294967295L)), null);
    }
    ...
    public static final ULong firstOrNull(ULongProgression uLongProgression) {
        ...
        return ULong.m174boximpl(uLongProgression.getFirst());
    }
    ...
    public static final ULong lastOrNull(ULongProgression uLongProgression) {
        ...
        return ULong.m174boximpl(uLongProgression.getLast());
    }
    ...
    public static final ULongProgression reversed(ULongProgression uLongProgression) {
        Intrinsics.checkNotNullParameter(uLongProgression, "<this>");
        return ULongProgression.INSTANCE.m1250fromClosedRange7ftBX0g(uLongProgression.getLast(), uLongProgression.getFirst(), -uLongProgression.getStep());
    }
    ...
    public static final UInt randomOrNull(UIntRange uIntRange, Random random) {
        ...
        return UInt.m95boximpl(URandomKt.nextUInt(random, uIntRange));
    }
    ...
    public static final ULongProgression step(ULongProgression uLongProgression, long j) {
        ...
        return companion.m1250fromClosedRange7ftBX0g(first, last, j);
    }
    ...
    public static final ULong randomOrNull(ULongRange uLongRange, Random random) {
        ...
        return ULong.m174boximpl(URandomKt.nextULong(random, uLongRange));
    }
}
