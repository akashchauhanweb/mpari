...
public final /* data */ class IdpGenSubmitStaging {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof IdpGenSubmitStaging)) {
            return false;
        }
        IdpGenSubmitStaging idpGenSubmitStaging = (IdpGenSubmitStaging) other;
        return Intrinsics.areEqual(this.dlno, idpGenSubmitStaging.dlno) && Intrinsics.areEqual(this.dob, idpGenSubmitStaging.dob) && Intrinsics.areEqual(this.rtoCodeDLTr, idpGenSubmitStaging.rtoCodeDLTr) && Intrinsics.areEqual(this.selectedDLSerList, idpGenSubmitStaging.selectedDLSerList) && Intrinsics.areEqual(this.pofbirth, idpGenSubmitStaging.pofbirth) && Intrinsics.areEqual(this.country, idpGenSubmitStaging.country) && Intrinsics.areEqual(this.passno, idpGenSubmitStaging.passno) && Intrinsics.areEqual(this.passvaltill, idpGenSubmitStaging.passvaltill) && Intrinsics.areEqual(this.visano, idpGenSubmitStaging.visano) && Intrinsics.areEqual(this.visavaltill, idpGenSubmitStaging.visavaltill) && Intrinsics.areEqual(this.cov_req, idpGenSubmitStaging.cov_req) && Intrinsics.areEqual(this.tovisit, idpGenSubmitStaging.tovisit) && Intrinsics.areEqual(this.iscountryrestricted, idpGenSubmitStaging.iscountryrestricted) && Intrinsics.areEqual(this.countryRestrictedReason, idpGenSubmitStaging.countryRestrictedReason) && Intrinsics.areEqual(this.isDlSerdisqualified, idpGenSubmitStaging.isDlSerdisqualified) && Intrinsics.areEqual(this.dlSerdisqualifiedReason, idpGenSubmitStaging.dlSerdisqualifiedReason) && Intrinsics.areEqual(this.forAdd1, idpGenSubmitStaging.forAdd1) && Intrinsics.areEqual(this.forAdd2, idpGenSubmitStaging.forAdd2) && Intrinsics.areEqual(this.forAdd3, idpGenSubmitStaging.forAdd3) && Intrinsics.areEqual(this.forAddPinCode, idpGenSubmitStaging.forAddPinCode) && Intrinsics.areEqual(this.forNationMobNum, idpGenSubmitStaging.forNationMobNum) && Intrinsics.areEqual(this.emailID, idpGenSubmitStaging.emailID) && Intrinsics.areEqual(this.appliedIdpfromIndEmb, idpGenSubmitStaging.appliedIdpfromIndEmb) && Intrinsics.areEqual(this.indEmbName, idpGenSubmitStaging.indEmbName) && Intrinsics.areEqual(this.embPlace, idpGenSubmitStaging.embPlace) && Intrinsics.areEqual(this.dateOfVerifEmb, idpGenSubmitStaging.dateOfVerifEmb) && Intrinsics.areEqual(this.embEndorseNo, idpGenSubmitStaging.embEndorseNo) && Intrinsics.areEqual(this.idpcountryapplyfrom, idpGenSubmitStaging.idpcountryapplyfrom) && Intrinsics.areEqual(this.agentId, idpGenSubmitStaging.agentId) && Intrinsics.areEqual(this.agentPwd, idpGenSubmitStaging.agentPwd) && Intrinsics.areEqual(this.agentIpAddress, idpGenSubmitStaging.agentIpAddress) && Intrinsics.areEqual(this.agentServiceName, idpGenSubmitStaging.agentServiceName) && Intrinsics.areEqual(this.presHouseNo, idpGenSubmitStaging.presHouseNo) && Intrinsics.areEqual(this.presStreet, idpGenSubmitStaging.presStreet) && Intrinsics.areEqual(this.presLocation, idpGenSubmitStaging.presLocation) && Intrinsics.areEqual(this.presVillageOrTown, idpGenSubmitStaging.presVillageOrTown) && Intrinsics.areEqual(this.presSubDistrict, idpGenSubmitStaging.presSubDistrict) && Intrinsics.areEqual(this.presDistrict, idpGenSubmitStaging.presDistrict) && Intrinsics.areEqual(this.presState, idpGenSubmitStaging.presState) && Intrinsics.areEqual(this.presPincode, idpGenSubmitStaging.presPincode) && Intrinsics.areEqual(this.perHouseNo, idpGenSubmitStaging.perHouseNo) && Intrinsics.areEqual(this.perStreet, idpGenSubmitStaging.perStreet) && Intrinsics.areEqual(this.perLocation, idpGenSubmitStaging.perLocation) && Intrinsics.areEqual(this.permVillageOrTown, idpGenSubmitStaging.permVillageOrTown) && Intrinsics.areEqual(this.perSubDistrict, idpGenSubmitStaging.perSubDistrict) && Intrinsics.areEqual(this.perDistrict, idpGenSubmitStaging.perDistrict) && Intrinsics.areEqual(this.perState, idpGenSubmitStaging.perState) && Intrinsics.areEqual(this.perPinCode, idpGenSubmitStaging.perPinCode) && Intrinsics.areEqual(this.mobileNumber, idpGenSubmitStaging.mobileNumber) && Intrinsics.areEqual(this.eKYCId, idpGenSubmitStaging.eKYCId) && Intrinsics.areEqual(this.eKYCOpted, idpGenSubmitStaging.eKYCOpted) && Intrinsics.areEqual(this.eKYCGender, idpGenSubmitStaging.eKYCGender) && Intrinsics.areEqual(this.eKYCapplicantPhoto, idpGenSubmitStaging.eKYCapplicantPhoto);
    }
