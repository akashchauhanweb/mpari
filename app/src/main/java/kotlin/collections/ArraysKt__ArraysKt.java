        ...
        for (int i = 0; i < length; i++) {
            ...
            if (objArr != objArr2) {
                ...
                if ((objArr instanceof Object[]) && (objArr2 instanceof Object[])) {
                    ...
                    if (!UArraysKt___UArraysKt.m583contentEqualskV0jMPg(((UByteArray) objArr).getStorage(), ((UByteArray) objArr2).getStorage())) {
                        return false;
                    }
                } else if ((objArr instanceof UShortArray) && (objArr2 instanceof UShortArray)) {
                    if (!UArraysKt___UArraysKt.m581contentEqualsFGO6Aew(((UShortArray) objArr).getStorage(), ((UShortArray) objArr2).getStorage())) {
                        return false;
                    }
                } else if ((objArr instanceof UIntArray) && (objArr2 instanceof UIntArray)) {
                    if (!UArraysKt___UArraysKt.m582contentEqualsKJPZfPQ(((UIntArray) objArr).getStorage(), ((UIntArray) objArr2).getStorage())) {
                        return false;
                    }
                } else if ((objArr instanceof ULongArray) && (objArr2 instanceof ULongArray)) {
                    if (!UArraysKt___UArraysKt.m584contentEqualslec5QzE(((ULongArray) objArr).getStorage(), ((ULongArray) objArr2).getStorage())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (objArr == 0) {
                ...
                sb.append(UArraysKt___UArraysKt.m589contentToString2csIQuQ(((UByteArray) objArr).getStorage()));
            } else if (objArr instanceof UShortArray) {
                sb.append(UArraysKt___UArraysKt.m591contentToStringd6D3K8(((UShortArray) objArr).getStorage()));
            } else if (objArr instanceof UIntArray) {
                sb.append(UArraysKt___UArraysKt.m590contentToStringXUkPCBk(((UIntArray) objArr).getStorage()));
            } else if (objArr instanceof ULongArray) {
                sb.append(UArraysKt___UArraysKt.m592contentToStringuLth9ew(((ULongArray) objArr).getStorage()));
            } else {
