...
public final class UIntArray implements Collection<UInt>, KMappedMarker {
    ...
    public static int[] m156constructorimpl(int[] storage) {
        Intrinsics.checkNotNullParameter(storage, "storage");
        return storage;
    }

    /* JADX INFO: renamed from: containsAll-impl, reason: not valid java name */
    public static boolean m158containsAllimpl(int[] iArr, Collection<UInt> elements) {
    ...
    public static final int m161getpVg5ArA(int[] iArr, int i) {
        return UInt.m101constructorimpl(iArr[i]);
    }

    /* JADX INFO: renamed from: getSize-impl, reason: not valid java name */
    public static int m162getSizeimpl(int[] iArr) {
        return iArr.length;
    }
    ...
    public static boolean m164isEmptyimpl(int[] iArr) {
        return iArr.length == 0;
    }

    /* JADX INFO: renamed from: iterator-impl, reason: not valid java name */
    public static java.util.Iterator<UInt> m165iteratorimpl(int[] iArr) {
        return new Iterator(iArr);
    }

    /* JADX INFO: renamed from: set-VXSXFK8, reason: not valid java name */
    public static final void m166setVXSXFK8(int[] iArr, int i, int i2) {
        iArr[i] = i2;
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m169containsWZ4Q5Ns(((UInt) obj).getData());
        }
        return false;
    }

    /* JADX INFO: renamed from: contains-WZ4Q5Ns, reason: not valid java name */
    public boolean m169containsWZ4Q5Ns(int i) {
        return m157containsWZ4Q5Ns(this.storage, i);
    }
    ...
    public static int[] m155constructorimpl(int i) {
        return m156constructorimpl(new int[i]);
    }

    /* JADX INFO: renamed from: contains-WZ4Q5Ns, reason: not valid java name */
    public static boolean m157containsWZ4Q5Ns(int[] iArr, int i) {
