...
public final class ie5 {
    ...
    public static final je5.a a(Context context, Class klass, String str) {
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(klass, "klass");
        if (true ^ (str == null || StringsKt__StringsJVMKt.isBlank(str))) {
            return new je5.a(context, klass, str);
        }
    ...
    public static final je5.a c(Context context, Class klass) {
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(klass, "klass");
        return new je5.a(context, klass, null);
    }
}
