...
public class ee4 {
    ...
    public static boolean t(Bundle bundle) {
        return VContant.MAINSCREEN.equals(bundle.getString("gcm.n.e")) || VContant.MAINSCREEN.equals(bundle.getString(v("gcm.n.e")));
    }
    ...
    public boolean a(String str) {
        String strP = p(str);
        return VContant.MAINSCREEN.equals(strP) || Boolean.parseBoolean(strP);
    }
