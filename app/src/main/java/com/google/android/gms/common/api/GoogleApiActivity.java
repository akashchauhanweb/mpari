...
import com.zepto.ak2;
import com.zepto.iu4;
import com.zepto.lw0;
import com.zepto.xj2;
...
public class GoogleApiActivity extends Activity implements DialogInterface.OnCancelListener {
    ...
    public final void b() {
        ...
        if (pendingIntent == null) {
            xj2.l().m(this, ((Integer) iu4.i(num)).intValue(), 2, this);
            this.a = 1;
            return;
        }
        try {
            ...
            if (extras.getBoolean("notify_manager", true)) {
                ak2.x(this).H(new lw0(22, null), getIntent().getIntExtra("failing_client_id", -1));
            } else {
    ...
    public final void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i == 1) {
            ...
            setResult(i2, intent);
            if (booleanExtra) {
                ak2 ak2VarX = ak2.x(this);
                if (i2 == -1) {
                    ak2VarX.a();
                } else if (i2 == 0) {
                    ak2VarX.H(new lw0(13, null), getIntent().getIntExtra("failing_client_id", -1));
                }
            }
        } else if (i == 2) {
            this.a = 0;
