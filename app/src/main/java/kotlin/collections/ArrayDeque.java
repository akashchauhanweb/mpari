...
public final class ArrayDeque<E> extends AbstractMutableList<E> {
    ...
    public static final class Companion {
        ...
        public final int newCapacity$kotlin_stdlib(int oldCapacity, int minCapacity) {
            ...
            return i - ArrayDeque.maxArraySize > 0 ? minCapacity > ArrayDeque.maxArraySize ? IntCompanionObject.MAX_VALUE : ArrayDeque.maxArraySize : i;
        }
    }
    ...
    public boolean addAll(int index, Collection<? extends E> elements) {
        ...
        if (index < ((size() + 1) >> 1)) {
            ...
            if (iPositiveMod2 >= iPositiveMod) {
                ...
                ArraysKt___ArraysJvmKt.copyInto(objArr8, objArr8, size, 0, iPositiveMod);
                Object[] objArr9 = this.elementData;
                if (i3 >= objArr9.length) {
                    ArraysKt___ArraysJvmKt.copyInto(objArr9, objArr9, i3 - objArr9.length, iPositiveMod2, objArr9.length);
                } else {
                    ArraysKt___ArraysJvmKt.copyInto(objArr9, objArr9, 0, objArr9.length - size, objArr9.length);
                    Object[] objArr10 = this.elementData;
                    ArraysKt___ArraysJvmKt.copyInto(objArr10, objArr10, i3, iPositiveMod2, objArr10.length - size);
                }
            } else {
                int i4 = size + iPositiveMod;
                Object[] objArr11 = this.elementData;
                if (i4 <= objArr11.length) {
                    ArraysKt___ArraysJvmKt.copyInto(objArr11, objArr11, i3, iPositiveMod2, iPositiveMod);
                } else if (i3 >= objArr11.length) {
                    ArraysKt___ArraysJvmKt.copyInto(objArr11, objArr11, i3 - objArr11.length, iPositiveMod2, iPositiveMod);
                } else {
                    int length3 = iPositiveMod - (i4 - objArr11.length);
                    ArraysKt___ArraysJvmKt.copyInto(objArr11, objArr11, 0, length3, iPositiveMod);
                    Object[] objArr12 = this.elementData;
                    ArraysKt___ArraysJvmKt.copyInto(objArr12, objArr12, i3, iPositiveMod2, length3);
                }
            }
