...
public abstract class jr7 {
    ...
    public static void c(ViewParent viewParent, View view, int i, int i2, int[] iArr, int i3) {
        if (viewParent instanceof q34) {
            ((q34) viewParent).j(view, i, i2, iArr, i3);
            return;
        }
        if (i3 == 0) {
            try {
    ...
    public static void d(ViewParent viewParent, View view, int i, int i2, int i3, int i4, int i5, int[] iArr) {
        if (viewParent instanceof r34) {
            ((r34) viewParent).m(view, i, i2, i3, i4, i5, iArr);
            return;
        }
        iArr[0] = iArr[0] + i3;
        iArr[1] = iArr[1] + i4;
        if (viewParent instanceof q34) {
            ((q34) viewParent).n(view, i, i2, i3, i4, i5);
            return;
        }
        if (i5 == 0) {
            try {
    ...
    public static void e(ViewParent viewParent, View view, View view2, int i, int i2) {
        if (viewParent instanceof q34) {
            ((q34) viewParent).h(view, view2, i, i2);
            return;
        }
        if (i2 == 0) {
            try {
    ...
    public static boolean f(ViewParent viewParent, View view, View view2, int i, int i2) {
        if (viewParent instanceof q34) {
            return ((q34) viewParent).o(view, view2, i, i2);
        }
        if (i2 != 0) {
            return false;
        }
