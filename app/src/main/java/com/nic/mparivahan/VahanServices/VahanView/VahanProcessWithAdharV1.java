...
public final class VahanProcessWithAdharV1 extends pq {
    ...
    public static final class a extends Lambda implements Function1 {
        ...
        public final void a(EkycVerifyResponse ekycVerifyResponse) {
            ...
            DOEkyc dOEkyc7;
            DOEkyc dOEkyc8;
            VahanProcessWithAdharV1.this.M1().dismiss();
            if (ekycVerifyResponse == null) {
                VahanProcessWithAdharV1.this.M1().dismiss();
                VahanProcessWithAdharV1 vahanProcessWithAdharV1 = VahanProcessWithAdharV1.this;
                vahanProcessWithAdharV1.i2(vahanProcessWithAdharV1, "Unable to verify the request, Please try after some time");
                return;
            }
            ...
            if (apiMessage == null || apiMessage.getStatusCode() != 200) {
                ...
                VahanProcessWithAdharV1 vahanProcessWithAdharV12 = VahanProcessWithAdharV1.this;
                ApiMessage apiMessage2 = ekycVerifyResponse.getApiMessage();
                vahanProcessWithAdharV12.i2(vahanProcessWithAdharV12, String.valueOf(apiMessage2 != null ? apiMessage2.getDeveloperMessage() : null));
                return;
            }
            ...
            if (StringsKt__StringsJVMKt.equals(String.valueOf(dOAadhaarResponse2 != null ? dOAadhaarResponse2.getStatus() : null), "Y", true)) {
                try {
                    new vh7(VahanProcessWithAdharV1.this).f(VahanProcessWithAdharV1.this.txnNo);
                    if (String.valueOf((dOAadhaarResponse2 == null || (dOEkyc8 = dOAadhaarResponse2.getDOEkyc()) == null) ? null : dOEkyc8.getName()).length() != 0) {
                        VahanProcessWithAdharV1.this.r2(String.valueOf((dOAadhaarResponse2 == null || (dOEkyc = dOAadhaarResponse2.getDOEkyc()) == null) ? null : dOEkyc.getName()));
                    }
                    VahanProcessWithAdharV1 vahanProcessWithAdharV13 = VahanProcessWithAdharV1.this;
                    ...
                    vahanProcessWithAdharV13.l2(sb.toString());
    ...
    public static final class c extends Lambda implements Function1 {
        ...
        public final void a(Boolean bool) {
            if (VahanProcessWithAdharV1.this.M1().isShowing()) {
                VahanProcessWithAdharV1.this.M1().dismiss();
            }
            Intrinsics.checkNotNull(bool);
            if (!bool.booleanValue()) {
                VahanProcessWithAdharV1 vahanProcessWithAdharV1 = VahanProcessWithAdharV1.this;
                vahanProcessWithAdharV1.i2(vahanProcessWithAdharV1, "Unable to verify the Aadhaar, Please try after some time");
                return;
            }
            ld7 ld7VarS1 = VahanProcessWithAdharV1.this.S1();
            VahanProcessWithAdharV1 vahanProcessWithAdharV12 = VahanProcessWithAdharV1.this;
            ld7VarS1.n(vahanProcessWithAdharV12, vahanProcessWithAdharV12.R1());
            ld7 ld7VarS12 = VahanProcessWithAdharV1.this.S1();
            VahanProcessWithAdharV1 vahanProcessWithAdharV13 = VahanProcessWithAdharV1.this;
            ld7VarS12.p1(vahanProcessWithAdharV13, vahanProcessWithAdharV13.R1());
        }
    ...
    public static final class d extends Lambda implements Function1 {
        ...
        public final void invoke(String str) {
            ...
            if (VahanProcessWithAdharV1.this.getD() != null && (d = VahanProcessWithAdharV1.this.getD()) != null) {
                d.dismiss();
            }
            VahanProcessWithAdharV1 vahanProcessWithAdharV12 = VahanProcessWithAdharV1.this;
            vahanProcessWithAdharV12.i2(vahanProcessWithAdharV12, str.toString());
        }
    }
        ...
        public final void a(ApFacelessCheckModel apFacelessCheckModel) {
            ...
            try {
                ...
                if (facelesswithaadharonly != null && facelesswithaadharonly.length() != 0) {
                    ...
                    if (arrayList.contains(VContant.INSTANCE.g(VahanProcessWithAdharV1.this.getServiceSelection_HashMap()))) {
                        VahanProcessWithAdharV1 vahanProcessWithAdharV1 = VahanProcessWithAdharV1.this;
                        vahanProcessWithAdharV1.k2(true, vahanProcessWithAdharV1.getOwner_name_addhaar(), VahanProcessWithAdharV1.this.getAddress());
                        return;
                    } else {
                        VahanProcessWithAdharV1 vahanProcessWithAdharV12 = VahanProcessWithAdharV1.this;
                        vahanProcessWithAdharV12.k2(true, vahanProcessWithAdharV12.getOwner_name_addhaar(), VahanProcessWithAdharV1.this.getAddress());
                        return;
                    }
                }
                VahanProcessWithAdharV1 vahanProcessWithAdharV13 = VahanProcessWithAdharV1.this;
                vahanProcessWithAdharV13.k2(true, vahanProcessWithAdharV13.getOwner_name_addhaar(), VahanProcessWithAdharV1.this.getAddress());
            } catch (Exception e) {
                VahanProcessWithAdharV1 vahanProcessWithAdharV14 = VahanProcessWithAdharV1.this;
                vahanProcessWithAdharV14.k2(true, vahanProcessWithAdharV14.getOwner_name_addhaar(), VahanProcessWithAdharV1.this.getAddress());
                e.printStackTrace();
            }
        }
    ...
    public static final void A2(VahanProcessWithAdharV1 this$0, TextView time_text, TextView resendOtp, View view) {
    ...
    public static final void B2(EditText enterOtp, VahanProcessWithAdharV1 this$0, View view) {
    ...
    public static final void D2(VahanProcessWithAdharV1 this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public static final void T1(VahanProcessWithAdharV1 this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.onBackPressed();
    }

    public static final void U1(VahanProcessWithAdharV1 this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.h2();
    }

    public static final void V1(VahanProcessWithAdharV1 this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.F1().f.setText("");
    }

    public static final void W1(VahanProcessWithAdharV1 this$0, String str) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.M1().dismiss();
        this$0.k2(true, this$0.owner_name_addhaar, this$0.address);
    }

    public static final void X1(VahanProcessWithAdharV1 this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        if (this$0.F1().C.isChecked()) {
            this$0.type = "V";
        }
    ...
    public static final void Y1(VahanProcessWithAdharV1 this$0, eKycResponse ekycresponse) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.M1().dismiss();
        try {
    ...
    public static final void Z1(VahanProcessWithAdharV1 this$0, String str) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.M1().dismiss();
        this$0.i2(this$0, "Unable to process the request, Please try after some time");
    }

    public static final void a2(VahanProcessWithAdharV1 this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public static final void b2(VahanProcessWithAdharV1 this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.F1().i.getText().clear();
    }

    public static final void c2(VahanProcessWithAdharV1 this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.qe7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                VahanProcessWithAdharV1.d2(dialog, view2);
            }
        });
    ...
    public static final void e2(VahanProcessWithAdharV1 this$0, CompoundButton compoundButton, boolean z) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        if (z) {
    ...
    public static final void f2(VahanProcessWithAdharV1 this$0, CompoundButton compoundButton, boolean z) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        if (z) {
            this$0.F1().c.setChecked(false);
            this$0.F1().C.setChecked(true);
    ...
    public static final void g2(VahanProcessWithAdharV1 this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public final void i2(Context context, String message) {
        ...
        ((TextView) viewFindViewById2).setOnClickListener(new View.OnClickListener() { // from class: com.zepto.pe7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VahanProcessWithAdharV1.j2(dialog, view);
            }
        });
        dialog.show();
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        F1().v.f.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.ge7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VahanProcessWithAdharV1.T1(this.a, view);
            }
        });
        F1().v.g.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.ue7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VahanProcessWithAdharV1.U1(this.a, view);
            }
        });
        p2((f47) new z(this, new em7(new e47(O1()))).a(f47.class));
        x2((ld7) new z(this, new kd7(new jd7(N1()))).a(ld7.class));
        F1().y.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.ve7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VahanProcessWithAdharV1.a2(this.a, view);
            }
        });
        F1().w.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.we7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VahanProcessWithAdharV1.b2(this.a, view);
            }
        });
        F1().t.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.xe7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VahanProcessWithAdharV1.c2(this.a, view);
            }
        });
        F1().c.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.zepto.ye7
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                VahanProcessWithAdharV1.e2(this.a, compoundButton, z);
            }
        });
        F1().C.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.zepto.ze7
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                VahanProcessWithAdharV1.f2(this.a, compoundButton, z);
            }
        });
        F1().r.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.he7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VahanProcessWithAdharV1.g2(this.a, view);
            }
        });
        F1().x.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.ie7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VahanProcessWithAdharV1.V1(this.a, view);
            }
        });
        ...
        S1().v().g(this, new mf4() { // from class: com.zepto.je7
            @Override // com.zepto.mf4
            public final void a(Object obj) {
                VahanProcessWithAdharV1.W1(this.a, (String) obj);
            }
        });
        F1().p.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.re7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VahanProcessWithAdharV1.X1(this.a, view);
            }
        });
        K1().i().g(this, new mf4() { // from class: com.zepto.se7
            @Override // com.zepto.mf4
            public final void a(Object obj) {
                VahanProcessWithAdharV1.Y1(this.a, (eKycResponse) obj);
            }
        });
        K1().j().g(this, new mf4() { // from class: com.zepto.te7
            @Override // com.zepto.mf4
            public final void a(Object obj) {
                VahanProcessWithAdharV1.Z1(this.a, (String) obj);
            }
        });
    }
    ...
    public final void y2(Context context, String mobile_no) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.ke7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VahanProcessWithAdharV1.z2(editText, imageView, view);
            }
        });
        textView.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.le7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VahanProcessWithAdharV1.A2(this.a, textView3, textView, view);
            }
        });
        textView2.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.me7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VahanProcessWithAdharV1.B2(editText, this, view);
            }
        });
        textView4.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.ne7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VahanProcessWithAdharV1.C2(editText, view);
            }
        });
        linearLayout.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.oe7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VahanProcessWithAdharV1.D2(this.a, view);
            }
        });
