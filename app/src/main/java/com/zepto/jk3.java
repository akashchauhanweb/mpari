...
public final class jk3 {
    ...
    public jk3(LinearLayout linearLayout, MyTextView myTextView, MyTextView myTextView2, MyTextView myTextView3, MyTextView myTextView4, HorizontalScrollView horizontalScrollView, MyTextView myTextView5) {
        this.a = linearLayout;
        this.b = myTextView;
        this.c = myTextView2;
        this.d = myTextView3;
                ...
                if (myTextView3 != null) {
                    ...
                    if (myTextView4 != null) {
                        ...
                        if (horizontalScrollView != null) {
                            ...
                            if (myTextView5 != null) {
                                return new jk3((LinearLayout) view, myTextView, myTextView2, myTextView3, myTextView4, horizontalScrollView, myTextView5);
                            }
                        }
                    }
                }
