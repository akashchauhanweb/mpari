...
public final class xi5 {
    ...
    public xi5(ScrollView scrollView, RadioButton radioButton, MyTextView myTextView, TextView textView, CheckBox checkBox, FrameLayout frameLayout, EditText editText, iy3 iy3Var, vy3 vy3Var, RadioGroup radioGroup, ImageView imageView, TextView textView2, TextView textView3, TextView textView4, RadioButton radioButton2) {
        this.a = scrollView;
        this.b = radioButton;
        this.c = myTextView;
        this.d = textView;
                                                    ...
                                                    if (textView3 != null) {
                                                        ...
                                                        if (textView4 != null) {
                                                            ...
                                                            if (radioButton2 != null) {
                                                                return new xi5((ScrollView) view, radioButton, myTextView, textView, checkBox, frameLayout, editText, iy3VarA, vy3VarA, radioGroup, imageView, textView2, textView3, textView4, radioButton2);
                                                            }
                                                        }
                                                    }
                                                }
    ...
    public static xi5 c(LayoutInflater layoutInflater) {
        return d(layoutInflater, null, false);
    }

    public static xi5 d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.sarthi_adhar_layout, viewGroup, false);
        if (z) {
