...
public final /* data */ class ChanngeOfAdressDtoX {
    ...
    public final ChanngeOfAdressDtoX copy(int action_cd, int action_code, String appl_no, String c_add1, String c_add2, String c_add3, int c_district, int c_pincode, String c_state, String facelessmessge, int flow_slno, String from_dt, String messege, int off_cd, String op_dt, String p_add1, String p_add2, String p_add3, int p_district, int p_pincode, String p_state, int pur_cd, String regn_no, String state_cd, String state_header) {
        ...
        Intrinsics.checkNotNullParameter(state_cd, "state_cd");
        Intrinsics.checkNotNullParameter(state_header, "state_header");
        return new ChanngeOfAdressDtoX(action_cd, action_code, appl_no, c_add1, c_add2, c_add3, c_district, c_pincode, c_state, facelessmessge, flow_slno, from_dt, messege, off_cd, op_dt, p_add1, p_add2, p_add3, p_district, p_pincode, p_state, pur_cd, regn_no, state_cd, state_header);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ChanngeOfAdressDtoX)) {
            return false;
        }
        ChanngeOfAdressDtoX channgeOfAdressDtoX = (ChanngeOfAdressDtoX) other;
        return this.action_cd == channgeOfAdressDtoX.action_cd && this.action_code == channgeOfAdressDtoX.action_code && Intrinsics.areEqual(this.appl_no, channgeOfAdressDtoX.appl_no) && Intrinsics.areEqual(this.c_add1, channgeOfAdressDtoX.c_add1) && Intrinsics.areEqual(this.c_add2, channgeOfAdressDtoX.c_add2) && Intrinsics.areEqual(this.c_add3, channgeOfAdressDtoX.c_add3) && this.c_district == channgeOfAdressDtoX.c_district && this.c_pincode == channgeOfAdressDtoX.c_pincode && Intrinsics.areEqual(this.c_state, channgeOfAdressDtoX.c_state) && Intrinsics.areEqual(this.facelessmessge, channgeOfAdressDtoX.facelessmessge) && this.flow_slno == channgeOfAdressDtoX.flow_slno && Intrinsics.areEqual(this.from_dt, channgeOfAdressDtoX.from_dt) && Intrinsics.areEqual(this.messege, channgeOfAdressDtoX.messege) && this.off_cd == channgeOfAdressDtoX.off_cd && Intrinsics.areEqual(this.op_dt, channgeOfAdressDtoX.op_dt) && Intrinsics.areEqual(this.p_add1, channgeOfAdressDtoX.p_add1) && Intrinsics.areEqual(this.p_add2, channgeOfAdressDtoX.p_add2) && Intrinsics.areEqual(this.p_add3, channgeOfAdressDtoX.p_add3) && this.p_district == channgeOfAdressDtoX.p_district && this.p_pincode == channgeOfAdressDtoX.p_pincode && Intrinsics.areEqual(this.p_state, channgeOfAdressDtoX.p_state) && this.pur_cd == channgeOfAdressDtoX.pur_cd && Intrinsics.areEqual(this.regn_no, channgeOfAdressDtoX.regn_no) && Intrinsics.areEqual(this.state_cd, channgeOfAdressDtoX.state_cd) && Intrinsics.areEqual(this.state_header, channgeOfAdressDtoX.state_header);
    }
