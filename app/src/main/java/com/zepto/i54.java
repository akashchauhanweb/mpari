...
public final class i54 extends RecyclerView.h {
    ...
    public i54(Context context, ArrayList searchList, int i, String inputType, wa3 langSession, String serviceCode, String chassisNo) {
    ...
    public static final void D(i54 this$0, int i, View view) {
        ...
        if (kt6.d(this$0.j)) {
            intent.putExtra("inputchassisno", this$0.j);
        }
    ...
    public void p(a holder, final int i) {
        ...
        holder.Q().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.h54
