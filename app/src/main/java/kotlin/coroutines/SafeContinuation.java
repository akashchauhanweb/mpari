...
public final class SafeContinuation<T> implements Continuation<T>, CoroutineStackFrame {
    ...
    public final Object getOrThrow() throws Throwable {
        ...
        if (obj == coroutineSingletons) {
            if (o2.a(RESULT, this, coroutineSingletons, IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED())) {
    ...
    public void resumeWith(Object result) {
        while (true) {
            ...
            CoroutineSingletons coroutineSingletons = CoroutineSingletons.UNDECIDED;
            if (obj == coroutineSingletons) {
                if (o2.a(RESULT, this, coroutineSingletons, result)) {
                    return;
                }
            } else {
                ...
                if (o2.a(RESULT, this, IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED(), CoroutineSingletons.RESUMED)) {
