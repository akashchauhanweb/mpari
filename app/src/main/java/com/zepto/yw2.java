...
public abstract class yw2 {
    public static void a(TextInputLayout textInputLayout, CheckableImageButton checkableImageButton, ColorStateList colorStateList, PorterDuff.Mode mode) {
        ...
        if (drawable != null) {
            ...
            if (colorStateList == null || !colorStateList.isStateful()) {
                ...
                tw1.o(drawable, ColorStateList.valueOf(colorStateList.getColorForState(c(textInputLayout, checkableImageButton), colorStateList.getDefaultColor())));
            }
            if (mode != null) {
                tw1.p(drawable, mode);
            }
    ...
    public static void d(TextInputLayout textInputLayout, CheckableImageButton checkableImageButton, ColorStateList colorStateList) {
        ...
        tw1.o(drawableMutate, ColorStateList.valueOf(colorForState));
    ...
    public static void f(CheckableImageButton checkableImageButton, View.OnLongClickListener onLongClickListener) {
        boolean zP = dq7.P(checkableImageButton);
        ...
        dq7.B0(checkableImageButton, z2 ? 1 : 2);
    }
