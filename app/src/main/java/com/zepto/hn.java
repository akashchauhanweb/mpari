...
public final class hn implements rl {
    ...
    public class a extends ThreadLocal {
        ...
        public Cipher initialValue() {
            try {
                return (Cipher) m22.b.a("AES/GCM-SIV/NoPadding");
    ...
    public hn(byte[] bArr) throws InvalidAlgorithmParameterException {
        hm7.a(bArr.length);
    ...
    public static AlgorithmParameterSpec d(byte[] bArr, int i, int i2) throws GeneralSecurityException {
        try {
