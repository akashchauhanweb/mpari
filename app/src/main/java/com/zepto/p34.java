...
public class p34 {
    ...
    public boolean a(float f, float f2, boolean z) {
        ...
        return jr7.a(viewParentH, this.c, f, f2, z);
    }
    ...
    public boolean b(float f, float f2) {
        ...
        return jr7.b(viewParentH, this.c, f, f2);
    }
    ...
    public boolean d(int i, int i2, int[] iArr, int[] iArr2, int i3) {
        ...
        iArr[0] = 0;
        iArr[1] = 0;
        jr7.c(viewParentH, this.c, i, i2, iArr, i3);
        if (iArr2 != null) {
            this.c.getLocationInWindow(iArr2);
            iArr2[0] = iArr2[0] - i4;
            iArr2[1] = iArr2[1] - i5;
    ...
    public final boolean g(int i, int i2, int i3, int i4, int[] iArr, int i5, int[] iArr2) {
        ...
        jr7.d(viewParentH, this.c, i, i2, i3, i4, i5, iArr3);
        if (iArr != null) {
            this.c.getLocationInWindow(iArr);
            iArr[0] = iArr[0] - i6;
            iArr[1] = iArr[1] - i7;
    ...
    public boolean p(int i, int i2) {
        ...
        for (ViewParent parent = this.c.getParent(); parent != null; parent = parent.getParent()) {
            if (jr7.f(parent, view, this.c, i, i2)) {
                n(i2, parent);
                jr7.e(parent, view, this.c, i, i2);
                return true;
            }
