...
public final class IssueOfDuplicateMultiServiceToBuyer extends pq {
    ...
    public static final class a extends Lambda implements Function1 {
        ...
        public final void a(DReasonResponse dReasonResponse) {
            IssueOfDuplicateMultiServiceToBuyer.this.v1().dismiss();
            try {
                if (dReasonResponse.size() > 0) {
                    dReasonResponse.add(0, new DReasonResponseItem("Select Reason", null));
                    IssueOfDuplicateMultiServiceToBuyer issueOfDuplicateMultiServiceToBuyer = IssueOfDuplicateMultiServiceToBuyer.this;
                    Intrinsics.checkNotNull(dReasonResponse);
                    IssueOfDuplicateMultiServiceToBuyer.this.r1().h.setAdapter((SpinnerAdapter) new cg7(issueOfDuplicateMultiServiceToBuyer, dReasonResponse));
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public static final class c implements AdapterView.OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView adapterView, View view, int i, long j) {
            ...
            Object selectedItem = IssueOfDuplicateMultiServiceToBuyer.this.r1().h.getSelectedItem();
            ...
            if (StringsKt__StringsJVMKt.equals(dReasonResponseItem.getReason_desc(), "OTHER", true) || StringsKt__StringsJVMKt.equals(dReasonResponseItem.getReason_desc(), "TORN", true)) {
                IssueOfDuplicateMultiServiceToBuyer.this.r1().e.setVisibility(8);
            } else {
                IssueOfDuplicateMultiServiceToBuyer.this.r1().e.setVisibility(0);
            }
        }
    ...
    public static final void A1(IssueOfDuplicateMultiServiceToBuyer this$0, View view) {
    ...
    public static final void B1(IssueOfDuplicateMultiServiceToBuyer this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        try {
    ...
    public static final void C1(IssueOfDuplicateMultiServiceToBuyer this$0, DatePicker datePicker, int i, int i2, int i3) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.cal.set(1, i);
        this$0.cal.set(2, i2);
        this$0.cal.set(5, i3);
    ...
    public static final void D1(IssueOfDuplicateMultiServiceToBuyer this$0, DatePickerDialog.OnDateSetListener dateSetListener, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public static final void E1(IssueOfDuplicateMultiServiceToBuyer this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        ...
        try {
            ...
            Durcdto durcdto = new Durcdto("", 0, strH, string2, 0, " ", 0, " ", "", i, strR, string4, string2, i2, strH2, " ", 0, strValueOf, strW1, strValueOf2, "", "", "", Integer.parseInt(rc_vh_class_cd));
            ...
            intent.setClass(this$0, Class.forName("com.nic.mparivahan.VahanServices.VahanTransferOwnerView.VahanTransferOfOwnership.SellerAndBuyer.BuyerView.TOBuyer." + VContant.INSTANCE.u("3", this$0.multiServiceList, "B")));
    ...
    public static final void F1(IssueOfDuplicateMultiServiceToBuyer this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public static final void G1(IssueOfDuplicateMultiServiceToBuyer this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.H1();
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (arrayList.size() <= 1) {
            ...
            M1(new wa3(this));
            r1().l.i.setText(String.valueOf(s1().b("toBuyerHeader", "Transfer of Ownership \n(Buyer)")));
        }
        if (this.isFaceless) {
        ...
        r1().l.e.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.t13
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                IssueOfDuplicateMultiServiceToBuyer.A1(this.a, view);
            }
        });
        r1().l.i.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.u13
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                IssueOfDuplicateMultiServiceToBuyer.B1(this.a, view);
            }
        });
        try {
            v1().show();
        ...
        final DatePickerDialog.OnDateSetListener onDateSetListener = new DatePickerDialog.OnDateSetListener() { // from class: com.zepto.v13
            @Override // android.app.DatePickerDialog.OnDateSetListener
            public final void onDateSet(DatePicker datePicker, int i, int i2, int i3) {
                IssueOfDuplicateMultiServiceToBuyer.C1(this.a, datePicker, i, i2, i3);
            }
        };
        r1().c.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.w13
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                IssueOfDuplicateMultiServiceToBuyer.D1(this.a, onDateSetListener, view);
            }
        });
        z1().L().g(this, new d(new a()));
        z1().M().g(this, new d(new b()));
        r1().h.setOnItemSelectedListener(new c());
        r1().b.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.x13
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                IssueOfDuplicateMultiServiceToBuyer.E1(this.a, view);
            }
        });
        r1().l.f.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.y13
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                IssueOfDuplicateMultiServiceToBuyer.F1(this.a, view);
            }
        });
        r1().l.g.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.z13
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                IssueOfDuplicateMultiServiceToBuyer.G1(this.a, view);
            }
        });
    }
