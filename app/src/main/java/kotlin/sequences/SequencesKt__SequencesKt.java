...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    public static final class C01511<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        public C01511(Sequence<? extends T> sequence, Function2<? super Integer, ? super T, ? extends C> function2, Function1<? super C, ? extends Iterator<? extends R>> function1, Continuation<? super C01511> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01511 c01511 = new C01511(this.$source, this.$transform, this.$iterator, continuation);
            c01511.L$0 = obj;
            return c01511;
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            while (it.hasNext()) {
                ...
                Iterator<R> itInvoke = this.$iterator.invoke((C) function2.invoke(Boxing.boxInt(i), (T) next));
        ...
        public final Object invoke(SequenceScope<? super R> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C01511) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public static final class C01551<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C01551(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> function0, Continuation<? super C01551> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01551 c01551 = new C01551(this.$this_ifEmpty, this.$defaultValue, continuation);
            c01551.L$0 = obj;
            return c01551;
        }
    ...
    public static final class C01561<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C01561(Sequence<? extends T> sequence, Random random, Continuation<? super C01561> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01561 c01561 = new C01561(this.$this_shuffled, this.$random, continuation);
            c01561.L$0 = obj;
            return c01561;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(SequenceScope<? super T> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C01561) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(Sequence<? extends T> source, Function2<? super Integer, ? super T, ? extends C> transform, Function1<? super C, ? extends Iterator<? extends R>> iterator) {
        ...
        Intrinsics.checkNotNullParameter(iterator, "iterator");
        return SequencesKt__SequenceBuilderKt.sequence(new C01511(source, transform, iterator, null));
    }
    ...
    public static final <T> Sequence<T> ifEmpty(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> defaultValue) {
        ...
        return SequencesKt__SequenceBuilderKt.sequence(new C01551(sequence, defaultValue, null));
    }
    ...
    public static final <T> Sequence<T> shuffled(Sequence<? extends T> sequence, Random random) {
        ...
        return SequencesKt__SequenceBuilderKt.sequence(new C01561(sequence, random, null));
    }
