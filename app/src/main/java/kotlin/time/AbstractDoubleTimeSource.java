...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    public static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m1348equalsimpl0(mo1335minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m1446getZEROUwyO8pc());
        }
        ...
        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m1371hashCodeimpl(Duration.m1379plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }
        ...
        public long mo1335minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (other instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual(this.timeSource, doubleTimeMark.timeSource)) {
                    if (Duration.m1348equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m1375isInfiniteimpl(this.offset)) {
                        return Duration.INSTANCE.m1446getZEROUwyO8pc();
                    }
                    long jM1378minusLRDsOJo = Duration.m1378minusLRDsOJo(this.offset, doubleTimeMark.offset);
                    long duration = DurationKt.toDuration(this.startedAt - doubleTimeMark.startedAt, this.timeSource.getUnit());
                    return Duration.m1348equalsimpl0(duration, Duration.m1396unaryMinusUwyO8pc(jM1378minusLRDsOJo)) ? Duration.INSTANCE.m1446getZEROUwyO8pc() : Duration.m1379plusLRDsOJo(duration, jM1378minusLRDsOJo);
                }
            }
        ...
        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt__DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m1392toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
        ...
        public ComparableTimeMark mo1336plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1379plusLRDsOJo(this.offset, duration), null);
        }
    }
    ...
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m1446getZEROUwyO8pc(), null);
    }
}
