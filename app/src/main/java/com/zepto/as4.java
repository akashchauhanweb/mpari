...
public final class as4 {
    ...
    public as4(LinearLayout linearLayout, MyTextView myTextView, MyTextView myTextView2, MyTextView myTextView3, MyTextView myTextView4, HorizontalScrollView horizontalScrollView, MyTextView myTextView5) {
        this.a = linearLayout;
        this.b = myTextView;
        this.c = myTextView2;
        this.d = myTextView3;
                ...
                if (myTextView3 != null) {
                    ...
                    if (myTextView4 != null) {
                        ...
                        if (horizontalScrollView != null) {
                            i = R.id.uploadPhotoSignature;
                            MyTextView myTextView5 = (MyTextView) zp7.a(view, R.id.uploadPhotoSignature);
                            if (myTextView5 != null) {
                                return new as4((LinearLayout) view, myTextView, myTextView2, myTextView3, myTextView4, horizontalScrollView, myTextView5);
                            }
                        }
                    }
                }
