...
public class az0 extends ContextWrapper {
    ...
    public static class a {
        public static Context a(az0 az0Var, Configuration configuration) {
            return az0Var.createConfigurationContext(configuration);
        }
    }
    ...
    public az0(Context context, Resources.Theme theme) {
        super(context);
        this.b = theme;
    }
}
