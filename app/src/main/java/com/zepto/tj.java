...
public final class tj extends RecyclerView.h {
    public final AddDrivingSchoolActivity d;
    ...
    public tj(AddDrivingSchoolActivity context, ArrayList list, wa3 langSession) {
    ...
    public static final void C(tj this$0, int i, View view) {
    ...
    public void p(a holder, final int i) {
        ...
        holder.S().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.sj
