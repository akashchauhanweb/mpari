...
@Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u0006\u0018\u0000 \u00142\u00020\u0001:\u0001\u0015B\u0017\u0012\u0006\u0010\u000f\u001a\u00020\b\u0012\u0006\u0010\u0011\u001a\u00020\u0010¢\u0006\u0004\b\u0012\u0010\u0013J\b\u0010\u0003\u001a\u00020\u0002H\u0016J\u000e\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004R\"\u0010\u000f\u001a\u00020\b8\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\t\u0010\n\u001a\u0004\b\u000b\u0010\f\"\u0004\b\r\u0010\u000e¨\u0006\u0016"}, d2 = {"Lcom/nic/mparivahan/VahanServices/VahanLog/VahanLogUpdateDoc;", "Landroidx/work/Worker;", "Landroidx/work/c$a;", "p", "Lcom/nic/mparivahan/VahanServices/VahanLog/DocUpdateLogs;", "afterpayment", "", "r", "Landroid/content/Context;", "f", "Landroid/content/Context;", "getContext", "()Landroid/content/Context;", "setContext", "(Landroid/content/Context;)V", "context", "Landroidx/work/WorkerParameters;", "workerParams", "<init>", "(Landroid/content/Context;Landroidx/work/WorkerParameters;)V", "g", "a", "app_release"}, k = 1, mv = {1, 9, 0})
public final class VahanLogUpdateDoc extends Worker {
    ...
    /* JADX INFO: renamed from: com.nic.mparivahan.VahanServices.VahanLog.VahanLogUpdateDoc$a, reason: from kotlin metadata */
    public static final class Companion {
        ...
        public final void a(Context context, DocUpdateLogs docUpdateLogs) throws Throwable {
            Intrinsics.checkNotNullParameter(context, "context");
            Intrinsics.checkNotNullParameter(docUpdateLogs, "docUpdateLogs");
            androidx.work.b bVarA = new b.a().b("docUpdateLogs", new Gson().toJson(docUpdateLogs)).a();
            Intrinsics.checkNotNullExpressionValue(bVarA, "build(...)");
            iy7.c(context).a((ih4) ((ih4.a) ((ih4.a) new ih4.a(VahanLogUpdateDoc.class).j(bVarA)).h(new lx0.a().b(s44.CONNECTED).a())).a());
        }
    }
    ...
    public VahanLogUpdateDoc(Context context, WorkerParameters workerParams) {
    ...
    public c.a p() {
        try {
            Object objFromJson = new Gson().fromJson(f().m("docUpdateLogs"), (Class<Object>) DocUpdateLogs.class);
            Intrinsics.checkNotNullExpressionValue(objFromJson, "fromJson(...)");
            r((DocUpdateLogs) objFromJson);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public final void r(DocUpdateLogs afterpayment) {
        ...
        String string = mt6.a.H(afterpayment).toString();
