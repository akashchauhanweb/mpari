...
public final class id7 extends BaseAdapter {
    public Context a;
    public final ArrayList b;

    public id7(Context context, ArrayList state) {
    ...
    public View getView(int i, View view, ViewGroup parent) {
        ...
        ((TextView) viewFindViewById).setText(((Doclist) this.b.get(i)).getDescr().toString());
        return view;
    }
}
