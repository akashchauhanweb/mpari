...
public final class iz2 {
    public static final hg6.b c = hg6.b.e;
    ...
    public class a extends ThreadLocal {
        ...
        public Cipher initialValue() {
            try {
                return (Cipher) m22.b.a("AES/GCM/NoPadding");
    ...
    public iz2(byte[] bArr, boolean z) throws GeneralSecurityException {
        if (!c.a()) {
    ...
    public static AlgorithmParameterSpec d(byte[] bArr, int i, int i2) {
        return (!w86.b() || w86.a() > 19) ? new GCMParameterSpec(128, bArr, i, i2) : new IvParameterSpec(bArr, i, i2);
    }
