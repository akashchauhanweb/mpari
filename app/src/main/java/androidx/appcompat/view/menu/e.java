...
public class e implements f96 {
    ...
    public boolean O(MenuItem menuItem, i iVar, int i) {
        g gVar = (g) menuItem;
        ...
        boolean zK = gVar.k();
        a6 a6VarA = gVar.a();
        boolean z = a6VarA != null && a6VarA.a();
        if (gVar.j()) {
    ...
    */
    public final void f0(boolean r3) {
        /*
            ...
            boolean r3 = com.zepto.kq7.c(r3, r1)
            if (r3 == 0) goto L1c
            goto L1d
        L1c:
            r0 = 0
    ...
    public final void k(Bundle bundle) {
        ...
        for (WeakReference weakReference : this.w) {
            ...
            if (iVar == null) {
                ...
                int iC = iVar.c();
                if (iC > 0 && (parcelableK = iVar.k()) != null) {
                    sparseArray.put(iC, parcelableK);
                }
            }
        }
    ...
    public final boolean l(l lVar, i iVar) {
        ...
        boolean zG = iVar != null ? iVar.g(lVar) : false;
        for (WeakReference weakReference : this.w) {
            i iVar2 = (i) weakReference.get();
            if (iVar2 == null) {
                this.w.remove(weakReference);
