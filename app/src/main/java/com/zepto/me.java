...
public final class me {
    ...
    public static me d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_pay_tax_status_screen, viewGroup, false);
        if (z) {
