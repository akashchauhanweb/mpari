...
public final class VahanlTaxlogCapture extends Worker {
    ...
    /* JADX INFO: renamed from: com.nic.mparivahan.VahanServices.VahanLog.VahanlTaxlogCapture$a, reason: from kotlin metadata */
    public static final class Companion {
        ...
        public final void a(Context context, Afterpayment afterpayment, int i) throws Throwable {
            ...
            iy7.c(context).a((ih4) ((ih4.a) ((ih4.a) new ih4.a(VahanlTaxlogCapture.class).j(bVarA)).h(new lx0.a().b(s44.CONNECTED).a())).a());
        }
    }
    ...
    public VahanlTaxlogCapture(Context context, WorkerParameters workerParams) {
    ...
    public c.a p() {
        try {
            Gson gson = new Gson();
            int iJ = f().j("Flag", 1);
            Object objFromJson = gson.fromJson(f().m("AfterPayment"), (Class<Object>) Afterpayment.class);
            Intrinsics.checkNotNullExpressionValue(objFromJson, "fromJson(...)");
            r((Afterpayment) objFromJson, iJ);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public final void r(Afterpayment afterpayment, int flag) {
        Intrinsics.checkNotNullParameter(afterpayment, "afterpayment");
        ...
        String string = mt6.a.I(afterpayment, flag).toString();
