...
public final class Retrofit {
    ...
    final da0.a callFactory;
    final Executor callbackExecutor;
    final List<Converter.Factory> converterFactories;
    private final Map<Method, ServiceMethod<?>> serviceMethodCache = new ConcurrentHashMap();
    final boolean validateEagerly;

    public Retrofit(da0.a aVar, ds2 ds2Var, List<Converter.Factory> list, List<CallAdapter.Factory> list2, Executor executor, boolean z) {
    ...
    public <T> Converter<T, lc5> nextRequestBodyConverter(Converter.Factory factory, Type type, Annotation[] annotationArr, Annotation[] annotationArr2) {
        ...
        for (int i = iIndexOf; i < size; i++) {
            Converter<T, lc5> converter = (Converter<T, lc5>) this.converterFactories.get(i).requestBodyConverter(type, annotationArr, annotationArr2, this);
            if (converter != null) {
                return converter;
            }
        }
    ...
    public <T> Converter<nd5, T> nextResponseBodyConverter(Converter.Factory factory, Type type, Annotation[] annotationArr) {
        Objects.requireNonNull(type, "type == null");
        Objects.requireNonNull(annotationArr, "annotations == null");
        int iIndexOf = this.converterFactories.indexOf(factory) + 1;
        int size = this.converterFactories.size();
        for (int i = iIndexOf; i < size; i++) {
            Converter<nd5, T> converter = (Converter<nd5, T>) this.converterFactories.get(i).responseBodyConverter(type, annotationArr, this);
            if (converter != null) {
                return converter;
            }
        }
    ...
    public <T> Converter<T, lc5> requestBodyConverter(Type type, Annotation[] annotationArr, Annotation[] annotationArr2) {
        return nextRequestBodyConverter(null, type, annotationArr, annotationArr2);
    }

    public <T> Converter<nd5, T> responseBodyConverter(Type type, Annotation[] annotationArr) {
    ...
    public static final class Builder {
        ...
        public Builder baseUrl(URL url) {
            ...
            return baseUrl(ds2.h(url.toString()));
        }
        ...
        public Builder callFactory(da0.a aVar) {
        ...
        public Builder client(yf4 yf4Var) {
            Objects.requireNonNull(yf4Var, "client == null");
            return callFactory(yf4Var);
        }
        ...
        public Builder baseUrl(ds2 ds2Var) {
            Objects.requireNonNull(ds2Var, "baseUrl == null");
            if ("".equals(ds2Var.m().get(r0.size() - 1))) {
                this.baseUrl = ds2Var;
                return this;
            }
            throw new IllegalArgumentException("baseUrl must end in /: " + ds2Var);
        }
    }
}
