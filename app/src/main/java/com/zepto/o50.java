...
public final class o50 {
    ...
    public static final class a {
        ...
        public a() {
            c(o50.e(Locale.getDefault()));
        }

        public static o50 b(boolean z) {
            return z ? o50.h : o50.g;
        }

        public o50 a() {
            return (this.b == 2 && this.c == o50.d) ? b(this.a) : new o50(this.a, this.b, this.c);
        }
    ...
    static {
        ...
        g = new o50(false, 2, se6Var);
        h = new o50(true, 2, se6Var);
    }

    public o50(boolean z, int i, se6 se6Var) {
        this.a = z;
        this.b = i;
        this.c = se6Var;
    }
    ...
    public final String f(CharSequence charSequence, se6 se6Var) {
        boolean zA = se6Var.a(charSequence, 0, charSequence.length());
        return (this.a || !(zA || b(charSequence) == 1)) ? this.a ? (!zA || b(charSequence) == -1) ? f : "" : "" : e;
    }

    public final String g(CharSequence charSequence, se6 se6Var) {
        boolean zA = se6Var.a(charSequence, 0, charSequence.length());
    ...
    public CharSequence i(CharSequence charSequence, se6 se6Var, boolean z) {
        ...
        if (d() && z) {
            spannableStringBuilder.append((CharSequence) g(charSequence, zA ? te6.b : te6.a));
        }
        if (zA != this.a) {
        ...
        if (z) {
            spannableStringBuilder.append((CharSequence) f(charSequence, zA ? te6.b : te6.a));
        }
    ...
    public String k(String str, se6 se6Var, boolean z) {
        if (str == null) {
            return null;
        }
        return i(str, se6Var, z).toString();
    }
}
