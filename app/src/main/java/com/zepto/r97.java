...
public final class r97 {
    ...
    public r97(CoordinatorLayout coordinatorLayout, TextView textView, k27 k27Var, ImageView imageView, AppCompatTextView appCompatTextView, LinearLayout linearLayout, FrameLayout frameLayout, TextView textView2, FrameLayout frameLayout2, LinearLayout linearLayout2, TextView textView3, TextView textView4, TextView textView5, TextView textView6, d47 d47Var, TextView textView7, CustomWegetLayout customWegetLayout, RecyclerView recyclerView, CardView cardView, RecyclerView recyclerView2, TextView textView8, TextView textView9, View view, View view2) {
                                                                                    ...
                                                                                    if (textView8 != null) {
                                                                                        ...
                                                                                        if (textView9 != null) {
                                                                                            ...
                                                                                            if (viewA3 != null) {
                                                                                                ...
                                                                                                if (viewA4 != null) {
                                                                                                    return new r97((CoordinatorLayout) view, textView, k27VarA, imageView, appCompatTextView, linearLayout, frameLayout, textView2, frameLayout2, linearLayout2, textView3, textView4, textView5, textView6, d47VarA, textView7, customWegetLayout, recyclerView, cardView, recyclerView2, textView8, textView9, viewA3, viewA4);
                                                                                                }
                                                                                            }
                                                                                        }
                                                                                    }
    ...
    public static r97 c(LayoutInflater layoutInflater) {
        return d(layoutInflater, null, false);
    }

    public static r97 d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.vahan_multi_service_dms, viewGroup, false);
        if (z) {
