...
public class TypeToken<T> {
    ...
    public TypeToken() {
        ...
        this.rawType = c.k(typeTokenTypeArgument);
    ...
    public static TypeToken<?> getParameterized(Type type, Type... typeArr) {
        ...
        return new TypeToken<>(c.n(null, type, typeArr));
    }
    ...
    public final boolean equals(Object obj) {
        return (obj instanceof TypeToken) && c.f(this.type, ((TypeToken) obj).type);
    }
    ...
    public boolean isAssignableFrom(Type type) {
        ...
        if (type2 instanceof Class) {
            return this.rawType.isAssignableFrom(c.k(type));
        }
        if (type2 instanceof ParameterizedType) {
            return isAssignableFrom(type, (ParameterizedType) type2, new HashMap());
        }
        if (type2 instanceof GenericArrayType) {
            return this.rawType.isAssignableFrom(c.k(type)) && isAssignableFrom(type, (GenericArrayType) this.type);
        }
