...
public abstract class c02 {
    ...
    public static void g(EditorInfo editorInfo, CharSequence charSequence, int i, int i2) {
        ...
        if (a(charSequence, (i2 + iMin) - 1, 1)) {
            iMin--;
        }
        f(editorInfo, i4 != i3 ? TextUtils.concat(charSequence.subSequence(i6, i6 + iMin2), charSequence.subSequence(i2, iMin + i2)) : charSequence.subSequence(i6, iMin2 + i4 + iMin + i6), iMin2, i4 + iMin2);
    }
}
