...
final class RequestFactory {
    ...
    public static final class Builder {
        ...
        private pl2 parseHeaders(String[] strArr) {
            ...
            for (String str : strArr) {
                ...
                if (xr2.HEADER_CONTENT_TYPE.equalsIgnoreCase(strSubstring)) {
                    try {
                        this.contentType = ls3.e(strTrim);
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            if (annotation instanceof Url) {
                ...
                this.gotUrl = true;
                if (type == ds2.class || type == String.class || type == URI.class || ((type instanceof Class) && "android.net.Uri".equals(((Class) type).getName()))) {
            ...
            if (!(annotation instanceof Part)) {
                if (annotation instanceof PartMap) {
                    ...
                    if (String.class == parameterUpperBound4) {
                        ...
                        if (jy3.c.class.isAssignableFrom(Utils.getRawType(parameterUpperBound5))) {
            ...
            if (strValue5.isEmpty()) {
                if (!Iterable.class.isAssignableFrom(rawType10)) {
                    if (rawType10.isArray()) {
                        if (jy3.c.class.isAssignableFrom(rawType10.getComponentType())) {
                    ...
                    if (jy3.c.class.isAssignableFrom(rawType10)) {
                        return ParameterHandler.RawPart.INSTANCE;
                    }
                    throw Utils.parameterError(this.method, i, "@Part annotation must supply a name or use MultipartBody.Part parameter type.", new Object[0]);
                }
                if (type instanceof ParameterizedType) {
                    if (jy3.c.class.isAssignableFrom(Utils.getRawType(Utils.getParameterUpperBound(0, (ParameterizedType) type)))) {
            ...
            pl2 pl2VarR = pl2.r("Content-Disposition", "form-data; name=\"" + strValue5 + "\"", "Content-Transfer-Encoding", part.encoding());
            if (!Iterable.class.isAssignableFrom(rawType10)) {
                if (!rawType10.isArray()) {
                    if (jy3.c.class.isAssignableFrom(rawType10)) {
                    ...
                    return new ParameterHandler.Part(this.method, i, pl2VarR, this.retrofit.requestBodyConverter(type, annotationArr, this.methodAnnotations));
                }
                Class<?> clsBoxIfPrimitive = boxIfPrimitive(rawType10.getComponentType());
                if (jy3.c.class.isAssignableFrom(clsBoxIfPrimitive)) {
                    throw Utils.parameterError(this.method, i, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                }
                return new ParameterHandler.Part(this.method, i, pl2VarR, this.retrofit.requestBodyConverter(clsBoxIfPrimitive, annotationArr, this.methodAnnotations)).array();
            }
            if (type instanceof ParameterizedType) {
                Type parameterUpperBound6 = Utils.getParameterUpperBound(0, (ParameterizedType) type);
                if (jy3.c.class.isAssignableFrom(Utils.getRawType(parameterUpperBound6))) {
                    throw Utils.parameterError(this.method, i, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                }
                return new ParameterHandler.Part(this.method, i, pl2VarR, this.retrofit.requestBodyConverter(parameterUpperBound6, annotationArr, this.methodAnnotations)).iterable();
            }
            throw Utils.parameterError(this.method, i, rawType10.getSimpleName() + " must include generic type (e.g., " + rawType10.getSimpleName() + "<String>)", new Object[0]);
        }
    ...
    public kc5 create(Object[] objArr) throws IOException {
        ...
        return requestBuilder.get().h(Invocation.class, new Invocation(this.method, arrayList)).b();
    }
}
