...
public final class UArraysKt___UArraysJvmKt$asList$2 extends AbstractList<ULong> implements RandomAccess {
    ...
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof ULong) {
            return m527indexOfVKZWuLQ(((ULong) obj).getData());
        }
        return -1;
    }

    /* JADX INFO: renamed from: indexOf-VKZWuLQ, reason: not valid java name */
    public int m527indexOfVKZWuLQ(long element) {
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof ULong) {
            return m528lastIndexOfVKZWuLQ(((ULong) obj).getData());
        }
        return -1;
    }

    /* JADX INFO: renamed from: lastIndexOf-VKZWuLQ, reason: not valid java name */
    public int m528lastIndexOfVKZWuLQ(long element) {
