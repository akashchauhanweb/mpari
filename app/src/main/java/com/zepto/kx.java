...
public final class kx {
    ...
    public kx(int i, float f, float f2, float f3, int i2, float f4, int i3, float f5, int i4, float f6) {
        this.a = i;
        this.b = er3.a(f, f2, f3);
        this.c = i2;
        this.e = f4;
        this.d = i3;
        this.f = f5;
    ...
    public static kx c(float f, float f2, float f3, float f4, int[] iArr, float f5, int[] iArr2, float f6, int[] iArr3) {
        kx kxVar = null;
        int i = 1;
        for (int i2 : iArr3) {
            ...
            while (i3 < length) {
                ...
                while (i5 < length2) {
                    ...
                    int i8 = i3;
                    int i9 = length;
                    kx kxVar2 = new kx(i, f2, f3, f4, iArr[i5], f5, i4, f6, i2, f);
                    if (kxVar == null || kxVar2.h < kxVar.h) {
                        if (kxVar2.h == 0.0f) {
                            return kxVar2;
                        }
                        kxVar = kxVar2;
