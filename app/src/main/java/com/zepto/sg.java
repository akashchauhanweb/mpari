...
public final class sg {
    ...
    public sg(LinearLayout linearLayout, TextView textView, TextView textView2, vy3 vy3Var, LinearLayout linearLayout2, LinearLayout linearLayout3, LinearLayout linearLayout4, TextView textView3, TextView textView4, TextView textView5, RecyclerView recyclerView, TextView textView6, ProgressBar progressBar, TextView textView7) {
        this.a = linearLayout;
        this.b = textView;
        this.c = textView2;
        this.d = vy3Var;
                                            ...
                                            if (recyclerView != null) {
                                                ...
                                                if (textView6 != null) {
                                                    ...
                                                    if (progressBar != null) {
                                                        ...
                                                        if (textView7 != null) {
                                                            return new sg((LinearLayout) view, textView, textView2, vy3VarA, linearLayout, linearLayout2, linearLayout3, textView3, textView4, textView5, recyclerView, textView6, progressBar, textView7);
                                                        }
                                                    }
                                                }
                                            }
    ...
    public static sg c(LayoutInflater layoutInflater) {
        return d(layoutInflater, null, false);
    }

    public static sg d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_traffic_history, viewGroup, false);
        if (z) {
