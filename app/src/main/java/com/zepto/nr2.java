...
public final class nr2 {
    ...
    public static nr2 c(LayoutInflater layoutInflater) {
        return d(layoutInflater, null, false);
    }

    public static nr2 d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.hpttermination_multi_service, viewGroup, false);
        if (z) {
