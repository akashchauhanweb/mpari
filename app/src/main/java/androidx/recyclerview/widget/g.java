...
public class g extends RecyclerView.z {
    ...
    public int t(View view, int i) {
        ...
        return s(pVarE.V(view) - ((ViewGroup.MarginLayoutParams) qVar).leftMargin, pVarE.Y(view) + ((ViewGroup.MarginLayoutParams) qVar).rightMargin, pVarE.j0(), pVarE.u0() - pVarE.k0(), i);
    }
    ...
    public int u(View view, int i) {
        ...
        RecyclerView.q qVar = (RecyclerView.q) view.getLayoutParams();
        return s(pVarE.Z(view) - ((ViewGroup.MarginLayoutParams) qVar).topMargin, pVarE.T(view) + ((ViewGroup.MarginLayoutParams) qVar).bottomMargin, pVarE.m0(), pVarE.b0() - pVarE.h0(), i);
    }
