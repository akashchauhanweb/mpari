...
public abstract class gu4 implements Spannable {
    ...
    public static final class a {
        ...
        /* JADX INFO: renamed from: com.zepto.gu4$a$a, reason: collision with other inner class name */
        ...
        public a(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i, int i2) {
            if (Build.VERSION.SDK_INT >= 29) {
                this.e = fu4.a(textPaint).setBreakStrategy(i).setHyphenationFrequency(i2).setTextDirection(textDirectionHeuristic).build();
            } else {
                this.e = null;
            }
            this.a = textPaint;
