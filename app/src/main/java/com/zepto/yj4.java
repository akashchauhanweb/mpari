...
public final class yj4 extends BaseAdapter {
    public Context a;
    public ArrayList b;

    public yj4(Context context, ArrayList owner) {
    ...
    public View getView(int i, View view, ViewGroup parent) {
        ...
        textView.setText(((OwnerCatagory) this.b.get(i)).getCatgDescription().toString());
        return view;
    }
}
