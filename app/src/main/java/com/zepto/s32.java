...
public final class s32 extends RecyclerView.h {
    ...
    public s32(ArrayList mList, Context mContext, String state_code) {
    ...
    public static final void F(int i, final s32 this$0, a holder, final wa3 langSession, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(holder, "$holder");
        Intrinsics.checkNotNullParameter(langSession, "$langSession");
        if (i == 3) {
            Intent intent = new Intent(this$0.e, (Class<?>) EsSectionActivity.class);
        ...
        String servCode = ((Enabledservice) obj).getServCode();
        switch (servCode.hashCode()) {
            case 49587:
                if (servCode.equals("201")) {
                    Intent intent2 = new Intent(this$0.e, (Class<?>) ApplicationStatusActivity.class);
            ...
            case 49589:
                if (servCode.equals("203")) {
                    Intent intent3 = new Intent(this$0.e, (Class<?>) ApplicationDetails.class);
            ...
            case 49590:
                if (servCode.equals("204")) {
                    Intent intent4 = new Intent(this$0.e, (Class<?>) DlServicesMainScreen.class);
            ...
            case 51694:
                if (servCode.equals("460")) {
                    try {
                        Intent intent5 = new Intent(this$0.e, (Class<?>) ApplicationCancel.class);
            ...
            case 52470:
                if (servCode.equals("501")) {
                    Intent intent6 = new Intent(this$0.e, (Class<?>) LearnerLicenceAadharScreen.class);
            ...
            case 52473:
                if (servCode.equals("504")) {
                    Intent intent8 = new Intent(this$0.e, (Class<?>) LLMain.class);
                    intent8.putExtra("state_code", this$0.f);
            ...
            case 52501:
                if (servCode.equals("511")) {
                    Intent intent9 = new Intent(this$0.e, (Class<?>) LLNoCheckActivity.class);
            ...
            case 52601:
                if (servCode.equals("548")) {
                    try {
                        Intent intent18 = new Intent(this$0.e, (Class<?>) DlServicesMainScreen.class);
            ...
            case 52625:
                if (servCode.equals("551")) {
                    try {
                        Intent intent19 = new Intent(this$0.e, (Class<?>) NewClOne.class);
            ...
            case 52633:
                if (servCode.equals("559")) {
                    try {
                        Intent intent23 = new Intent(this$0.e, (Class<?>) ClServicesMainScreen.class);
            ...
            case 52690:
                if (servCode.equals("574")) {
                    Intent intent24 = new Intent(this$0.e, (Class<?>) LLMain.class);
                    intent24.putExtra("state_code", this$0.f);
            ...
            case 56315:
                if (servCode.equals("902")) {
                    Intent intent26 = new Intent(this$0.e, (Class<?>) ApplicationStatusActivity.class);
            ...
            case 56316:
                if (servCode.equals("903")) {
                    ...
                    textView.setText(langSession.b("label_view_form_1", "View Form 1-A"));
                    textView2.setText(langSession.b("label_view_form_2", "View Form 2"));
                    if (StringsKt__StringsJVMKt.equals(new wl5(this$0.e).b(), "4", true)) {
                        textView2.setText(langSession.b("label_form_4", "View Form 4-A"));
                    } else {
                        textView2.setText(langSession.b("label_view_form_2", "View Form 2"));
                    }
                    imageView.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.p32
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view2) {
                            s32.G(dialog, view2);
                        }
                    });
                    textView.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.q32
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view2) {
                            s32.H(dialog, this$0, langSession, view2);
                        }
                    });
                    textView2.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.r32
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view2) {
                            s32.I(dialog, this$0, langSession, view2);
                        }
                    });
                    dialog.show();
                    return;
            ...
            case 56320:
                if (servCode.equals("907")) {
                    Intent intent27 = new Intent(this$0.e, (Class<?>) EditLearnerAppScreen.class);
            ...
            case 56321:
                if (servCode.equals("908")) {
                    Intent intent28 = new Intent(this$0.e, (Class<?>) AppNumberScreen.class);
            ...
            case 56322:
                if (servCode.equals("909")) {
                    Intent intent29 = new Intent(this$0.e, (Class<?>) CovApplication.class);
            ...
            case 56344:
                if (servCode.equals("910")) {
                    Intent intent30 = new Intent(this$0.e, (Class<?>) LearnerLicenseTestActivity.class);
                    intent30.putExtra("state_code", this$0.f);
        ...
        Intent intent32 = new Intent(this$0.e, (Class<?>) EsActivity.class);
        intent32.putExtra("state_code", this$0.f);
        this$0.e.startActivity(intent32);
    }
    ...
    public static final void H(Dialog d, s32 this$0, wa3 langSession, View view) {
        Intrinsics.checkNotNullParameter(d, "$d");
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(langSession, "$langSession");
        d.dismiss();
    ...
    public static final void I(Dialog d, s32 this$0, wa3 langSession, View view) {
        Intrinsics.checkNotNullParameter(d, "$d");
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(langSession, "$langSession");
        d.dismiss();
    ...
    public void p(final a holder, final int i) {
        ...
        if (Intrinsics.areEqual(this.g, "T") && i == 3) {
            holder.P().setText(wa3Var.b("label_view_more", "View More"));
            ...
            try {
                ...
                K(enabledservice.getServCode(), holder);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
        holder.Q().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.o32
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                s32.F(i, this, holder, wa3Var, view);
            }
        });
    }
    ...
    /* JADX WARN: Failed to restore switch over string. Please report as a decompilation issue */
    public final void K(String servCode, a holder) {
