...
public final class vl0 {
    ...
    public vl0(LinearLayout linearLayout, MyTextView myTextView, MyTextView myTextView2, MyTextView myTextView3, HorizontalScrollView horizontalScrollView, MyTextView myTextView4, MyTextView myTextView5) {
        this.a = linearLayout;
        this.b = myTextView;
        this.c = myTextView2;
        this.d = myTextView3;
                ...
                if (myTextView3 != null) {
                    ...
                    if (horizontalScrollView != null) {
                        ...
                        if (myTextView4 != null) {
                            ...
                            if (myTextView5 != null) {
                                return new vl0((LinearLayout) view, myTextView, myTextView2, myTextView3, horizontalScrollView, myTextView4, myTextView5);
                            }
                        }
                    }
                }
