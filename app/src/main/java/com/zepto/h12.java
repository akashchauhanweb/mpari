...
public final class h12 extends InputConnectionWrapper {
    public final TextView a;
    public final a b;

    public static class a {
        public boolean a(InputConnection inputConnection, Editable editable, int i, int i2, boolean z) {
            return androidx.emoji2.text.c.e(inputConnection, editable, i, i2, z);
        }
    ...
    public h12(TextView textView, InputConnection inputConnection, EditorInfo editorInfo) {
    ...
    public h12(TextView textView, InputConnection inputConnection, EditorInfo editorInfo, a aVar) {
