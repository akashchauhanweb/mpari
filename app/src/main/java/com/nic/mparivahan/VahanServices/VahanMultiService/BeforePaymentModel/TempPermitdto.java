...
public final /* data */ class TempPermitdto implements Serializable {
    ...
    public TempPermitdto(String allotmentOffice, String applNo, String goodsDetails, String goodsToCarry, String goodsType, String ipAddress, String issueDt, int i, String others, int i2, String periodMode, int i3, String purposeOfJourny, String regnNo, String routeDescription, String stateCd, String travelFrom, String travelUpto, List<VaSplPassengerdto> vaSplPassengerdto, String validFrom, String validUpto) {
    ...
    public final TempPermitdto copy(String allotmentOffice, String applNo, String goodsDetails, String goodsToCarry, String goodsType, String ipAddress, String issueDt, int offCd, String others, int period, String periodMode, int purCd, String purposeOfJourny, String regnNo, String routeDescription, String stateCd, String travelFrom, String travelUpto, List<VaSplPassengerdto> vaSplPassengerdto, String validFrom, String validUpto) {
        Intrinsics.checkNotNullParameter(allotmentOffice, "allotmentOffice");
        Intrinsics.checkNotNullParameter(applNo, "applNo");
        Intrinsics.checkNotNullParameter(goodsDetails, "goodsDetails");
        Intrinsics.checkNotNullParameter(goodsToCarry, "goodsToCarry");
        ...
        Intrinsics.checkNotNullParameter(validFrom, "validFrom");
        Intrinsics.checkNotNullParameter(validUpto, "validUpto");
        return new TempPermitdto(allotmentOffice, applNo, goodsDetails, goodsToCarry, goodsType, ipAddress, issueDt, offCd, others, period, periodMode, purCd, purposeOfJourny, regnNo, routeDescription, stateCd, travelFrom, travelUpto, vaSplPassengerdto, validFrom, validUpto);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TempPermitdto)) {
            return false;
        }
        TempPermitdto tempPermitdto = (TempPermitdto) other;
        return Intrinsics.areEqual(this.allotmentOffice, tempPermitdto.allotmentOffice) && Intrinsics.areEqual(this.applNo, tempPermitdto.applNo) && Intrinsics.areEqual(this.goodsDetails, tempPermitdto.goodsDetails) && Intrinsics.areEqual(this.goodsToCarry, tempPermitdto.goodsToCarry) && Intrinsics.areEqual(this.goodsType, tempPermitdto.goodsType) && Intrinsics.areEqual(this.ipAddress, tempPermitdto.ipAddress) && Intrinsics.areEqual(this.issueDt, tempPermitdto.issueDt) && this.offCd == tempPermitdto.offCd && Intrinsics.areEqual(this.others, tempPermitdto.others) && this.period == tempPermitdto.period && Intrinsics.areEqual(this.periodMode, tempPermitdto.periodMode) && this.purCd == tempPermitdto.purCd && Intrinsics.areEqual(this.purposeOfJourny, tempPermitdto.purposeOfJourny) && Intrinsics.areEqual(this.regnNo, tempPermitdto.regnNo) && Intrinsics.areEqual(this.routeDescription, tempPermitdto.routeDescription) && Intrinsics.areEqual(this.stateCd, tempPermitdto.stateCd) && Intrinsics.areEqual(this.travelFrom, tempPermitdto.travelFrom) && Intrinsics.areEqual(this.travelUpto, tempPermitdto.travelUpto) && Intrinsics.areEqual(this.vaSplPassengerdto, tempPermitdto.vaSplPassengerdto) && Intrinsics.areEqual(this.validFrom, tempPermitdto.validFrom) && Intrinsics.areEqual(this.validUpto, tempPermitdto.validUpto);
    }
