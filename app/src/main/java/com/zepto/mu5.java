...
public final class mu5 extends RecyclerView.h {
    public final Context d;
    public final ArrayList e;
    public final int f;
    public String g;
    public final wa3 h;
    public final SearchPrintReceiptListActivity i;
    ...
    public mu5(Context context, ArrayList searchList, int i, String name, wa3 langSession, SearchPrintReceiptListActivity activity) {
    ...
    public static final void D(mu5 this$0, ChallanListResultModal model, View view) {
    ...
    public void p(a holder, int i) {
        ...
        if (gd1.a.m(this.g)) {
            holder.S().setText(this.h.b("label_challan_print_receipt", this.d.getString(R.string.print_receipt)));
        } else {
            holder.S().setText(this.h.b("View_Payment_Receipt", this.g));
        }
        ...
        if (challanListResultModal.getStateCd().length() > 0) {
            holder.Q().setText(challanListResultModal.getStateCd());
        }
        if (this.f == 0) {
        ...
        holder.S().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.lu5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                mu5.D(this.a, challanListResultModal, view);
            }
        });
    }
