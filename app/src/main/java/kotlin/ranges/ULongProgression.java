...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM180constructorimpl = ((int) ULong.m180constructorimpl(j ^ ULong.m180constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM180constructorimpl2 = (iM180constructorimpl + ((int) ULong.m180constructorimpl(j2 ^ ULong.m180constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return iM180constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m226toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m226toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1224getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
}
