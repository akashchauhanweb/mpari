...
public final class m12 {
    ...
    public static class a extends b {
        ...
        public a(TextView textView) {
            this.a = textView;
            this.b = new i12(textView);
        }

        @Override // com.zepto.m12.b
        ...
        public final InputFilter[] f(InputFilter[] inputFilterArr) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                if (sparseArrayE.indexOfKey(i2) < 0) {
        ...
        public final TransformationMethod h(TransformationMethod transformationMethod) {
            return transformationMethod instanceof o12 ? ((o12) transformationMethod).a() : transformationMethod;
        }
        ...
        public final TransformationMethod k(TransformationMethod transformationMethod) {
            return ((transformationMethod instanceof o12) || (transformationMethod instanceof PasswordTransformationMethod)) ? transformationMethod : new o12(transformationMethod);
        }
    ...
    public m12(TextView textView, boolean z) {
        lu4.h(textView, "textView cannot be null");
        if (z) {
            this.a = new a(textView);
        } else {
