...
public final class UStringsKt {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m101constructorimpl(KotlinVersion.MAX_COMPONENT_VALUE)) > 0) {
            return null;
        }
        return UByte.m18boximpl(UByte.m24constructorimpl((byte) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM101constructorimpl = UInt.m101constructorimpl(i);
        ...
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                if (iDivideUnsigned == 119304647) {
                    iDivideUnsigned = Integer.divideUnsigned(-1, iM101constructorimpl);
                    if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            int iM101constructorimpl2 = UInt.m101constructorimpl(i3 * iM101constructorimpl);
            int iM101constructorimpl3 = UInt.m101constructorimpl(UInt.m101constructorimpl(iDigitOf) + iM101constructorimpl2);
            if (Integer.compareUnsigned(iM101constructorimpl3, iM101constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = iM101constructorimpl3;
        }
        return UInt.m95boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM180constructorimpl = ULong.m180constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                if (jDivideUnsigned == 512409557603043100L) {
                    jDivideUnsigned = Long.divideUnsigned(-1L, jM180constructorimpl);
                    if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            long jM180constructorimpl2 = ULong.m180constructorimpl(j * jM180constructorimpl);
            long jM180constructorimpl3 = ULong.m180constructorimpl(ULong.m180constructorimpl(((long) UInt.m101constructorimpl(iDigitOf)) & 4294967295L) + jM180constructorimpl2);
            if (Long.compareUnsigned(jM180constructorimpl3, jM180constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = jM180constructorimpl3;
        }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m101constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m281boximpl(UShort.m287constructorimpl((short) data));
    }
}
