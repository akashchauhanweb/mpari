...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        dq7.o0(this, context, iArr, attributeSet, typedArrayObtainStyledAttributes, 0, 0);
        this.a = typedArrayObtainStyledAttributes.getBoolean(c25.O0, true);
    ...
    private void setStacked(boolean z) {
        if (this.b != z) {
            if (!z || this.a) {
                ...
                View viewFindViewById = findViewById(b05.F);
