...
public final class f42 extends RecyclerView.h {
    ...
    public f42(ArrayList mList, Context mContext, String State_code) {
    ...
    public static final void C(int i, f42 this$0, Enabledservice mModel, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(mModel, "$mModel");
        if (i != 3) {
            this$0.E(mModel.getServCode(), this$0.e, this$0.f);
            return;
        }
        Intent intent = new Intent(this$0.e, (Class<?>) VehicleServiceSectionView.class);
    ...
    public void p(a holder, final int i) {
        ...
        holder.Q().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.e42
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                f42.C(i, this, enabledservice, view);
            }
        });
    }
    ...
    public final void E(String service_code, Context context, String service_name) {
        ...
        if (service_code.equals("901")) {
            try {
                Intent intent8 = new Intent(this.e, (Class<?>) VahanDownloadReceiptActivity.class);
                intent8.putExtra("service_name", ta3.a.U(this.e, service_code, service_name));
        ...
        if (service_code.equals("903")) {
            try {
                Intent intent9 = new Intent(this.e, (Class<?>) DownloadFormHomeScreen.class);
                intent9.putExtra("service_name", service_name);
        ...
        if (service_code.equals("907")) {
            try {
                Intent intent10 = new Intent(this.e, (Class<?>) DownloadNocHomeScreen.class);
        ...
        if (service_code.equals("910")) {
            try {
                Intent intent11 = new Intent(this.e, (Class<?>) DuplicateFitnessCertificateDownload.class);
        ...
        if (service_code.equals(VContant.Tax_PURPOSE_CODE) || service_code.equals("101")) {
            ...
            Intent intent12 = new Intent(context, (Class<?>) VahanMainViewScreen.class);
            intent12.putExtra("state_code", this.f);
        ...
        if (service_code.equals(VContant.TRANFER_OF_OWNERSHIP_PURPOSE_CODE)) {
            ...
            Intent intent21 = new Intent(context, (Class<?>) SellerBuyerSelectionActivity.class);
        ...
        if (service_code.equals(VContant.RC_PERMIT_RENEWAL_PURPOSE_CODE)) {
            ...
            Intent intent22 = new Intent(context, (Class<?>) VahanMainViewScreen.class);
        ...
        if (service_code.equals(VContant.NOMINEE_PURPOSE_CODE)) {
            ...
            Intent intent24 = new Intent(context, (Class<?>) NomineeMainViewScreen.class);
        ...
        if (service_code.equals(VContant.MISELL_PURPOSE_CODE)) {
            ...
            Intent intent25 = new Intent(context, (Class<?>) VahanMainViewScreen.class);
        ...
        if (service_code.equals("904")) {
            Intent intent27 = new Intent(context, (Class<?>) DownloadAppoinmentScreen.class);
            intent27.putExtra("service_name", service_name);
            ...
            if (service_code.equals(VContant.UPDATE_MOBILE_PURPOSE_CODE)) {
                ...
                Intent intent28 = new Intent(context, (Class<?>) VahanMainViewScreen.class);
                intent28.putExtra("state_code", this.f);
