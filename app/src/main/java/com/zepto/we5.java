...
public class we5 extends Drawable {
    public float a;
    ...
    public we5(ColorStateList colorStateList, float f) {
        this.a = f;
        e(colorStateList);
        this.c = new RectF();
        this.d = new Rect();
    ...
    public final void i(Rect rect) {
        ...
        this.d.set(rect);
        if (this.f) {
            this.d.inset((int) Math.ceil(xe5.a(this.e, this.a, this.g)), (int) Math.ceil(xe5.b(this.e, this.a, this.g)));
            this.c.set(this.d);
        }
    }
