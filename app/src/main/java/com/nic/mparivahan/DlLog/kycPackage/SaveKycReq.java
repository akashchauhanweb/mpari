...
public final class SaveKycReq extends Worker {
    ...
    public SaveKycReq(Context context, WorkerParameters workerParams) {
    ...
    public final void r(String avAadharno, String avRtoCode, String avTxn, String avExt1, String avExt2, int avAccd) {
        DlLogInterface dlLogInterfaceB = DlLogInterface.INSTANCE.b(this.context);
        lc5.a aVar = lc5.Companion;
        ls3 ls3VarB = ls3.g.b("application/json");
        String string = s(avAadharno, avRtoCode, avTxn, avExt1, avExt2, avAccd).toString();
        Intrinsics.checkNotNullExpressionValue(string, "toString(...)");
        lc5 lc5VarD = aVar.d(ls3VarB, string);
        String strValueOf = String.valueOf(System.currentTimeMillis());
        dlLogInterfaceB.saveKycRes(lc5VarD, strValueOf).enqueue(new b(strValueOf));
    }

    public final JSONObject s(String avAadharno, String avRtoCode, String avTxn, String avExt1, String avExt2, int avAccd) {
