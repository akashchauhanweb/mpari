...
public class fx1 extends ListView {
    public final Rect a;
    public int b;
    public int c;
    public int d;
    ...
    public static class b {
        ...
        public static void b(fx1 fx1Var, int i, View view) {
            try {
                a.invoke(fx1Var, Integer.valueOf(i), view, Boolean.FALSE, -1, -1);
                b.invoke(fx1Var, Integer.valueOf(i));
                c.invoke(fx1Var, Integer.valueOf(i));
    ...
    public static class d extends ax1 {
        public boolean b;
        ...
        @Override // com.zepto.ax1, android.graphics.drawable.Drawable
    ...
    public class f implements Runnable {
        ...
        public void run() {
            fx1 fx1Var = fx1.this;
            fx1Var.m = null;
            fx1Var.drawableStateChanged();
        }
    }

    public fx1(Context context, boolean z) {
        super(context, null, zy4.A);
        this.a = new Rect();
        this.b = 0;
        this.c = 0;
        this.d = 0;
    ...
    */
    public boolean e(android.view.MotionEvent r8, int r9) {
        ...
        L4d:
            if (r3 == 0) goto L65
            com.zepto.vf3 r9 = r7.l
            if (r9 != 0) goto L5a
            com.zepto.vf3 r9 = new com.zepto.vf3
            r9.<init>(r7)
            r7.l = r9
        L5a:
            com.zepto.vf3 r9 = r7.l
            ...
            goto L6c
        L65:
            com.zepto.vf3 r8 = r7.l
            if (r8 == 0) goto L6c
            r8.m(r2)
        L6c:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.zepto.fx1.e(android.view.MotionEvent, int):boolean");
    }
    ...
    public final void g(int i, View view) {
        ...
        if (z) {
            ...
            tw1.k(selector, fExactCenterX, fExactCenterY);
        }
    }
    ...
    public final boolean k() {
        return c80.c() ? c.a(this) : e.a(this);
    }
