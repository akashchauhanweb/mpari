...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        dq7.u0(this, new u5(this));
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, c25.a);
        this.e = typedArrayObtainStyledAttributes.getDrawable(c25.b);
        this.f = typedArrayObtainStyledAttributes.getDrawable(c25.d);
        this.j = typedArrayObtainStyledAttributes.getDimensionPixelSize(c25.j, -1);
        boolean z = true;
        if (getId() == b05.G) {
            this.h = true;
            this.g = typedArrayObtainStyledAttributes.getDrawable(c25.c);
        }
    ...
    public void onFinishInflate() {
        ...
        this.c = findViewById(b05.a);
        this.d = findViewById(b05.f);
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        setMeasuredDimension(getMeasuredWidth(), Math.min((!b(this.c) ? a(this.c) : !b(this.d) ? a(this.d) : 0) + a(this.b), mode == Integer.MIN_VALUE ? View.MeasureSpec.getSize(i2) : IntCompanionObject.MAX_VALUE));
    }
