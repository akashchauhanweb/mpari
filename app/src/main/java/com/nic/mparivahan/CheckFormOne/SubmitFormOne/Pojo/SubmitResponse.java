...
@Keep
@Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\f\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\b\u0087\b\u0018\u00002\u00020\u0001B#\u0012\f\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003\u0012\u0006\u0010\u0005\u001a\u00020\u0006\u0012\u0006\u0010\u0007\u001a\u00020\u0006¢\u0006\u0002\u0010\bJ\u000f\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003HÆ\u0003J\t\u0010\u000f\u001a\u00020\u0006HÆ\u0003J\t\u0010\u0010\u001a\u00020\u0006HÆ\u0003J-\u0010\u0011\u001a\u00020\u00002\u000e\b\u0002\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u00032\b\b\u0002\u0010\u0005\u001a\u00020\u00062\b\b\u0002\u0010\u0007\u001a\u00020\u0006HÆ\u0001J\u0013\u0010\u0012\u001a\u00020\u00132\b\u0010\u0014\u001a\u0004\u0018\u00010\u0001HÖ\u0003J\t\u0010\u0015\u001a\u00020\u0016HÖ\u0001J\t\u0010\u0017\u001a\u00020\u0006HÖ\u0001R\u0017\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\nR\u0011\u0010\u0005\u001a\u00020\u0006¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fR\u0011\u0010\u0007\u001a\u00020\u0006¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\f¨\u0006\u0018"}, d2 = {"Lcom/nic/mparivahan/CheckFormOne/SubmitFormOne/Pojo/SubmitResponse;", "", "foneObject", "", "Lcom/nic/mparivahan/CheckFormOne/SubmitFormOne/Pojo/FoneObject;", "status_code", "", "status_desc", "(Ljava/util/List;Ljava/lang/String;Ljava/lang/String;)V", "getFoneObject", "()Ljava/util/List;", "getStatus_code", "()Ljava/lang/String;", "getStatus_desc", "component1", "component2", "component3", "copy", "equals", "", "other", "hashCode", "", "toString", "app_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
public final /* data */ class SubmitResponse {
    private final List<FoneObject> foneObject;
    private final String status_code;
    private final String status_desc;

    public SubmitResponse(List<FoneObject> foneObject, String status_code, String status_desc) {
        Intrinsics.checkNotNullParameter(foneObject, "foneObject");
        Intrinsics.checkNotNullParameter(status_code, "status_code");
        Intrinsics.checkNotNullParameter(status_desc, "status_desc");
        this.foneObject = foneObject;
        this.status_code = status_code;
        this.status_desc = status_desc;
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ SubmitResponse copy$default(SubmitResponse submitResponse, List list, String str, String str2, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public final SubmitResponse copy(List<FoneObject> foneObject, String status_code, String status_desc) {
        Intrinsics.checkNotNullParameter(foneObject, "foneObject");
        Intrinsics.checkNotNullParameter(status_code, "status_code");
        Intrinsics.checkNotNullParameter(status_desc, "status_desc");
        return new SubmitResponse(foneObject, status_code, status_desc);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.foneObject, submitResponse.foneObject) && Intrinsics.areEqual(this.status_code, submitResponse.status_code) && Intrinsics.areEqual(this.status_desc, submitResponse.status_desc);
    }
