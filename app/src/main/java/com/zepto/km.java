...
public final class km extends ri2 implements bt3 {
    ...
    public static final class b extends ri2.a implements bt3 {
        ...
        public b() {
            super(km.DEFAULT_INSTANCE);
        }
    }

    static {
        km kmVar = new km();
        DEFAULT_INSTANCE = kmVar;
        ri2.Q(km.class, kmVar);
    }
    ...
    public static km b0(s80 s80Var, g72 g72Var) {
        return (km) ri2.K(DEFAULT_INSTANCE, s80Var, g72Var);
    }
