...
public abstract class k75 {
    ...
    public static void k(AccessibleObject accessibleObject) {
        try {
            ...
            throw new i53("Failed making " + f(accessibleObject, false) + " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type.", e);
        }
    }
