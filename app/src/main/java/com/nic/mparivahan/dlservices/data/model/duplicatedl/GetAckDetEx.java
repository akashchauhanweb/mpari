...
public final /* data */ class GetAckDetEx implements Serializable {
    ...
    public static /* synthetic */ GetAckDetEx copy$default(GetAckDetEx getAckDetEx, DlSubmitResult dlSubmitResult, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof GetAckDetEx) && Intrinsics.areEqual(this.dlSubmitresult, ((GetAckDetEx) other).dlSubmitresult);
    }
    ...
    public /* synthetic */ GetAckDetEx(DlSubmitResult dlSubmitResult, int i, DefaultConstructorMarker defaultConstructorMarker) {
