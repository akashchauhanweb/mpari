...
public final class h94 extends RecyclerView.h {
    ...
    public static final class b extends RecyclerView.d0 {
        ...
        private final void g0(DocumentListItem documentListItem) {
            ...
            try {
                ...
                if (documentListItem.getIssueDate().length() == 0 || Intrinsics.areEqual(documentListItem.getIssueDate(), "null")) {
                    this.E.setText("");
                } else {
    ...
    public static final class g extends Lambda implements Function1 {
        ...
        public final void a(UploadDocListResponse uploadDocListResponse) {
            ...
            h94Var.Y(proofList, editTextW, this.f);
        }
    ...
    public static final class h implements d86.b {
        ...
        public h(EditText editText, h94 h94Var, int i, List list) {
            this.a = editText;
            this.b = h94Var;
            this.c = i;
            this.d = list;
    ...
    public h94(Context context, Application application, ArrayList arrayList, a itemListener) {
    ...
    public static final void N(DocumentListItem documentListItem, b holder, h94 this$0, wa3 mSession, int i2, View view) {
        ...
        if (documentListItem == null || !documentListItem.getIsDocInsertedStatus() || StringsKt__StringsJVMKt.equals(documentListItem.getRemarks(), "Reject", true)) {
            if (holder.W().getText().toString().length() <= 0) {
                ...
                Toast.makeText(context, mSession.b("select_doc_type", context.getString(R.string.sel_doc_type)), 0).show();
    ...
    public static final void O(h94 this$0, int i2, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.g.a(i2);
    }

    public static final void P(DocumentListItem documentListItem, h94 this$0, int i2, wa3 mSession, b holder, View view) throws IOException {
        String strSubstring;
        ...
        if (numValueOf.intValue() > 0) {
            ...
            sb2.append((arrayList == null || (documentListItem3 = (DocumentListItem) arrayList.get(i2)) == null) ? null : documentListItem3.getApplication_no());
            sb2.append("&stateCode=");
            ArrayList arrayList2 = this$0.f;
            sb2.append((arrayList2 == null || (documentListItem2 = (DocumentListItem) arrayList2.get(i2)) == null) ? null : documentListItem2.getStateCode());
            sb2.append("&status=NP&j_key=vVl%2FAz1yGsjOAG18WDeScg%3D%3D&j_securityKey=");
            sb2.append(APIController.a().sarthiDMSKey());
            String string = sb2.toString();
            Log.d("DMS_URL_FOR_IMAGE", string);
            ...
            if (fileNmae5 == null || !StringsKt__StringsKt.contains$default((CharSequence) fileNmae5, (CharSequence) ".pdf", false, 2, (Object) null)) {
                ...
                textView.setText(mSession.b("btn_ok", this$0.d.getString(R.string.ok_txt)));
                textView.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.g94
                ...
                try {
                    ...
                    Context context = this$0.d;
                    Toast.makeText(context, mSession.b("service_is_not_present", context.getString(R.string.no_Details_are_avail)), 0).show();
                }
                dialog.show();
            }
        }
    ...
    public static final void R(DocumentListItem documentListItem, h94 this$0, final b holder, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(holder, "$holder");
        if (documentListItem == null || !documentListItem.getIsDocInsertedStatus()) {
            DatePickerDialog datePickerDialog = new DatePickerDialog(this$0.d, new DatePickerDialog.OnDateSetListener() { // from class: com.zepto.f94
                @Override // android.app.DatePickerDialog.OnDateSetListener
                public final void onDateSet(DatePicker datePicker, int i2, int i3, int i4) {
                    h94.S(holder, datePicker, i2, i3, i4);
                }
    ...
    public static final void T(DocumentListItem documentListItem, h94 this$0, b holder, int i2, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(holder, "$holder");
        if (documentListItem == null || !documentListItem.getIsDocInsertedStatus()) {
    ...
    public static final void W(DocumentListItem documentListItem, b holder, h94 this$0, wa3 mSession, int i2, View view) {
        Intrinsics.checkNotNullParameter(holder, "$holder");
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(mSession, "$mSession");
        if (documentListItem == null || !documentListItem.getIsDocInsertedStatus() || StringsKt__StringsJVMKt.equals(documentListItem.getRemarks(), "Reject", true)) {
    ...
    public void p(final b holder, final int i2) {
        ...
        final wa3 wa3Var = new wa3(this.d);
        holder.W().setHint(wa3Var.b("select_documents", this.d.getString(R.string.select_documents)));
        holder.a0().setHint(wa3Var.b("issuer", this.d.getString(R.string.issuer)));
        holder.V().setHint(wa3Var.b("doc_number", this.d.getString(R.string.doc_number)));
        holder.T().setHint(wa3Var.b("con_number", this.d.getString(R.string.con_number)));
        holder.b0().setHint(wa3Var.b("d_i_d", this.d.getString(R.string.d_i_d)));
        holder.Y().setText(wa3Var.b("doc_documents", this.d.getString(R.string.documents)));
        holder.Z().setText(wa3Var.b("label_gallery", this.d.getString(R.string.gallery)));
        holder.X().setText(wa3Var.b("label_capture", this.d.getString(R.string.capture)));
        holder.f0().setText(wa3Var.b("label_view", "View"));
        holder.d0().setText(wa3Var.b("label_edit", "Edit"));
        ...
        holder.b0().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.x84
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                h94.R(documentListItem, this, holder, view);
            }
        });
        holder.W().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.y84
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                h94.T(documentListItem, this, holder, i2, view);
            }
        });
        holder.P().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.z84
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                h94.U(holder, view);
            }
        });
        holder.Q().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.a94
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                h94.V(holder, view);
            }
        ...
        holder.S().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.b94
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                h94.W(documentListItem2, holder, this, wa3Var, i2, view);
            }
        });
        holder.R().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.c94
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                h94.N(documentListItem2, holder, this, wa3Var, i2, view);
            }
        });
        holder.U().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.d94
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                h94.O(this.a, i2, view);
            }
        });
        final DocumentListItem documentListItem3 = documentListItem;
        holder.e0().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.e94
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) throws IOException {
                h94.P(documentListItem3, this, i2, wa3Var, holder, view);
            }
        });
    }
