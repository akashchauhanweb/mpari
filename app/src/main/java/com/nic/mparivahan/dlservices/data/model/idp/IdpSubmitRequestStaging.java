...
public final /* data */ class IdpSubmitRequestStaging {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof IdpSubmitRequestStaging)) {
            return false;
        }
        IdpSubmitRequestStaging idpSubmitRequestStaging = (IdpSubmitRequestStaging) other;
        return Intrinsics.areEqual(this.dlno, idpSubmitRequestStaging.dlno) && Intrinsics.areEqual(this.dob, idpSubmitRequestStaging.dob) && Intrinsics.areEqual(this.rtoCodeDLTr, idpSubmitRequestStaging.rtoCodeDLTr) && Intrinsics.areEqual(this.selectedDLSerList, idpSubmitRequestStaging.selectedDLSerList) && Intrinsics.areEqual(this.pofbirth, idpSubmitRequestStaging.pofbirth) && Intrinsics.areEqual(this.country, idpSubmitRequestStaging.country) && Intrinsics.areEqual(this.passno, idpSubmitRequestStaging.passno) && Intrinsics.areEqual(this.passvaltill, idpSubmitRequestStaging.passvaltill) && Intrinsics.areEqual(this.visano, idpSubmitRequestStaging.visano) && Intrinsics.areEqual(this.visavaltill, idpSubmitRequestStaging.visavaltill) && Intrinsics.areEqual(this.cov_req, idpSubmitRequestStaging.cov_req) && Intrinsics.areEqual(this.tovisit, idpSubmitRequestStaging.tovisit) && Intrinsics.areEqual(this.iscountryrestricted, idpSubmitRequestStaging.iscountryrestricted) && Intrinsics.areEqual(this.countryRestrictedReason, idpSubmitRequestStaging.countryRestrictedReason) && Intrinsics.areEqual(this.isDlSerdisqualified, idpSubmitRequestStaging.isDlSerdisqualified) && Intrinsics.areEqual(this.dlSerdisqualifiedReason, idpSubmitRequestStaging.dlSerdisqualifiedReason) && Intrinsics.areEqual(this.forAdd1, idpSubmitRequestStaging.forAdd1) && Intrinsics.areEqual(this.forAdd2, idpSubmitRequestStaging.forAdd2) && Intrinsics.areEqual(this.forAdd3, idpSubmitRequestStaging.forAdd3) && Intrinsics.areEqual(this.forAddPinCode, idpSubmitRequestStaging.forAddPinCode) && Intrinsics.areEqual(this.forNationMobNum, idpSubmitRequestStaging.forNationMobNum) && Intrinsics.areEqual(this.emailID, idpSubmitRequestStaging.emailID) && Intrinsics.areEqual(this.appliedIdpfromIndEmb, idpSubmitRequestStaging.appliedIdpfromIndEmb) && Intrinsics.areEqual(this.indEmbName, idpSubmitRequestStaging.indEmbName) && Intrinsics.areEqual(this.embPlace, idpSubmitRequestStaging.embPlace) && Intrinsics.areEqual(this.dateOfVerifEmb, idpSubmitRequestStaging.dateOfVerifEmb) && Intrinsics.areEqual(this.embEndorseNo, idpSubmitRequestStaging.embEndorseNo) && Intrinsics.areEqual(this.idpcountryapplyfrom, idpSubmitRequestStaging.idpcountryapplyfrom) && Intrinsics.areEqual(this.agentId, idpSubmitRequestStaging.agentId) && Intrinsics.areEqual(this.agentPwd, idpSubmitRequestStaging.agentPwd) && Intrinsics.areEqual(this.agentIpAddress, idpSubmitRequestStaging.agentIpAddress) && Intrinsics.areEqual(this.agentServiceName, idpSubmitRequestStaging.agentServiceName) && Intrinsics.areEqual(this.mobileNumber, idpSubmitRequestStaging.mobileNumber) && Intrinsics.areEqual(this.eKYCId, idpSubmitRequestStaging.eKYCId) && Intrinsics.areEqual(this.eKYCOpted, idpSubmitRequestStaging.eKYCOpted) && Intrinsics.areEqual(this.eKYCGender, idpSubmitRequestStaging.eKYCGender) && Intrinsics.areEqual(this.eKYCapplicantPhoto, idpSubmitRequestStaging.eKYCapplicantPhoto);
    }
