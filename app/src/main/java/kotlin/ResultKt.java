...
public final class ResultKt {
    ...
    private static final <R, T> R fold(Object obj, Function1<? super T, ? extends R> onSuccess, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        return thM9exceptionOrNullimpl == null ? onSuccess.invoke(obj) : onFailure.invoke(thM9exceptionOrNullimpl);
    }
    ...
    private static final <R, T extends R> R getOrDefault(Object obj, R r) {
        return Result.m12isFailureimpl(obj) ? r : obj;
    }
    ...
    private static final <R, T extends R> R getOrElse(Object obj, Function1<? super Throwable, ? extends R> onFailure) {
        Intrinsics.checkNotNullParameter(onFailure, "onFailure");
        Throwable thM9exceptionOrNullimpl = Result.m9exceptionOrNullimpl(obj);
        return thM9exceptionOrNullimpl == null ? obj : onFailure.invoke(thM9exceptionOrNullimpl);
    }
    ...
    private static final <R, T> Object map(Object obj, Function1<? super T, ? extends R> transform) {
        ...
        return Result.m13isSuccessimpl(obj) ? Result.m6constructorimpl(transform.invoke(obj)) : Result.m6constructorimpl(obj);
    }
    ...
    private static final <T> Object onFailure(Object obj, Function1<? super Throwable, Unit> action) {
        ...
        if (thM9exceptionOrNullimpl != null) {
            action.invoke(thM9exceptionOrNullimpl);
        }
        return obj;
    }
    ...
    private static final <R, T extends R> Object recover(Object obj, Function1<? super Throwable, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        Throwable thM9exceptionOrNullimpl = Result.m9exceptionOrNullimpl(obj);
        return thM9exceptionOrNullimpl == null ? obj : Result.m6constructorimpl(transform.invoke(thM9exceptionOrNullimpl));
    }
    ...
    private static final <R, T extends R> Object recoverCatching(Object obj, Function1<? super Throwable, ? extends R> transform) {
        ...
        try {
            return Result.m6constructorimpl(transform.invoke(thM9exceptionOrNullimpl));
        } catch (Throwable th) {
            Result.Companion companion = Result.INSTANCE;
            return Result.m6constructorimpl(createFailure(th));
        }
    ...
    private static final <T, R> Object runCatching(T t, Function1<? super T, ? extends R> block) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m6constructorimpl(block.invoke(t));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m6constructorimpl(createFailure(th));
        }
