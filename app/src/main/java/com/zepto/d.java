...
public abstract class d {
    ...
    public static final class b implements ParameterizedType, Serializable {
        ...
        public b(Type type, Type type2, Type... typeArr) {
            ...
            this.c = type == null ? null : d.b(type);
            this.e = d.b(type2);
        ...
        public String toString() {
            ...
            sb.append(d.t(this.e));
            sb.append("<");
            sb.append(d.t(this.f[0]));
            for (int i = 1; i < length; i++) {
                sb.append(", ");
                sb.append(d.t(this.f[i]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    public static final class c implements WildcardType, Serializable {
        ...
        public c(Type[] typeArr, Type[] typeArr2) {
            com.zepto.a.a(typeArr2.length <= 1);
            com.zepto.a.a(typeArr.length == 1);
            if (typeArr2.length != 1) {
                Objects.requireNonNull(typeArr[0]);
                d.c(typeArr[0]);
                this.e = null;
                this.c = d.b(typeArr[0]);
                return;
            }
            Objects.requireNonNull(typeArr2[0]);
            d.c(typeArr2[0]);
            com.zepto.a.a(typeArr[0] == Object.class);
            this.e = d.b(typeArr2[0]);
            this.c = Object.class;
        }
        ...
        public String toString() {
            if (this.e != null) {
                return "? super " + d.t(this.e);
            }
            if (this.c == Object.class) {
                return "?";
            }
            return "? extends " + d.t(this.c);
        }
    }
    ...
    public static void c(Type type) {
        com.zepto.a.a(((type instanceof Class) && ((Class) type).isPrimitive()) ? false : true);
    }
    ...
    public static Class k(Type type) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            com.zepto.a.a(rawType instanceof Class);
    ...
    public static Type l(Type type, Class cls, Class cls2) {
        ...
        com.zepto.a.a(cls2.isAssignableFrom(cls));
    ...
    */
    public static java.lang.reflect.Type p(java.lang.reflect.Type r9, java.lang.Class r10, java.lang.reflect.Type r11, java.util.Map r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.zepto.d.p(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type, java.util.Map):java.lang.reflect.Type");
    }
