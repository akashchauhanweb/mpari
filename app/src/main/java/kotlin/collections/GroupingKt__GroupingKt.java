...
class GroupingKt__GroupingKt extends GroupingKt__GroupingJVMKt {
    ...
    public static final <T, K, R> Map<K, R> aggregate(Grouping<T, ? extends K> grouping, Function4<? super K, ? super R, ? super T, ? super Boolean, ? extends R> operation) {
        ...
        while (itSourceIterator.hasNext()) {
            ...
            AppBlackListingSharedPreferenceHelper appBlackListingSharedPreferenceHelper = (Object) linkedHashMap.get(objKeyOf);
            linkedHashMap.put(objKeyOf, operation.invoke(objKeyOf, appBlackListingSharedPreferenceHelper, next, Boolean.valueOf(appBlackListingSharedPreferenceHelper == null && !linkedHashMap.containsKey(objKeyOf))));
        }
    ...
    public static final <T, K, R, M extends Map<? super K, R>> M aggregateTo(Grouping<T, ? extends K> grouping, M destination, Function4<? super K, ? super R, ? super T, ? super Boolean, ? extends R> operation) {
        ...
        while (itSourceIterator.hasNext()) {
            ?? next = itSourceIterator.next();
            Object objKeyOf = grouping.keyOf(next);
            AppBlackListingSharedPreferenceHelper appBlackListingSharedPreferenceHelper = (Object) destination.get(objKeyOf);
            destination.put(objKeyOf, operation.invoke(objKeyOf, appBlackListingSharedPreferenceHelper, next, Boolean.valueOf(appBlackListingSharedPreferenceHelper == null && !destination.containsKey(objKeyOf))));
        }
        return destination;
    }
    ...
    public static final <S, T extends S, K> Map<K, S> reduce(Grouping<T, ? extends K> grouping, Function3<? super K, ? super S, ? super T, ? extends S> operation) {
        ...
        while (itSourceIterator.hasNext()) {
            ...
            AppBlackListingSharedPreferenceHelper appBlackListingSharedPreferenceHelper = (Object) linkedHashMap.get(objKeyOf);
            if (!(appBlackListingSharedPreferenceHelper == null && !linkedHashMap.containsKey(objKeyOf))) {
                sInvoke = operation.invoke(objKeyOf, appBlackListingSharedPreferenceHelper, sInvoke);
            }
    ...
    public static final <S, T extends S, K, M extends Map<? super K, S>> M reduceTo(Grouping<T, ? extends K> grouping, M destination, Function3<? super K, ? super S, ? super T, ? extends S> operation) {
        ...
        while (itSourceIterator.hasNext()) {
            ...
            Object objKeyOf = grouping.keyOf(sInvoke);
            AppBlackListingSharedPreferenceHelper appBlackListingSharedPreferenceHelper = (Object) destination.get(objKeyOf);
            if (!(appBlackListingSharedPreferenceHelper == null && !destination.containsKey(objKeyOf))) {
                sInvoke = operation.invoke(objKeyOf, appBlackListingSharedPreferenceHelper, sInvoke);
            }
    ...
    public static final <T, K, R, M extends Map<? super K, R>> M foldTo(Grouping<T, ? extends K> grouping, M destination, R r, Function2<? super R, ? super T, ? extends R> operation) {
        ...
        while (itSourceIterator.hasNext()) {
            ...
            AppBlackListingSharedPreferenceHelper appBlackListingSharedPreferenceHelper = (Object) destination.get(kKeyOf);
            if (appBlackListingSharedPreferenceHelper == null && !destination.containsKey(kKeyOf)) {
                appBlackListingSharedPreferenceHelper = (Object) r;
            }
            destination.put(kKeyOf, operation.invoke(appBlackListingSharedPreferenceHelper, next));
        }
        return destination;
    }
    ...
    public static final <T, K, R> Map<K, R> fold(Grouping<T, ? extends K> grouping, R r, Function2<? super R, ? super T, ? extends R> operation) {
        ...
        while (itSourceIterator.hasNext()) {
            ?? next = itSourceIterator.next();
            K kKeyOf = grouping.keyOf(next);
            AppBlackListingSharedPreferenceHelper appBlackListingSharedPreferenceHelper = (Object) linkedHashMap.get(kKeyOf);
            if (appBlackListingSharedPreferenceHelper == null && !linkedHashMap.containsKey(kKeyOf)) {
                appBlackListingSharedPreferenceHelper = (Object) r;
            }
            linkedHashMap.put(kKeyOf, operation.invoke(appBlackListingSharedPreferenceHelper, next));
        }
        return linkedHashMap;
    }
}
