...
public final class ny6 extends LinearLayout {
    ...
    public ny6(Context context, ArrayList eventObjectses) {
        super(context);
    ...
    public static final void h(ny6 this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.d();
    }

    public static final void j(ny6 this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.e();
    }
    ...
    public final void g() {
        ...
        if (imageView != null) {
            imageView.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.ly6
    ...
    public final ArrayList<ca0> getEventObjectses() {
        return this.j;
    }
    ...
    public final void i() {
        ...
        if (imageView != null) {
            imageView.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.my6
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    ny6.j(this.a, view);
                }
    ...
    public final void k() {
        ...
        oy6 oy6Var = new oy6(context, arrayList, cal, this.j);
        this.i = oy6Var;
        ExpandableHeightGridView expandableHeightGridView = this.e;
        if (expandableHeightGridView == null) {
            return;
        }
        expandableHeightGridView.setAdapter((ListAdapter) oy6Var);
    }
    ...
    public final void setEventObjectses(ArrayList<ca0> arrayList) {
