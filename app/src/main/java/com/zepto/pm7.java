...
public class pm7 extends hd5 {
    public static boolean c;
    public final WeakReference b;

    public pm7(Context context, Resources resources) {
        super(resources);
    ...
    @Override // com.zepto.hd5, android.content.res.Resources
    ...
    public Drawable getDrawable(int i) {
        ...
        return context != null ? cd5.g().s(context, this, i) : a(i);
    }
