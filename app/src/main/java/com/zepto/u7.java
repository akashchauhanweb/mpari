...
public final class u7 {
    ...
    public u7(ScrollView scrollView, RadioButton radioButton, MyTextView myTextView, TextView textView, CheckBox checkBox, FrameLayout frameLayout, EditText editText, iy3 iy3Var, vy3 vy3Var, RadioGroup radioGroup, ImageView imageView, TextView textView2, TextView textView3, TextView textView4, RadioButton radioButton2) {
        this.a = scrollView;
        this.b = radioButton;
        this.c = myTextView;
        this.d = textView;
                                                    ...
                                                    if (textView3 != null) {
                                                        ...
                                                        if (textView4 != null) {
                                                            ...
                                                            if (radioButton2 != null) {
                                                                return new u7((ScrollView) view, radioButton, myTextView, textView, checkBox, frameLayout, editText, iy3VarA, vy3VarA, radioGroup, imageView, textView2, textView3, textView4, radioButton2);
                                                            }
                                                        }
                                                    }
                                                }
    ...
    public static u7 d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_cl_mob_update_adhar, viewGroup, false);
        if (z) {
