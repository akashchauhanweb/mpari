...
final class AdjustedTimeMark implements TimeMark {
    ...
    public long mo1333elapsedNowUwyO8pc() {
        return Duration.m1378minusLRDsOJo(this.mark.mo1333elapsedNowUwyO8pc(), this.adjustment);
    }
    ...
    public TimeMark mo1334minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1480minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo1336plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1379plusLRDsOJo(this.adjustment, duration), null);
    }
