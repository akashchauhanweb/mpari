...
public final /* data */ class TaxGroupDetail {
    ...
    public static /* synthetic */ TaxGroupDetail copy$default(TaxGroupDetail taxGroupDetail, double d, double d2, double d3, String str, double d4, Object obj, double d5, double d6, Object obj2, double d7, int i, int i2, String str2, double d8, Object obj3, int i3, double d9, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, int i4, Object obj4) {
        double d10 = (i4 & 1) != 0 ? taxGroupDetail.amount : d;
        double d11 = (i4 & 2) != 0 ? taxGroupDetail.amount1 : d2;
        double d12 = (i4 & 4) != 0 ? taxGroupDetail.amount2 : d3;
        String str12 = (i4 & 8) != 0 ? taxGroupDetail.applicationstatus : str;
        double d13 = (i4 & 16) != 0 ? taxGroupDetail.fine : d4;
        Object obj5 = (i4 & 32) != 0 ? taxGroupDetail.g_TAX_UPTO : obj;
        double d14 = (i4 & 64) != 0 ? taxGroupDetail.gamount : d5;
        double d15 = (i4 & 128) != 0 ? taxGroupDetail.interest : d6;
        Object obj6 = (i4 & 256) != 0 ? taxGroupDetail.pay_due_date : obj2;
        double d16 = (i4 & ConstantsKt.MINIMUM_BLOCK_SIZE) != 0 ? taxGroupDetail.penalty : d7;
        int i5 = (i4 & 1024) != 0 ? taxGroupDetail.prv_ADJ : i;
        return taxGroupDetail.copy(d10, d11, d12, str12, d13, obj5, d14, d15, obj6, d16, i5, (i4 & 2048) != 0 ? taxGroupDetail.pur_CD : i2, (i4 & ConstantsKt.DEFAULT_BLOCK_SIZE) != 0 ? taxGroupDetail.rcpt_dt : str2, (i4 & ConstantsKt.DEFAULT_BUFFER_SIZE) != 0 ? taxGroupDetail.rebate : d8, (i4 & 16384) != 0 ? taxGroupDetail.receipt_no : obj3, (32768 & i4) != 0 ? taxGroupDetail.sr_no : i3, (i4 & 65536) != 0 ? taxGroupDetail.surcharge : d9, (i4 & 131072) != 0 ? taxGroupDetail.tax_EXAM_UPTO : str3, (262144 & i4) != 0 ? taxGroupDetail.tax_FROM : str4, (i4 & 524288) != 0 ? taxGroupDetail.tax_HEAD : str5, (i4 & 1048576) != 0 ? taxGroupDetail.tax_MODE : str6, (i4 & 2097152) != 0 ? taxGroupDetail.tax_UPTO : str7, (i4 & 4194304) != 0 ? taxGroupDetail.tax_clear_upto : str8, (i4 & 8388608) != 0 ? taxGroupDetail.tax_from_date : str9, (i4 & 16777216) != 0 ? taxGroupDetail.tax_upto_date : str10, (i4 & 33554432) != 0 ? taxGroupDetail.transaction_no : str11);
    }
    ...
    public final TaxGroupDetail copy(double amount, double amount1, double amount2, String applicationstatus, double fine, Object g_TAX_UPTO, double gamount, double interest, Object pay_due_date, double penalty, int prv_ADJ, int pur_CD, String rcpt_dt, double rebate, Object receipt_no, int sr_no, double surcharge, String tax_EXAM_UPTO, String tax_FROM, String tax_HEAD, String tax_MODE, String tax_UPTO, String tax_clear_upto, String tax_from_date, String tax_upto_date, String transaction_no) {
        Intrinsics.checkNotNullParameter(applicationstatus, "applicationstatus");
        Intrinsics.checkNotNullParameter(g_TAX_UPTO, "g_TAX_UPTO");
        Intrinsics.checkNotNullParameter(pay_due_date, "pay_due_date");
        Intrinsics.checkNotNullParameter(rcpt_dt, "rcpt_dt");
        ...
        Intrinsics.checkNotNullParameter(tax_upto_date, "tax_upto_date");
        Intrinsics.checkNotNullParameter(transaction_no, "transaction_no");
        return new TaxGroupDetail(amount, amount1, amount2, applicationstatus, fine, g_TAX_UPTO, gamount, interest, pay_due_date, penalty, prv_ADJ, pur_CD, rcpt_dt, rebate, receipt_no, sr_no, surcharge, tax_EXAM_UPTO, tax_FROM, tax_HEAD, tax_MODE, tax_UPTO, tax_clear_upto, tax_from_date, tax_upto_date, transaction_no);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TaxGroupDetail)) {
            return false;
        }
        TaxGroupDetail taxGroupDetail = (TaxGroupDetail) other;
        return Double.compare(this.amount, taxGroupDetail.amount) == 0 && Double.compare(this.amount1, taxGroupDetail.amount1) == 0 && Double.compare(this.amount2, taxGroupDetail.amount2) == 0 && Intrinsics.areEqual(this.applicationstatus, taxGroupDetail.applicationstatus) && Double.compare(this.fine, taxGroupDetail.fine) == 0 && Intrinsics.areEqual(this.g_TAX_UPTO, taxGroupDetail.g_TAX_UPTO) && Double.compare(this.gamount, taxGroupDetail.gamount) == 0 && Double.compare(this.interest, taxGroupDetail.interest) == 0 && Intrinsics.areEqual(this.pay_due_date, taxGroupDetail.pay_due_date) && Double.compare(this.penalty, taxGroupDetail.penalty) == 0 && this.prv_ADJ == taxGroupDetail.prv_ADJ && this.pur_CD == taxGroupDetail.pur_CD && Intrinsics.areEqual(this.rcpt_dt, taxGroupDetail.rcpt_dt) && Double.compare(this.rebate, taxGroupDetail.rebate) == 0 && Intrinsics.areEqual(this.receipt_no, taxGroupDetail.receipt_no) && this.sr_no == taxGroupDetail.sr_no && Double.compare(this.surcharge, taxGroupDetail.surcharge) == 0 && Intrinsics.areEqual(this.tax_EXAM_UPTO, taxGroupDetail.tax_EXAM_UPTO) && Intrinsics.areEqual(this.tax_FROM, taxGroupDetail.tax_FROM) && Intrinsics.areEqual(this.tax_HEAD, taxGroupDetail.tax_HEAD) && Intrinsics.areEqual(this.tax_MODE, taxGroupDetail.tax_MODE) && Intrinsics.areEqual(this.tax_UPTO, taxGroupDetail.tax_UPTO) && Intrinsics.areEqual(this.tax_clear_upto, taxGroupDetail.tax_clear_upto) && Intrinsics.areEqual(this.tax_from_date, taxGroupDetail.tax_from_date) && Intrinsics.areEqual(this.tax_upto_date, taxGroupDetail.tax_upto_date) && Intrinsics.areEqual(this.transaction_no, taxGroupDetail.transaction_no);
    }
