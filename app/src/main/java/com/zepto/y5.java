...
public class y5 implements h96 {
    public final int a;
    public final int b;
    public final int c;
    ...
    public int h = ConstantsKt.DEFAULT_BLOCK_SIZE;
    public int j = ConstantsKt.DEFAULT_BLOCK_SIZE;
    ...
    public y5(Context context, int i, int i2, int i3, int i4, CharSequence charSequence) {
        this.l = context;
        this.a = i2;
        this.b = i;
        this.c = i4;
