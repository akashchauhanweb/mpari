...
public final class xl extends ri2 implements bt3 {
    private static final xl DEFAULT_INSTANCE;
    ...
    public static final class b extends ri2.a implements bt3 {
        ...
        public b() {
            super(xl.DEFAULT_INSTANCE);
        }
    }

    static {
        xl xlVar = new xl();
        DEFAULT_INSTANCE = xlVar;
        ri2.Q(xl.class, xlVar);
    }
    ...
    public static xl c0(s80 s80Var, g72 g72Var) {
        return (xl) ri2.K(DEFAULT_INSTANCE, s80Var, g72Var);
    }
    ...
    public cm Z() {
        cm cmVar = this.params_;
        return cmVar == null ? cm.W() : cmVar;
    }
