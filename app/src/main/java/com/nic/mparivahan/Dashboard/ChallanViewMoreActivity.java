...
public final class ChallanViewMoreActivity extends pq {
    ...
    public static final class a extends Lambda implements Function1 {
        ...
        public final void a(EnableServiceResponse enableServiceResponse) {
            ...
            try {
                if (ChallanViewMoreActivity.this.r1().isShowing()) {
                    ChallanViewMoreActivity.this.r1().dismiss();
                }
                if (!StringsKt__StringsJVMKt.equals(enableServiceResponse.getStatusCode(), "MSTR001", true)) {
                    RecyclerView recyclerView2 = ChallanViewMoreActivity.this.challan_recyclerView;
                ...
                RecyclerView recyclerView3 = ChallanViewMoreActivity.this.challan_recyclerView;
                if (recyclerView3 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("challan_recyclerView");
                    recyclerView3 = null;
                }
                recyclerView3.setVisibility(0);
                RecyclerView recyclerView4 = ChallanViewMoreActivity.this.challan_recyclerView;
                if (recyclerView4 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("challan_recyclerView");
                    recyclerView4 = null;
                }
                recyclerView4.setLayoutManager(new GridLayoutManager(ChallanViewMoreActivity.this, 4));
                ...
                if (enabledservice.size() <= 0) {
                    RecyclerView recyclerView5 = ChallanViewMoreActivity.this.challan_recyclerView;
                ...
                if (!aVar.g(enabledservice, "2001")) {
                    ChallanViewMoreActivity challanViewMoreActivity = ChallanViewMoreActivity.this;
                    j32 j32Var = new j32(enabledservice, challanViewMoreActivity, String.valueOf(challanViewMoreActivity.getIntent().getStringExtra("state_code")));
                    RecyclerView recyclerView6 = ChallanViewMoreActivity.this.challan_recyclerView;
                    if (recyclerView6 == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("challan_recyclerView");
                        recyclerView6 = null;
                    }
                    recyclerView6.setAdapter(j32Var);
                    j32Var.j();
                    return;
                }
                if (aVar.i(enabledservice, "2001") > -1) {
                    ...
                    ChallanViewMoreActivity challanViewMoreActivity2 = ChallanViewMoreActivity.this;
                    j32 j32Var2 = new j32(list, challanViewMoreActivity2, String.valueOf(challanViewMoreActivity2.getIntent().getStringExtra("state_code")));
                    RecyclerView recyclerView7 = ChallanViewMoreActivity.this.challan_recyclerView;
                    if (recyclerView7 == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("challan_recyclerView");
                        recyclerView7 = null;
                    }
                    recyclerView7.setAdapter(j32Var2);
                    j32Var2.j();
                }
            } catch (Exception e) {
                e.printStackTrace();
                RecyclerView recyclerView8 = ChallanViewMoreActivity.this.challan_recyclerView;
    ...
    private final void s1() {
        ...
        appCompatImageView.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.pc0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChallanViewMoreActivity.t1(this.a, view);
            }
        });
        ...
        relativeLayout.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.qc0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChallanViewMoreActivity.u1(this.a, view);
            }
        });
        ...
        linearLayout2.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.rc0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChallanViewMoreActivity.v1(this.a, view);
            }
        });
        ...
        linearLayout3.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.sc0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChallanViewMoreActivity.w1(this.a, view);
            }
        });
        ...
        linearLayout4.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.tc0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChallanViewMoreActivity.x1(this.a, view);
            }
        });
        ...
        linearLayout5.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.uc0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChallanViewMoreActivity.y1(this.a, view);
            }
        });
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.vc0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChallanViewMoreActivity.z1(this.a, view);
            }
        });
    ...
    public static final void t1(ChallanViewMoreActivity this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.onBackPressed();
    }

    public static final void u1(ChallanViewMoreActivity this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.onBackPressed();
    }

    public static final void v1(ChallanViewMoreActivity this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.startActivity(new Intent(this$0, (Class<?>) SearchPrintReceiptActivity.class));
    }

    public static final void w1(ChallanViewMoreActivity this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.startActivity(new Intent(this$0, (Class<?>) SearchChallanOnlineActivity.class));
    }

    public static final void x1(ChallanViewMoreActivity this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.startActivity(new Intent(this$0, (Class<?>) PaymentSearchChallan.class));
    }

    public static final void y1(ChallanViewMoreActivity this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.startActivity(new Intent(this$0, (Class<?>) VerifyPaymentChallan.class));
    }

    public static final void z1(ChallanViewMoreActivity this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
