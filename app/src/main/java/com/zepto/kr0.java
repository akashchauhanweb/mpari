...
public final class kr0 {
    ...
    public final boolean F(CharSequence charSequence, boolean z) {
        return (z ? te6.d : te6.c).a(charSequence, 0, charSequence.length());
    }
    ...
    public void H(Configuration configuration) {
        if (Build.VERSION.SDK_INT >= 31) {
            ...
            if (typeface != null) {
                this.x = hp6.b(configuration, typeface);
            }
            Typeface typeface2 = this.B;
            if (typeface2 != null) {
                this.A = hp6.b(configuration, typeface2);
            }
    ...
    public void P(int i) {
        pe6 pe6Var = new pe6(this.a.getContext(), i);
        if (pe6Var.i() != null) {
            this.o = pe6Var.i();
        }
        if (pe6Var.j() != 0.0f) {
        ...
        ColorStateList colorStateList = pe6Var.c;
        ...
        this.E = new wa0(new a(), pe6Var.e());
        pe6Var.h(this.a.getContext(), this.E);
        J();
    }
    ...
    public final boolean U(Typeface typeface) {
        ...
        this.y = typeface;
        Typeface typefaceB = hp6.b(this.a.getContext().getResources().getConfiguration(), typeface);
        this.x = typefaceB;
        if (typefaceB == null) {
            typefaceB = this.y;
        }
    ...
    public final void b(boolean z) {
        ...
        int iB = jk2.b(this.k, this.I ? 1 : 0);
        int i = iB & 112;
        if (i == 48) {
            this.r = this.h.top;
        } else if (i != 80) {
        ...
        int iB2 = jk2.b(this.j, this.I ? 1 : 0);
        int i3 = iB2 & 112;
        if (i3 == 48) {
            this.q = this.g.top;
        } else if (i3 != 80) {
    ...
    public final float d(float f) {
        float f2 = this.e;
        return f <= f2 ? rp.b(1.0f, 0.0f, this.d, f2, f) : rp.b(0.0f, 1.0f, f2, 1.0f, f);
    }
    ...
    public final void g(float f) {
        ...
        TimeInterpolator timeInterpolator = rp.b;
    ...
    public final StaticLayout k(int i, float f, boolean z) {
        return (StaticLayout) lu4.g(d76.b(this.G, this.V, (int) f).d(this.F).g(z).c(i == 1 ? Layout.Alignment.ALIGN_NORMAL : y()).f(false).i(i).h(this.q0, this.r0).e(this.s0).j(null).a());
    }
    ...
    public final void m(Canvas canvas, float f, float f2) {
        ...
        if (!this.c) {
            ...
            if (Build.VERSION.SDK_INT >= 31) {
                ...
                textPaint.setShadowLayer(this.P, this.Q, this.R, sq3.a(this.S, textPaint.getAlpha()));
            }
            this.k0.draw(canvas);
        }
        if (!this.c) {
        ...
        if (i >= 31) {
            ...
            textPaint2.setShadowLayer(this.P, this.Q, this.R, sq3.a(this.S, textPaint2.getAlpha()));
        }
    ...
    public final Layout.Alignment y() {
        int iB = jk2.b(this.j, this.I ? 1 : 0) & 7;
