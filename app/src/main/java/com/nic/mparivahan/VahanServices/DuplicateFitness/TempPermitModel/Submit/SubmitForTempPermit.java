...
public final /* data */ class SubmitForTempPermit implements Serializable {
    ...
    public SubmitForTempPermit(String allotmentOffice, String str, String goodsDetails, String goodsToCarry, String goodsType, String ipAddress, String issueDt, Integer num, String others, int i, String periodMode, int i2, String purposeOfJourny, String regnNo, String routeDescription, String stateCd, String travelFrom, String travelUpto, ArrayList<VaSplPassengerdto> arrayList, String validFrom, String validUpto) {
    ...
    public final SubmitForTempPermit copy(String allotmentOffice, String applNo, String goodsDetails, String goodsToCarry, String goodsType, String ipAddress, String issueDt, Integer offCd, String others, int period, String periodMode, int purCd, String purposeOfJourny, String regnNo, String routeDescription, String stateCd, String travelFrom, String travelUpto, ArrayList<VaSplPassengerdto> vaSplPassengerdto, String validFrom, String validUpto) {
        ...
        Intrinsics.checkNotNullParameter(validFrom, "validFrom");
        Intrinsics.checkNotNullParameter(validUpto, "validUpto");
        return new SubmitForTempPermit(allotmentOffice, applNo, goodsDetails, goodsToCarry, goodsType, ipAddress, issueDt, offCd, others, period, periodMode, purCd, purposeOfJourny, regnNo, routeDescription, stateCd, travelFrom, travelUpto, vaSplPassengerdto, validFrom, validUpto);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SubmitForTempPermit)) {
            return false;
        }
        SubmitForTempPermit submitForTempPermit = (SubmitForTempPermit) other;
        return Intrinsics.areEqual(this.allotmentOffice, submitForTempPermit.allotmentOffice) && Intrinsics.areEqual(this.applNo, submitForTempPermit.applNo) && Intrinsics.areEqual(this.goodsDetails, submitForTempPermit.goodsDetails) && Intrinsics.areEqual(this.goodsToCarry, submitForTempPermit.goodsToCarry) && Intrinsics.areEqual(this.goodsType, submitForTempPermit.goodsType) && Intrinsics.areEqual(this.ipAddress, submitForTempPermit.ipAddress) && Intrinsics.areEqual(this.issueDt, submitForTempPermit.issueDt) && Intrinsics.areEqual(this.offCd, submitForTempPermit.offCd) && Intrinsics.areEqual(this.others, submitForTempPermit.others) && this.period == submitForTempPermit.period && Intrinsics.areEqual(this.periodMode, submitForTempPermit.periodMode) && this.purCd == submitForTempPermit.purCd && Intrinsics.areEqual(this.purposeOfJourny, submitForTempPermit.purposeOfJourny) && Intrinsics.areEqual(this.regnNo, submitForTempPermit.regnNo) && Intrinsics.areEqual(this.routeDescription, submitForTempPermit.routeDescription) && Intrinsics.areEqual(this.stateCd, submitForTempPermit.stateCd) && Intrinsics.areEqual(this.travelFrom, submitForTempPermit.travelFrom) && Intrinsics.areEqual(this.travelUpto, submitForTempPermit.travelUpto) && Intrinsics.areEqual(this.vaSplPassengerdto, submitForTempPermit.vaSplPassengerdto) && Intrinsics.areEqual(this.validFrom, submitForTempPermit.validFrom) && Intrinsics.areEqual(this.validUpto, submitForTempPermit.validUpto);
    }
