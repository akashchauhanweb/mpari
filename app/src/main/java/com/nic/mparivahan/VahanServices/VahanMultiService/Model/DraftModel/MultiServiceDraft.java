...
public final /* data */ class MultiServiceDraft implements Serializable {
    ...
    public MultiServiceDraft(String str, ChanngeOfAdressDto channgeOfAdressDto, Durcdto durcdto, HpaDto hpaDto, HptDto hptDto, int i, String str2, ArrayList<Integer> purposeCode, String str3, String str4, com.nic.mparivahan.VahanServices.VahanTransferOwnerView.VahanTransferOfOwnership.SellerAndBuyer.SellerModel.TransferOwnershipDto transferOwnershipDto) {
    ...
    public final MultiServiceDraft copy(String applNo, ChanngeOfAdressDto channgeOfAdressDto, Durcdto durcdto, HpaDto hpaDto, HptDto hptDto, int officeCode, String openDate, ArrayList<Integer> purposeCode, String regnNo, String stateCode, com.nic.mparivahan.VahanServices.VahanTransferOwnerView.VahanTransferOfOwnership.SellerAndBuyer.SellerModel.TransferOwnershipDto transferOwnershipDto) {
        Intrinsics.checkNotNullParameter(purposeCode, "purposeCode");
        return new MultiServiceDraft(applNo, channgeOfAdressDto, durcdto, hpaDto, hptDto, officeCode, openDate, purposeCode, regnNo, stateCode, transferOwnershipDto);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof MultiServiceDraft)) {
            return false;
        }
        MultiServiceDraft multiServiceDraft = (MultiServiceDraft) other;
        return Intrinsics.areEqual(this.applNo, multiServiceDraft.applNo) && Intrinsics.areEqual(this.channgeOfAdressDto, multiServiceDraft.channgeOfAdressDto) && Intrinsics.areEqual(this.durcdto, multiServiceDraft.durcdto) && Intrinsics.areEqual(this.hpaDto, multiServiceDraft.hpaDto) && Intrinsics.areEqual(this.hptDto, multiServiceDraft.hptDto) && this.officeCode == multiServiceDraft.officeCode && Intrinsics.areEqual(this.openDate, multiServiceDraft.openDate) && Intrinsics.areEqual(this.purposeCode, multiServiceDraft.purposeCode) && Intrinsics.areEqual(this.regnNo, multiServiceDraft.regnNo) && Intrinsics.areEqual(this.stateCode, multiServiceDraft.stateCode) && Intrinsics.areEqual(this.transferOwnershipDto, multiServiceDraft.transferOwnershipDto);
    }
    ...
    public int hashCode() {
        ...
        int iHashCode6 = (((iHashCode5 + (str2 == null ? 0 : str2.hashCode())) * 31) + this.purposeCode.hashCode()) * 31;
