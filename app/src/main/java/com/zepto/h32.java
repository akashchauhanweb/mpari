...
public final class h32 extends RecyclerView.h {
    public final List d;
    ...
    public h32(List mList, Context mContext, String State_code) {
    ...
    public static final void C(int i, h32 this$0, Enabledservice mModel, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(mModel, "$mModel");
        if (i != 3) {
            this$0.E(mModel.getServCode(), mModel.getServName().toString(), this$0.e);
            return;
        }
        Intent intent = new Intent(this$0.e, (Class<?>) ChallanViewMoreActivity.class);
    ...
    public void p(a holder, final int i) {
        ...
        holder.Q().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.g32
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                h32.C(i, this, enabledservice, view);
            }
        });
    }
    ...
    public final void E(String service_code, String serviceName, Context context) {
        Intrinsics.checkNotNullParameter(service_code, "service_code");
        Intrinsics.checkNotNullParameter(serviceName, "serviceName");
        Intrinsics.checkNotNullParameter(context, "context");
        if (StringsKt__StringsJVMKt.equals(service_code, "111", true)) {
        ...
        if (StringsKt__StringsJVMKt.equals(service_code, "112", true)) {
        ...
        if (StringsKt__StringsJVMKt.equals(service_code, "113", true)) {
        ...
        if (StringsKt__StringsJVMKt.equals(service_code, "114", true)) {
            Intent intent4 = new Intent(this.e, (Class<?>) SearchPrintChallanActivity.class);
            intent4.putExtra("Service_name", serviceName);
        ...
        if (StringsKt__StringsJVMKt.equals(service_code, "115", true)) {
            ...
            intent5.putExtra("Service_name", serviceName);
