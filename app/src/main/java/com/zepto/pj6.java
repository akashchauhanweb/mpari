...
public final class pj6 {
    ...
    public pj6(LinearLayout linearLayout, MaterialCardView materialCardView, CardView cardView, LinearLayout linearLayout2, LinearLayout linearLayout3, LinearLayout linearLayout4, LinearLayout linearLayout5, CardView cardView2, RecyclerView recyclerView, TextView textView, TextView textView2, TextView textView3, TextView textView4, TextView textView5) {
        this.a = linearLayout;
                            ...
                            if (linearLayout4 != null) {
                                ...
                                if (cardView2 != null) {
                                    ...
                                    if (recyclerView != null) {
                                        ...
                                        TextView textView = (TextView) zp7.a(view, R.id.txt_traffic_dashboard);
                                        if (textView != null) {
                                            ...
                                            if (textView2 != null) {
                                                ...
                                                if (textView3 != null) {
                                                    ...
                                                    if (textView4 != null) {
                                                        ...
                                                        if (textView5 != null) {
                                                            return new pj6((LinearLayout) view, materialCardView, cardView, linearLayout, linearLayout2, linearLayout3, linearLayout4, cardView2, recyclerView, textView, textView2, textView3, textView4, textView5);
                                                        }
                                                    }
                                                }
                                            }
    ...
    public static pj6 c(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.traffic_dashboard, viewGroup, false);
        if (z) {
