...
public abstract class be extends lq7 {
    ...
    public static be x(LayoutInflater layoutInflater) {
        kd1.d();
        return y(layoutInflater, null);
    }

    public static be y(LayoutInflater layoutInflater, Object obj) {
        return (be) lq7.o(layoutInflater, R.layout.activity_new_learner_personal_details, null, false, obj);
    }
}
