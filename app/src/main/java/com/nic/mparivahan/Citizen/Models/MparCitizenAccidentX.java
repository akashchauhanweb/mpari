...
public final /* data */ class MparCitizenAccidentX {
    ...
    public MparCitizenAccidentX(int i, int i2, String accdGaddr, double d, String accdLocation, double d2, int i3, String accdRegnNo, String accdRemarks, String accdStateCd, int i4, String accdSubmittedAt, String accdUpdatedAt, String accdUpdatedBy) {
    ...
    public final MparCitizenAccidentX copy(int accdCitizenId, int accdDistId, String accdGaddr, double accdLatitude, String accdLocation, double accdLongitude, int accdRecordId, String accdRegnNo, String accdRemarks, String accdStateCd, int accdStatus, String accdSubmittedAt, String accdUpdatedAt, String accdUpdatedBy) {
        ...
        Intrinsics.checkNotNullParameter(accdUpdatedAt, "accdUpdatedAt");
        Intrinsics.checkNotNullParameter(accdUpdatedBy, "accdUpdatedBy");
        return new MparCitizenAccidentX(accdCitizenId, accdDistId, accdGaddr, accdLatitude, accdLocation, accdLongitude, accdRecordId, accdRegnNo, accdRemarks, accdStateCd, accdStatus, accdSubmittedAt, accdUpdatedAt, accdUpdatedBy);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof MparCitizenAccidentX)) {
            return false;
        }
        MparCitizenAccidentX mparCitizenAccidentX = (MparCitizenAccidentX) other;
        return this.accdCitizenId == mparCitizenAccidentX.accdCitizenId && this.accdDistId == mparCitizenAccidentX.accdDistId && Intrinsics.areEqual(this.accdGaddr, mparCitizenAccidentX.accdGaddr) && Double.compare(this.accdLatitude, mparCitizenAccidentX.accdLatitude) == 0 && Intrinsics.areEqual(this.accdLocation, mparCitizenAccidentX.accdLocation) && Double.compare(this.accdLongitude, mparCitizenAccidentX.accdLongitude) == 0 && this.accdRecordId == mparCitizenAccidentX.accdRecordId && Intrinsics.areEqual(this.accdRegnNo, mparCitizenAccidentX.accdRegnNo) && Intrinsics.areEqual(this.accdRemarks, mparCitizenAccidentX.accdRemarks) && Intrinsics.areEqual(this.accdStateCd, mparCitizenAccidentX.accdStateCd) && this.accdStatus == mparCitizenAccidentX.accdStatus && Intrinsics.areEqual(this.accdSubmittedAt, mparCitizenAccidentX.accdSubmittedAt) && Intrinsics.areEqual(this.accdUpdatedAt, mparCitizenAccidentX.accdUpdatedAt) && Intrinsics.areEqual(this.accdUpdatedBy, mparCitizenAccidentX.accdUpdatedBy);
    }
