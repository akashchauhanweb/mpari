...
public final /* data */ class RenPermitdto implements Serializable {
    ...
    public RenPermitdto(String applNo, String authDateUpto, String authDatefrom, String authNo, String chassisNo, int i, String goodsToCarry, String ipAddress, String jorneyPurpose, int i2, String opDt, String parking1, int i3, String pmtNo, int i4, List<Integer> purCd, String rcptNo, String regionCovered, String regnNo, String remarks1, String replaceDate, int i5, String stateCd, String validFrom, String validUpto) {
    ...
    public final RenPermitdto copy(String applNo, String authDateUpto, String authDatefrom, String authNo, String chassisNo, int domainCd, String goodsToCarry, String ipAddress, String jorneyPurpose, int offCd, String opDt, String parking1, int pmtCatg, String pmtNo, int pmtType, List<Integer> purCd, String rcptNo, String regionCovered, String regnNo, String remarks1, String replaceDate, int serviceType, String stateCd, String validFrom, String validUpto) {
        Intrinsics.checkNotNullParameter(applNo, "applNo");
        Intrinsics.checkNotNullParameter(authDateUpto, "authDateUpto");
        Intrinsics.checkNotNullParameter(authDatefrom, "authDatefrom");
        Intrinsics.checkNotNullParameter(authNo, "authNo");
        ...
        Intrinsics.checkNotNullParameter(validFrom, "validFrom");
        Intrinsics.checkNotNullParameter(validUpto, "validUpto");
        return new RenPermitdto(applNo, authDateUpto, authDatefrom, authNo, chassisNo, domainCd, goodsToCarry, ipAddress, jorneyPurpose, offCd, opDt, parking1, pmtCatg, pmtNo, pmtType, purCd, rcptNo, regionCovered, regnNo, remarks1, replaceDate, serviceType, stateCd, validFrom, validUpto);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof RenPermitdto)) {
            return false;
        }
        RenPermitdto renPermitdto = (RenPermitdto) other;
        return Intrinsics.areEqual(this.applNo, renPermitdto.applNo) && Intrinsics.areEqual(this.authDateUpto, renPermitdto.authDateUpto) && Intrinsics.areEqual(this.authDatefrom, renPermitdto.authDatefrom) && Intrinsics.areEqual(this.authNo, renPermitdto.authNo) && Intrinsics.areEqual(this.chassisNo, renPermitdto.chassisNo) && this.domainCd == renPermitdto.domainCd && Intrinsics.areEqual(this.goodsToCarry, renPermitdto.goodsToCarry) && Intrinsics.areEqual(this.ipAddress, renPermitdto.ipAddress) && Intrinsics.areEqual(this.jorneyPurpose, renPermitdto.jorneyPurpose) && this.offCd == renPermitdto.offCd && Intrinsics.areEqual(this.opDt, renPermitdto.opDt) && Intrinsics.areEqual(this.parking1, renPermitdto.parking1) && this.pmtCatg == renPermitdto.pmtCatg && Intrinsics.areEqual(this.pmtNo, renPermitdto.pmtNo) && this.pmtType == renPermitdto.pmtType && Intrinsics.areEqual(this.purCd, renPermitdto.purCd) && Intrinsics.areEqual(this.rcptNo, renPermitdto.rcptNo) && Intrinsics.areEqual(this.regionCovered, renPermitdto.regionCovered) && Intrinsics.areEqual(this.regnNo, renPermitdto.regnNo) && Intrinsics.areEqual(this.remarks1, renPermitdto.remarks1) && Intrinsics.areEqual(this.replaceDate, renPermitdto.replaceDate) && this.serviceType == renPermitdto.serviceType && Intrinsics.areEqual(this.stateCd, renPermitdto.stateCd) && Intrinsics.areEqual(this.validFrom, renPermitdto.validFrom) && Intrinsics.areEqual(this.validUpto, renPermitdto.validUpto);
    }
