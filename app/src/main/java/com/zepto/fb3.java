...
public final class fb3 {
    ...
    public static fb3 a(View view) {
        int i = R.id.app_no;
        MyTextView myTextView = (MyTextView) zp7.a(view, R.id.app_no);
        if (myTextView != null) {
                    ...
                    if (appCompatButton != null) {
                        ...
                        if (myTextView3 != null) {
                            ...
                            if (appCompatButton2 != null) {
                                i = R.id.reg_no;
                                MyTextView myTextView4 = (MyTextView) zp7.a(view, R.id.reg_no);
                                if (myTextView4 != null) {
                                    i = R.id.time_text;
                                        ...
                                        if (appCompatEditText != null) {
                                            ...
                                            if (appCompatEditText2 != null) {
                                                ...
                                                if (appCompatEditText3 != null) {
                                                    return new fb3((ScrollView) view, myTextView, d47VarA, myTextView2, appCompatButton, myTextView3, appCompatButton2, myTextView4, myTextView5, appCompatEditText, appCompatEditText2, appCompatEditText3);
                                                }
                                            }
                                        }
                                    }
    ...
    public static fb3 c(LayoutInflater layoutInflater) {
        return d(layoutInflater, null, false);
    }

    public static fb3 d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.layout_application_vehicle_services, viewGroup, false);
        if (z) {
