...
public final class s extends zq7 {
    public final r d;
    public final oy3 e;
    public final oy3 f;
    ...
    public static final class a implements Callback {
        ...
        public void onResponse(Call call, Response response) {
            ...
            Object objFromJson = new Gson().fromJson(aVar.a(str, data), (Class<Object>) AOVSaveToDraftReponse.class);
            Intrinsics.checkNotNullExpressionValue(objFromJson, "fromJson(...)");
            this.b.i().k((AOVSaveToDraftReponse) objFromJson);
        }
    }
    ...
    public final void g(AOVSaveToDraftRequest aov) {
        Intrinsics.checkNotNullParameter(aov, "aov");
        Ref.ObjectRef objectRef = new Ref.ObjectRef();
        objectRef.element = String.valueOf(System.currentTimeMillis());
        this.d.a(lc5.Companion.d(ls3.g.b("application/json"), VUtility.INSTANCE.G(aov)), (String) objectRef.element).enqueue(new a(objectRef, this));
    }
