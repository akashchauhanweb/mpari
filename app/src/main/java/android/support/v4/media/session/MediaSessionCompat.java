...
import com.zepto.as3;
import com.zepto.du7;
import com.zepto.es3;
import com.zepto.i80;
...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        public class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                if (message.what == 1) {
                    Callback.this.handleMediaPlayPauseKeySingleTapIfPending((es3) message.obj);
                }
            }
        }
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        if (mediaSessionImplApi21 != null) {
                            ...
                            i80.b(bundle2, MediaSessionCompat.KEY_EXTRA_BINDER, iBinderAsBinder);
        ...
        public void handleMediaPlayPauseKeySingleTapIfPending(es3 es3Var) {
            if (this.mMediaPlayPauseKeyPending) {
                ...
                mediaSessionImpl.setCurrentControllerInfo(es3Var);
                if (z && z3) {
                    onPause();
                } else if (!z && z2) {
                    onPlay();
    ...
    public interface MediaSessionImpl {
        ...
        void setCurrentControllerInfo(es3 es3Var);
        ...
        void setPlaybackToRemote(du7 du7Var);
    ...
    public static class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        ...
        public final es3 getCurrentControllerInfo() {
            return new es3(((MediaSession) this.mSessionObj).getCurrentControllerInfo());
        }

        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCurrentControllerInfo(es3 es3Var) {
        }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private du7.a mVolumeCallback = new du7.a() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
            public void onVolumeChanged(du7 du7Var) {
        ...
        public class MediaSessionStub extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                if (MediaSessionImplBase.this.mDestroyed) {
                    ...
                    MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new es3("android.media.session.MediaController", Binder.getCallingPid(), Binder.getCallingUid()));
                }
            }
        ...
        public class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                MediaSessionImplBase.this.setCurrentControllerInfo(new es3(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt(MediaSessionCompat.DATA_CALLING_PID), data.getInt(MediaSessionCompat.DATA_CALLING_UID)));
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public es3 getCurrentControllerInfo() {
            es3 es3Var;
            synchronized (this.mLock) {
                es3Var = this.mRemoteUserInfo;
            }
            return es3Var;
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToRemote(du7 du7Var) {
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            IMediaSession iMediaSessionAsInterface = IMediaSession.Stub.asInterface(i80.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER));
        ...
        public Bundle toBundle() {
            ...
            if (iMediaSession != null) {
                i80.b(bundle, MediaSessionCompat.KEY_EXTRA_BINDER, iMediaSession.asBinder());
            }
    ...
    public static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new es3(callingPackage, Binder.getCallingPid(), Binder.getCallingUid()));
            }
    ...
    private MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle) {
        ...
        if (context != null) {
            if (!TextUtils.isEmpty(str)) {
                if (componentName == null && (componentName = as3.a(context)) == null) {
