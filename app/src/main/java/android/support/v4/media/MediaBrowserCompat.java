...
public final class MediaBrowserCompat {
    ...
    public static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
        ...
        private final nx mSubscriptions = new nx();
        ...
        public void onConnected() {
            ...
            IBinder iBinderA = i80.a(extras, "extra_messenger");
            if (iBinderA != null) {
            ...
            IMediaSession iMediaSessionAsInterface = IMediaSession.Stub.asInterface(i80.a(extras, "extra_session_binder"));
            ...
            if (i == 0 || i == 1) {
                ...
                this.mHandler.post(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.1
                    ...
                    public void run() {
                        ...
                        MediaBrowserImplBase mediaBrowserImplBase2 = MediaBrowserImplBase.this;
                        if (mediaBrowserImplBase2.mState == 0) {
                            return;
                        }
                        mediaBrowserImplBase2.mState = 2;
                        if (MediaBrowserCompat.DEBUG && mediaBrowserImplBase2.mServiceConnection != null) {
                        ...
                        if (!mediaBrowserImplBase.mContext.bindService(intent, mediaBrowserImplBase.mServiceConnection, 1)) {
    ...
    public static class ServiceBinderWrapper {
        ...
        public void addSubscription(String str, IBinder iBinder, Bundle bundle, Messenger messenger) throws RemoteException {
            ...
            i80.b(bundle2, "data_callback_token", iBinder);
        ...
        public void removeSubscription(String str, IBinder iBinder, Messenger messenger) throws RemoteException {
            Bundle bundle = new Bundle();
            bundle.putString("data_media_item_id", str);
            i80.b(bundle, "data_callback_token", iBinder);
    ...
    public static class Subscription {
        ...
        public SubscriptionCallback getCallback(Bundle bundle) {
            for (int i = 0; i < this.mOptionsList.size(); i++) {
                if (zr3.a(this.mOptionsList.get(i), bundle)) {
