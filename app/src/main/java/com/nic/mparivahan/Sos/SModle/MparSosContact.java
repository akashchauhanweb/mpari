...
public final /* data */ class MparSosContact {
    ...
    public MparSosContact(String soscCreatedAt, int i, String soscMobile, String soscName, int i2, int i3, int i4, String soscUpdatedAt) {
    ...
    public final MparSosContact copy(String soscCreatedAt, int soscCtzId, String soscMobile, String soscName, int soscRecordId, int soscRelation, int soscStatus, String soscUpdatedAt) {
        Intrinsics.checkNotNullParameter(soscCreatedAt, "soscCreatedAt");
        Intrinsics.checkNotNullParameter(soscMobile, "soscMobile");
        Intrinsics.checkNotNullParameter(soscName, "soscName");
        Intrinsics.checkNotNullParameter(soscUpdatedAt, "soscUpdatedAt");
        return new MparSosContact(soscCreatedAt, soscCtzId, soscMobile, soscName, soscRecordId, soscRelation, soscStatus, soscUpdatedAt);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof MparSosContact)) {
            return false;
        }
        MparSosContact mparSosContact = (MparSosContact) other;
        return Intrinsics.areEqual(this.soscCreatedAt, mparSosContact.soscCreatedAt) && this.soscCtzId == mparSosContact.soscCtzId && Intrinsics.areEqual(this.soscMobile, mparSosContact.soscMobile) && Intrinsics.areEqual(this.soscName, mparSosContact.soscName) && this.soscRecordId == mparSosContact.soscRecordId && this.soscRelation == mparSosContact.soscRelation && this.soscStatus == mparSosContact.soscStatus && Intrinsics.areEqual(this.soscUpdatedAt, mparSosContact.soscUpdatedAt);
    }
