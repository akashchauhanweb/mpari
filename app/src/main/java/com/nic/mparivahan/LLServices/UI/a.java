...
public final class a extends RecyclerView.h {
    ...
    /* JADX INFO: renamed from: com.nic.mparivahan.LLServices.UI.a$a, reason: collision with other inner class name */
    ...
    public a(Context context, Application application, ArrayList arrayList, InterfaceC0054a itemListener) {
    ...
    public static final void P(DocumentListItem documentListItem, a this$0, int i2, Ref.ObjectRef mSession, b holder, View view) throws IOException {
        ...
        if (numValueOf.intValue() > 0) {
            ...
            if (fileNmae5 == null || !StringsKt__StringsKt.contains$default((CharSequence) fileNmae5, (CharSequence) ".pdf", false, 2, (Object) null)) {
                ...
                button.setOnClickListener(new View.OnClickListener() { // from class: com.zepto.qh3
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
                        com.nic.mparivahan.LLServices.UI.a.Q(dialog, view2);
                    }
                });
                try {
    ...
    public static final void R(DocumentListItem documentListItem, a this$0, final b holder, View view) {
        ...
        if (documentListItem == null || !documentListItem.getIsDocInsertedStatus()) {
            DatePickerDialog datePickerDialog = new DatePickerDialog(this$0.d, new DatePickerDialog.OnDateSetListener() { // from class: com.zepto.rh3
                @Override // android.app.DatePickerDialog.OnDateSetListener
                public final void onDateSet(DatePicker datePicker, int i2, int i3, int i4) {
                    com.nic.mparivahan.LLServices.UI.a.S(holder, datePicker, i2, i3, i4);
                }
    ...
    public void p(final b holder, final int i2) {
        ...
        holder.b0().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.ih3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                com.nic.mparivahan.LLServices.UI.a.R(documentListItem, this, holder, view);
            }
        });
        holder.W().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.jh3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                com.nic.mparivahan.LLServices.UI.a.T(documentListItem, this, holder, i2, view);
            }
        });
        holder.P().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.kh3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                com.nic.mparivahan.LLServices.UI.a.U(holder, view);
            }
        });
        holder.Q().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.lh3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                com.nic.mparivahan.LLServices.UI.a.V(holder, view);
            }
        });
        final DocumentListItem documentListItem2 = documentListItem;
        holder.S().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.mh3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                com.nic.mparivahan.LLServices.UI.a.W(documentListItem2, holder, this, objectRef, i2, view);
            }
        });
        holder.R().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.nh3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                com.nic.mparivahan.LLServices.UI.a.N(documentListItem2, holder, this, objectRef, i2, view);
            }
        });
        holder.U().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.oh3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                com.nic.mparivahan.LLServices.UI.a.O(this.a, i2, view);
            }
        });
        final DocumentListItem documentListItem3 = documentListItem;
        holder.e0().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.ph3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) throws IOException {
                com.nic.mparivahan.LLServices.UI.a.P(documentListItem3, this, i2, objectRef, holder, view);
            }
        });
    }
