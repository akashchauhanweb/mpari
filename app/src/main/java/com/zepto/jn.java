...
public final class jn extends ri2 implements bt3 {
    ...
    public static final class b extends ri2.a implements bt3 {
        ...
        public b() {
            super(jn.DEFAULT_INSTANCE);
        }
    }

    static {
        jn jnVar = new jn();
        DEFAULT_INSTANCE = jnVar;
        ri2.Q(jn.class, jnVar);
    }
    ...
    public static jn a0(s80 s80Var, g72 g72Var) {
        return (jn) ri2.K(DEFAULT_INSTANCE, s80Var, g72Var);
    }
