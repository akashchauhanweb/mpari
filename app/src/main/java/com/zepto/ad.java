...
public final class ad {
                                                        ...
                                                        if (textView2 != null) {
                                                            ...
                                                            if (myTextView3 != null) {
                                                                ...
                                                                if (myTextView4 != null) {
                                                                    ...
                                                                    if (myTextView5 != null) {
                                                                        return new ad((RelativeLayout) view, myTextView, textView, appCompatButton, checkBox, imageView, linearLayout, vy3VarA, appCompatEditText, appCompatButton2, cardView, myTextView2, linearLayout2, textView2, myTextView3, myTextView4, myTextView5);
                                                                    }
                                                                }
                                                            }
                                                        }
    ...
    public static ad d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_ll_mobile_otp, viewGroup, false);
        if (z) {
