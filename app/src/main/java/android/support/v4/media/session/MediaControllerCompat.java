...
public final class MediaControllerCompat {
    ...
    public static class MediaControllerExtraData extends bu0.a {
    ...
    public static MediaControllerCompat getMediaController(Activity activity) {
        if (activity instanceof bu0) {
            MediaControllerExtraData mediaControllerExtraData = (MediaControllerExtraData) ((bu0) activity).i0(MediaControllerExtraData.class);
    ...
    public static void setMediaController(Activity activity, MediaControllerCompat mediaControllerCompat) {
        if (activity instanceof bu0) {
            ((bu0) activity).j0(new MediaControllerExtraData(mediaControllerCompat));
        }
        ...
        public static class ExtraBinderRequestResultReceiver extends ResultReceiver {
            ...
            public void onReceiveResult(int i, Bundle bundle) {
                ...
                synchronized (mediaControllerImplApi21.mLock) {
                    mediaControllerImplApi21.mSessionToken.setExtraBinder(IMediaSession.Stub.asInterface(i80.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER)));
