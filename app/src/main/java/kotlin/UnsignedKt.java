...
public final class UnsignedKt {
    ...
    public static final int doubleToUInt(double d) {
        ...
        return d <= 2.147483647E9d ? UInt.m101constructorimpl((int) d) : UInt.m101constructorimpl(UInt.m101constructorimpl((int) (d - ((double) IntCompanionObject.MAX_VALUE))) + UInt.m101constructorimpl(IntCompanionObject.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double d) {
        ...
        return d < 9.223372036854776E18d ? ULong.m180constructorimpl((long) d) : ULong.m180constructorimpl(ULong.m180constructorimpl((long) (d - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
    ...
    public static final int m357uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m101constructorimpl((int) ((((long) i) & 4294967295L) / (((long) i2) & 4294967295L)));
    }

    @PublishedApi
    /* JADX INFO: renamed from: uintRemainder-J1ME1BU, reason: not valid java name */
    public static final int m358uintRemainderJ1ME1BU(int i, int i2) {
        return UInt.m101constructorimpl((int) ((((long) i) & 4294967295L) % (((long) i2) & 4294967295L)));
    }
    ...
    public static final long m359ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compareUnsigned(j, j2) < 0 ? ULong.m180constructorimpl(0L) : ULong.m180constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m180constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.m180constructorimpl(j3 + ((long) (Long.compareUnsigned(ULong.m180constructorimpl(j - (j3 * j2)), ULong.m180constructorimpl(j2)) < 0 ? 0 : 1)));
    }

    @PublishedApi
    /* JADX INFO: renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m360ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compareUnsigned(j, j2) < 0 ? j : ULong.m180constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m180constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (Long.compareUnsigned(ULong.m180constructorimpl(j3), ULong.m180constructorimpl(j2)) < 0) {
            j2 = 0;
        }
        return ULong.m180constructorimpl(j3 - j2);
    }
