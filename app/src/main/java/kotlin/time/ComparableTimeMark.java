...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    public static final class DefaultImpls {
        public static int compareTo(ComparableTimeMark comparableTimeMark, ComparableTimeMark other) {
            ...
            return Duration.m1342compareToLRDsOJo(comparableTimeMark.mo1335minusUwyO8pc(other), Duration.INSTANCE.m1446getZEROUwyO8pc());
        }
        ...
        public static ComparableTimeMark m1338minusLRDsOJo(ComparableTimeMark comparableTimeMark, long j) {
            return comparableTimeMark.mo1336plusLRDsOJo(Duration.m1396unaryMinusUwyO8pc(j));
        }
    }
    ...
    ComparableTimeMark mo1334minusLRDsOJo(long duration);

    /* JADX INFO: renamed from: minus-UwyO8pc */
    long mo1335minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    ComparableTimeMark mo1336plusLRDsOJo(long duration);
}
