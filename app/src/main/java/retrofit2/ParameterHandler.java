...
abstract class ParameterHandler<T> {
    ...
    public static final class Body<T> extends ParameterHandler<T> {
        private final Converter<T, lc5> converter;
        private final Method method;
        private final int p;

        public Body(Method method, int i, Converter<T, lc5> converter) {
            this.method = method;
            this.p = i;
    ...
    public static final class Headers extends ParameterHandler<pl2> {
        private final Method method;
        private final int p;
    ...
    public static final class Part<T> extends ParameterHandler<T> {
        ...
        public Part(Method method, int i, pl2 pl2Var, Converter<T, lc5> converter) {
            this.method = method;
            this.p = i;
            this.headers = pl2Var;
            this.converter = converter;
    ...
    public static final class PartMap<T> extends ParameterHandler<Map<String, T>> {
        ...
        private final Converter<T, lc5> valueConverter;

        public PartMap(Method method, int i, Converter<T, lc5> converter, String str) {
            this.method = method;
            this.p = i;
            this.valueConverter = converter;
        ...
        public void apply(RequestBuilder requestBuilder, Map<String, T> map) throws IOException {
            ...
            for (Map.Entry<String, T> entry : map.entrySet()) {
                ...
                requestBuilder.addPart(pl2.r("Content-Disposition", "form-data; name=\"" + key + "\"", "Content-Transfer-Encoding", this.transferEncoding), this.valueConverter.convert(value));
            }
        }
    }
    ...
    public static final class RawPart extends ParameterHandler<jy3.c> {
        ...
        @Override // retrofit2.ParameterHandler
        public void apply(RequestBuilder requestBuilder, jy3.c cVar) {
            if (cVar != null) {
