...
public final class DurationKt {
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM1446getZEROUwyO8pc = companion.m1446getZEROUwyO8pc();
        ...
        if (str.charAt(length2) == 'P') {
                ...
                if (str.charAt(i3) != 'T') {
                    ...
                    while (true) {
                        ...
                        if (!new CharRange(c, '9').contains(cCharAt2)) {
                            i2 = length;
                            if (!StringsKt__StringsKt.contains$default((CharSequence) "+-.", cCharAt2, false, 2, (Object) null)) {
                                break;
                            }
                        } else {
                            i2 = length;
                    ...
                    if (durationUnitDurationUnitByIsoChar != DurationUnit.SECONDS || iIndexOf$default <= 0) {
                        jM1446getZEROUwyO8pc = Duration.m1379plusLRDsOJo(jM1446getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    } else {
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring2 = strSubstring.substring(0, iIndexOf$default);
                        Intrinsics.checkNotNullExpressionValue(strSubstring2, "this as java.lang.String…ing(startIndex, endIndex)");
                        long jM1379plusLRDsOJo2 = Duration.m1379plusLRDsOJo(jM1446getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM1446getZEROUwyO8pc = Duration.m1379plusLRDsOJo(jM1379plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    }
            ...
            if (StringsKt__StringsJVMKt.regionMatches(str, length2, "Infinity", 0, Math.max(length - length2, 8), true)) {
                jM1446getZEROUwyO8pc = companion.m1444getINFINITEUwyO8pc();
            } else {
                boolean z6 = !z3;
                if (z3 && str.charAt(length2) == '(' && StringsKt___StringsKt.last(str) == ')') {
                    ...
                    i = i5;
                    jM1379plusLRDsOJo = jM1446getZEROUwyO8pc;
                    z6 = true;
                } else {
                    i = length;
                    jM1379plusLRDsOJo = jM1446getZEROUwyO8pc;
                ...
                while (length2 < i) {
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM1379plusLRDsOJo3 = Duration.m1379plusLRDsOJo(jM1379plusLRDsOJo, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring7 = strSubstring4.substring(iIndexOf$default2);
                        String str3 = str2;
                        Intrinsics.checkNotNullExpressionValue(strSubstring7, str3);
                        jM1379plusLRDsOJo = Duration.m1379plusLRDsOJo(jM1379plusLRDsOJo3, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < i) {
                        ...
                        jM1379plusLRDsOJo = Duration.m1379plusLRDsOJo(jM1379plusLRDsOJo, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                        durationUnit2 = durationUnitDurationUnitByShortName;
                    }
                    z7 = true;
                }
                jM1446getZEROUwyO8pc = jM1379plusLRDsOJo;
            }
        }
        return z4 ? Duration.m1396unaryMinusUwyO8pc(jM1446getZEROUwyO8pc) : jM1446getZEROUwyO8pc;
    }
    ...
    private static final long m1469timeskIfJnKk(double d, long j) {
    ...
    private static final long m1470timesmvk6XK0(int i, long j) {
