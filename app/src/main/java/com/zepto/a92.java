...
public final class a92 extends RecyclerView.h {
    ...
    public a92(ArrayList language_modle, Context context) {
    ...
    public void p(a holder, int i) {
        ...
        holder.O().setText(feeDobj.getFeeHeadDescr());
        holder.P().setText(String.valueOf(feeDobj.getFeeAmount()));
    }
