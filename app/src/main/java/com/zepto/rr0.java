...
public abstract class rr0 {
    ...
    */
    public static android.content.res.ColorStateList e(android.content.res.Resources r17, org.xmlpull.v1.XmlPullParser r18, android.util.AttributeSet r19, android.content.res.Resources.Theme r20) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.zepto.rr0.e(android.content.res.Resources, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet, android.content.res.Resources$Theme):android.content.res.ColorStateList");
    }
    ...
    public static int g(int i, float f, float f2) {
        ...
        int iB = er3.b((int) ((Color.alpha(i) * f) + 0.5f), 0, KotlinVersion.MAX_COMPONENT_VALUE);
        if (z) {
            na0 na0VarC = na0.c(i);
            i = na0.m(na0VarC.j(), na0VarC.i(), f2);
        }
