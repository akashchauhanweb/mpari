...
public final /* data */ class DuprcDtoX {
    ...
    public DuprcDtoX(String appl_no, int i, String fir_dt, String fir_no, int i2, String ins_from, int i3, String ins_upto, String msg, int i4, String op_dt, String police_station, String policy_no, int i5, String rcp_dt, String rcpt_NO, int i6, String reason, String regn_no, String state_cd, String state_header, String status, String tax_mode, int i7) {
    ...
    public final DuprcDtoX copy(String appl_no, int comp_cd, String fir_dt, String fir_no, int idv, String ins_from, int ins_type, String ins_upto, String msg, int off_cd, String op_dt, String police_station, String policy_no, int pur_cd, String rcp_dt, String rcpt_NO, int rcpt_amt, String reason, String regn_no, String state_cd, String state_header, String status, String tax_mode, int vh_class) {
        Intrinsics.checkNotNullParameter(appl_no, "appl_no");
        Intrinsics.checkNotNullParameter(fir_dt, "fir_dt");
        Intrinsics.checkNotNullParameter(fir_no, "fir_no");
        Intrinsics.checkNotNullParameter(ins_from, "ins_from");
        ...
        Intrinsics.checkNotNullParameter(status, "status");
        Intrinsics.checkNotNullParameter(tax_mode, "tax_mode");
        return new DuprcDtoX(appl_no, comp_cd, fir_dt, fir_no, idv, ins_from, ins_type, ins_upto, msg, off_cd, op_dt, police_station, policy_no, pur_cd, rcp_dt, rcpt_NO, rcpt_amt, reason, regn_no, state_cd, state_header, status, tax_mode, vh_class);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof DuprcDtoX)) {
            return false;
        }
        DuprcDtoX duprcDtoX = (DuprcDtoX) other;
        return Intrinsics.areEqual(this.appl_no, duprcDtoX.appl_no) && this.comp_cd == duprcDtoX.comp_cd && Intrinsics.areEqual(this.fir_dt, duprcDtoX.fir_dt) && Intrinsics.areEqual(this.fir_no, duprcDtoX.fir_no) && this.idv == duprcDtoX.idv && Intrinsics.areEqual(this.ins_from, duprcDtoX.ins_from) && this.ins_type == duprcDtoX.ins_type && Intrinsics.areEqual(this.ins_upto, duprcDtoX.ins_upto) && Intrinsics.areEqual(this.msg, duprcDtoX.msg) && this.off_cd == duprcDtoX.off_cd && Intrinsics.areEqual(this.op_dt, duprcDtoX.op_dt) && Intrinsics.areEqual(this.police_station, duprcDtoX.police_station) && Intrinsics.areEqual(this.policy_no, duprcDtoX.policy_no) && this.pur_cd == duprcDtoX.pur_cd && Intrinsics.areEqual(this.rcp_dt, duprcDtoX.rcp_dt) && Intrinsics.areEqual(this.rcpt_NO, duprcDtoX.rcpt_NO) && this.rcpt_amt == duprcDtoX.rcpt_amt && Intrinsics.areEqual(this.reason, duprcDtoX.reason) && Intrinsics.areEqual(this.regn_no, duprcDtoX.regn_no) && Intrinsics.areEqual(this.state_cd, duprcDtoX.state_cd) && Intrinsics.areEqual(this.state_header, duprcDtoX.state_header) && Intrinsics.areEqual(this.status, duprcDtoX.status) && Intrinsics.areEqual(this.tax_mode, duprcDtoX.tax_mode) && this.vh_class == duprcDtoX.vh_class;
    }
