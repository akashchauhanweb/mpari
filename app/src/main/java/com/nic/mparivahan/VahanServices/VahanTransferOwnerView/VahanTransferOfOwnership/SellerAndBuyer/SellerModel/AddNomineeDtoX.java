...
public final /* data */ class AddNomineeDtoX implements Serializable {
    ...
    public AddNomineeDtoX(String str, String str2, String str3, int i, String str4, int i2, String str5, int i3, String str6) {
        this.applNo = str;
    ...
    public final AddNomineeDtoX copy(String applNo, String nominationDt, String nomineeName, int offCd, String opdt, int purCd, String regnNo, int relation, String stateCd) {
        return new AddNomineeDtoX(applNo, nominationDt, nomineeName, offCd, opdt, purCd, regnNo, relation, stateCd);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof AddNomineeDtoX)) {
            return false;
        }
        AddNomineeDtoX addNomineeDtoX = (AddNomineeDtoX) other;
        return Intrinsics.areEqual(this.applNo, addNomineeDtoX.applNo) && Intrinsics.areEqual(this.nominationDt, addNomineeDtoX.nominationDt) && Intrinsics.areEqual(this.nomineeName, addNomineeDtoX.nomineeName) && this.offCd == addNomineeDtoX.offCd && Intrinsics.areEqual(this.opdt, addNomineeDtoX.opdt) && this.purCd == addNomineeDtoX.purCd && Intrinsics.areEqual(this.regnNo, addNomineeDtoX.regnNo) && this.relation == addNomineeDtoX.relation && Intrinsics.areEqual(this.stateCd, addNomineeDtoX.stateCd);
    }
