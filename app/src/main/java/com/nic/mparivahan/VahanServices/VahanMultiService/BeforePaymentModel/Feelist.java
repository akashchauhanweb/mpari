...
public final /* data */ class Feelist implements Serializable {
    ...
    public Feelist(boolean z, String dueDate, String dueDateString, int i, int i2, int i3, String feeHeadDescr, int i4, String fromDate, String fromDateLable, String noOfApplications, String paymentId, boolean z2, boolean z3, int i5, boolean z4, boolean z5, boolean z6, int i6, int i7, String uptoDate, String uptoDateLable) {
    ...
    public final Feelist copy(boolean disableDropDown, String dueDate, String dueDateString, int exemptFeesAmount, int exemptFineAmount, int feeAmount, String feeHeadDescr, int fineAmount, String fromDate, String fromDateLable, String noOfApplications, String paymentId, boolean perRcpt, boolean perTrans, int purCd, boolean readOnlyFee, boolean renderFromDate, boolean renderUptoDate, int servicecharge, int totalAmount, String uptoDate, String uptoDateLable) {
        ...
        Intrinsics.checkNotNullParameter(uptoDate, "uptoDate");
        Intrinsics.checkNotNullParameter(uptoDateLable, "uptoDateLable");
        return new Feelist(disableDropDown, dueDate, dueDateString, exemptFeesAmount, exemptFineAmount, feeAmount, feeHeadDescr, fineAmount, fromDate, fromDateLable, noOfApplications, paymentId, perRcpt, perTrans, purCd, readOnlyFee, renderFromDate, renderUptoDate, servicecharge, totalAmount, uptoDate, uptoDateLable);
    }
    ...
    public boolean equals(Object other) {
        ...
        return this.disableDropDown == feelist.disableDropDown && Intrinsics.areEqual(this.dueDate, feelist.dueDate) && Intrinsics.areEqual(this.dueDateString, feelist.dueDateString) && this.exemptFeesAmount == feelist.exemptFeesAmount && this.exemptFineAmount == feelist.exemptFineAmount && this.feeAmount == feelist.feeAmount && Intrinsics.areEqual(this.feeHeadDescr, feelist.feeHeadDescr) && this.fineAmount == feelist.fineAmount && Intrinsics.areEqual(this.fromDate, feelist.fromDate) && Intrinsics.areEqual(this.fromDateLable, feelist.fromDateLable) && Intrinsics.areEqual(this.noOfApplications, feelist.noOfApplications) && Intrinsics.areEqual(this.paymentId, feelist.paymentId) && this.perRcpt == feelist.perRcpt && this.perTrans == feelist.perTrans && this.purCd == feelist.purCd && this.readOnlyFee == feelist.readOnlyFee && this.renderFromDate == feelist.renderFromDate && this.renderUptoDate == feelist.renderUptoDate && this.servicecharge == feelist.servicecharge && this.totalAmount == feelist.totalAmount && Intrinsics.areEqual(this.uptoDate, feelist.uptoDate) && Intrinsics.areEqual(this.uptoDateLable, feelist.uptoDateLable);
    }
