...
public final class g87 extends RecyclerView.h {
    ...
    public g87(ArrayList mList, Context mContext, rx3 multiSelected) {
    ...
    public static final void C(ServiceList mModel, g87 this$0, int i, View view) {
    ...
    public void p(a holder, final int i) {
        ...
        holder.P().setText(ta3.a.j2(this.e, String.valueOf(serviceList.getPurposeCode()), " "));
        ...
        holder.Q().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.f87
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                g87.C(serviceList, this, i, view);
            }
        });
    }
