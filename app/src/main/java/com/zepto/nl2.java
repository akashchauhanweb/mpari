...
public abstract class nl2 extends er7 {
    public Runnable d;
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ...
            if (this.e == null || (overScroller = nl2.this.e) == null) {
                return;
            }
            if (!overScroller.computeScrollOffset()) {
                nl2.this.R(this.c, this.e);
                return;
            }
            nl2 nl2Var = nl2.this;
            nl2Var.T(this.c, this.e, nl2Var.e.getCurrY());
            dq7.i0(this.e, this);
        }
    }
    ...
    */
    public boolean H(androidx.coordinatorlayout.widget.CoordinatorLayout r12, android.view.View r13, android.view.MotionEvent r14) {
        ...
        L90:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.zepto.nl2.H(androidx.coordinatorlayout.widget.CoordinatorLayout, android.view.View, android.view.MotionEvent):boolean");
    }
    ...
    public int T(CoordinatorLayout coordinatorLayout, View view, int i) {
        return U(coordinatorLayout, view, i, IntCompanionObject.MIN_VALUE, IntCompanionObject.MAX_VALUE);
    }
    ...
    public nl2(Context context, AttributeSet attributeSet) {
