...
public final /* data */ class GetStated {
    ...
    public static /* synthetic */ GetStated copy$default(GetStated getStated, ArrayList arrayList, String str, String str2, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public final GetStated copy(ArrayList<Name> states, String statusCode, String statusDesc) {
        Intrinsics.checkNotNullParameter(states, "states");
        Intrinsics.checkNotNullParameter(statusCode, "statusCode");
        Intrinsics.checkNotNullParameter(statusDesc, "statusDesc");
        return new GetStated(states, statusCode, statusDesc);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof GetStated)) {
            return false;
        }
        GetStated getStated = (GetStated) other;
        return Intrinsics.areEqual(this.states, getStated.states) && Intrinsics.areEqual(this.statusCode, getStated.statusCode) && Intrinsics.areEqual(this.statusDesc, getStated.statusDesc);
    }
