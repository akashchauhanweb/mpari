...
public abstract class zs6 {
    ...
    public static class a {
        public static void h(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws b13 {
        ...
        public static void j(byte b, byte b2, byte b3, char[] cArr, int i) throws b13 {
        ...
        public static void k(byte b, byte b2, char[] cArr, int i) throws b13 {
            if (b < -62 || m(b2)) {
                throw b13.d();
            }
    ...
    public static final class c extends b {
        ...
        @Override // com.zepto.zs6.b
        public String a(byte[] bArr, int i, int i2) throws b13 {
        ...
        */
        public int d(int r7, byte[] r8, int r9, int r10) {
            ...
            L62:
                ...
                r7 = r8[r7]
                if (r9 < r10) goto L6f
                int r7 = com.zepto.zs6.b(r0, r1, r7)
                return r7
            L6f:
                r5 = r9
                r9 = r7
            ...
            L86:
                ...
                return r7
            */
            throw new UnsupportedOperationException("Method not decompiled: com.zepto.zs6.c.d(int, byte[], int, int):int");
        }
    }
        ...
        */
        public static int f(byte[] r10, long r11, int r13) {
            ...
            L9:
                ...
                if (r13 <= 0) goto L1a
                long r4 = r11 + r2
                byte r1 = com.zepto.iq6.u(r10, r11)
                if (r1 < 0) goto L19
                int r13 = r13 + (-1)
                r11 = r4
                goto L9
            ...
            L29:
                ...
                if (r1 < r0) goto L39
                long r2 = r2 + r11
                byte r11 = com.zepto.iq6.u(r10, r11)
                if (r11 <= r6) goto L37
                goto L39
            L37:
                r11 = r2
            ...
            L48:
                int r13 = r13 + (-3)
                long r2 = r2 + r11
                byte r0 = com.zepto.iq6.u(r10, r11)
                if (r0 > r6) goto L64
                r7 = -96
                if (r1 != r4) goto L57
                if (r0 < r7) goto L64
            ...
            L5d:
                long r11 = r11 + r8
                byte r0 = com.zepto.iq6.u(r10, r2)
                if (r0 <= r6) goto L7
            L64:
                return r5
            L65:
            ...
            L6d:
                ...
                r0 = 3
                long r11 = r11 + r0
                byte r0 = com.zepto.iq6.u(r10, r8)
                if (r0 <= r6) goto L7
            L8f:
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: com.zepto.zs6.e.f(byte[], long, int):int");
        }
        ...
        public static int g(byte[] bArr, long j, int i) {
            ...
            while (true) {
                int i4 = i2 + 8;
                if (i4 > i || (iq6.A(bArr, iq6.h + j) & (-9187201950435737472L)) != 0) {
                    break;
                }
                j += 8;
                i2 = i4;
        ...
        public static int h(byte[] bArr, int i, long j, int i2) {
            ...
            if (i2 == 1) {
                return zs6.j(i, iq6.u(bArr, j));
            }
            if (i2 == 2) {
                return zs6.k(i, iq6.u(bArr, j), iq6.u(bArr, j + 1));
            }
            ...
            while (i4 < length) {
                ...
                if (cCharAt2 >= 128 || j4 >= j5) {
                    if (cCharAt2 >= 2048 || j4 > j5 - 2) {
                        ...
                        if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || j4 > j5 - 3) {
                            ...
                            if (i5 != length) {
                                ...
                                if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                    int codePoint = Character.toCodePoint(cCharAt2, cCharAt3);
                                    j2 = 1;
                                    iq6.K(bArr, j4, (byte) ((codePoint >>> 18) | 240));
                                    j3 = j5;
                                    iq6.K(bArr, j4 + 1, (byte) (((codePoint >>> 12) & 63) | 128));
                                    long j6 = j4 + 3;
                                    iq6.K(bArr, j4 + 2, (byte) (((codePoint >>> 6) & 63) | 128));
                                    j4 += 4;
                                    iq6.K(bArr, j6, (byte) ((codePoint & 63) | 128));
                                    i4 = i5;
                                } else {
                                    i4 = i5;
                                }
                        ...
                        iq6.K(bArr, j4, (byte) ((cCharAt2 >>> '\f') | 480));
                        long j7 = j4 + 2;
                        iq6.K(bArr, j4 + 1, (byte) (((cCharAt2 >>> 6) & 63) | 128));
                        j4 += 3;
                        iq6.K(bArr, j7, (byte) ((cCharAt2 & '?') | 128));
                    } else {
                        str = str3;
                        str2 = str4;
                        long j8 = j4 + j;
                        iq6.K(bArr, j4, (byte) ((cCharAt2 >>> 6) | 960));
                        j4 += 2;
                        iq6.K(bArr, j8, (byte) ((cCharAt2 & '?') | 128));
                    }
                    j3 = j5;
                    j2 = 1;
                } else {
                    iq6.K(bArr, j4, (byte) cCharAt2);
                    j3 = j5;
                    str2 = str4;
                    j2 = j;
                    j4 += j;
        ...
        /* JADX WARN: Code restructure failed: missing block: B:35:0x0058, code lost:
            ...
            if (com.zepto.iq6.u(r12, r0) > (-65)) goto L38;
         */
        /* JADX WARN: Code restructure failed: missing block: B:58:0x009e, code lost:
        
            if (com.zepto.iq6.u(r12, r0) > (-65)) goto L59;
         */
        @Override // com.zepto.zs6.b
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        */
        public int d(int r11, byte[] r12, int r13, int r14) {
            ...
            L10:
                ...
                if (r2 < r11) goto L29
                long r6 = r6 + r0
                byte r11 = com.zepto.iq6.u(r12, r0)
                if (r11 <= r5) goto L26
                goto L29
            L26:
                r0 = r6
            ...
            L2a:
                ...
                if (r0 < 0) goto L43
                int r11 = com.zepto.zs6.a(r2, r11)
                return r11
            L43:
                r0 = r8
            L44:
            ...
            L5e:
                ...
                if (r3 != 0) goto L76
                long r8 = r0 + r6
                byte r3 = com.zepto.iq6.u(r12, r0)
                int r11 = (r8 > r13 ? 1 : (r8 == r13 ? 0 : -1))
                if (r11 < 0) goto L73
                int r11 = com.zepto.zs6.a(r2, r3)
                return r11
            L73:
                r11 = 0
                r0 = r8
            ...
            L79:
                ...
                int r0 = (r8 > r13 ? 1 : (r8 == r13 ? 0 : -1))
                if (r0 < 0) goto L8a
                int r11 = com.zepto.zs6.b(r2, r3, r11)
                return r11
            L8a:
                r0 = r8
            L8b:
            ...
            La8:
                ...
                throw r11
            */
            throw new UnsupportedOperationException("Method not decompiled: com.zepto.zs6.e.d(int, byte[], int, int):int");
        }
    }

    static {
        a = (!e.e() || xo.c()) ? new c() : new e();
    }
