...
public final class q6 {
    ...
    public q6(ScrollView scrollView, MyTextView myTextView, d47 d47Var, AppCompatButton appCompatButton, MyTextView myTextView2, AppCompatButton appCompatButton2, MyTextView myTextView3, AppCompatEditText appCompatEditText) {
        this.a = scrollView;
        this.b = myTextView;
        this.c = d47Var;
                ...
                if (appCompatButton != null) {
                    ...
                    if (myTextView2 != null) {
                        ...
                        if (appCompatButton2 != null) {
                            ...
                            if (myTextView3 != null) {
                                i = R.id.txt_Acknumber;
                                AppCompatEditText appCompatEditText = (AppCompatEditText) zp7.a(view, R.id.txt_Acknumber);
                                if (appCompatEditText != null) {
                                    return new q6((ScrollView) view, myTextView, d47VarA, appCompatButton, myTextView2, appCompatButton2, myTextView3, appCompatEditText);
                                }
                            }
                        }
                    }
    ...
    public static q6 d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_auction_status, viewGroup, false);
        if (z) {
