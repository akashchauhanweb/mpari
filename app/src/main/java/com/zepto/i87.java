...
public final class i87 extends RecyclerView.h {
    ...
    public i87(ArrayList mList, Context mContext, rx3 multiSelected) {
    ...
    public static final void C(ServiceList mModel, i87 this$0, int i, View view) {
        Intrinsics.checkNotNullParameter(mModel, "$mModel");
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        if (mModel.getSelectService()) {
            if (VContant.TRANFER_OF_OWNERSHIP_PURPOSE_CODE.equals(String.valueOf(mModel.getPurposeCode()))) {
                return;
            }
            this$0.f.d0(String.valueOf(mModel.getPurposeCode()), i);
            return;
        }
        if (VContant.TRANFER_OF_OWNERSHIP_PURPOSE_CODE.equals(String.valueOf(mModel.getPurposeCode()))) {
            return;
        }
        if (!VContant.HYPOTHICATION_TERMINATION_PURPOSE_CODE.equals(String.valueOf(mModel.getPurposeCode())) && !VContant.HYPOTHECATION_CONTINUATION_PURPOSE_CODE.equals(String.valueOf(mModel.getPurposeCode()))) {
            this$0.f.U(String.valueOf(mModel.getPurposeCode()), i);
            return;
        }
        if (VContant.HYPOTHICATION_TERMINATION_PURPOSE_CODE.equals(String.valueOf(mModel.getPurposeCode()))) {
            if (((ServiceList) this$0.d.get(i + 1)).getSelectService()) {
                Toast.makeText(this$0.e, "HPT and HPC services are not allowed together", 1).show();
            } else {
                this$0.f.U(String.valueOf(mModel.getPurposeCode()), i);
            }
        }
        if (VContant.HYPOTHECATION_CONTINUATION_PURPOSE_CODE.equals(String.valueOf(mModel.getPurposeCode()))) {
            if (((ServiceList) this$0.d.get(i - 1)).getSelectService()) {
                Toast.makeText(this$0.e, "HPT and HPC services are not allowed together", 1).show();
            } else {
                this$0.f.U(String.valueOf(mModel.getPurposeCode()), i);
    ...
    public void p(a holder, final int i) {
        ...
        final ServiceList serviceList = (ServiceList) obj;
        holder.P().setText(ta3.a.j2(this.e, String.valueOf(serviceList.getPurposeCode()), "SM"));
        if (serviceList.getSelectService()) {
            F(String.valueOf(serviceList.getPurposeCode()), holder);
        } else {
            E(String.valueOf(serviceList.getPurposeCode()), holder);
        }
        holder.Q().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.h87
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                i87.C(serviceList, this, i, view);
            }
        });
    }
