...
public final class j12 implements KeyListener {
    public final KeyListener a;
    public final a b;

    public static class a {
        public boolean a(Editable editable, int i, KeyEvent keyEvent) {
            return androidx.emoji2.text.c.f(editable, i, keyEvent);
        }
    }

    public j12(KeyListener keyListener) {
    ...
    public j12(KeyListener keyListener, a aVar) {
        this.a = keyListener;
        this.b = aVar;
    }
}
