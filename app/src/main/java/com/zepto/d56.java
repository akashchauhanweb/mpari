...
public final class d56 extends SpannableStringBuilder {
        ...
        */
        public void onSpanChanged(android.text.Spannable r9, java.lang.Object r10, int r11, int r12, int r13, int r14) {
            ...
            L20:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.zepto.d56.a.onSpanChanged(android.text.Spannable, java.lang.Object, int, int, int, int):void");
        }
    ...
    public d56(Class cls, CharSequence charSequence) {
        super(charSequence);
        this.e = new ArrayList();
        lu4.h(cls, "watcherClass cannot be null");
        this.c = cls;
    }

    public static d56 c(Class cls, CharSequence charSequence) {
        return new d56(cls, charSequence);
    }
    ...
    public final void e() {
        for (int i = 0; i < this.e.size(); i++) {
            ((a) this.e.get(i)).onTextChanged(this, 0, length(), length());
        }
    }
    ...
    public CharSequence subSequence(int i, int i2) {
        return new d56(this.c, this, i, i2);
    }
    ...
    public d56(Class cls, CharSequence charSequence, int i, int i2) {
