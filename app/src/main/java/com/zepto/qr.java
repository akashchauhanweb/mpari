...
public class qr {
    ...
    public qr(ProgressBar progressBar) {
        this.a = progressBar;
    }
    ...
    public void c(AttributeSet attributeSet, int i) {
        lg6 lg6VarV = lg6.v(this.a.getContext(), attributeSet, c, i, 0);
        Drawable drawableH = lg6VarV.h(0);
        if (drawableH != null) {
            this.a.setIndeterminateDrawable(e(drawableH));
        }
        Drawable drawableH2 = lg6VarV.h(1);
        if (drawableH2 != null) {
    ...
    public Drawable d(Drawable drawable, boolean z) {
        if (drawable instanceof kz7) {
            ...
            Drawable drawableB = kz7Var.b();
            if (drawableB != null) {
                kz7Var.a(d(drawableB, z));
            }
        } else {
