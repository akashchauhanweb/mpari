...
public final class bn2 extends ri2 implements bt3 {
    private static final bn2 DEFAULT_INSTANCE;
    ...
    public static final class b extends ri2.a implements bt3 {
        ...
        public b t(s80 s80Var) {
            l();
            ((bn2) this.e).e0(s80Var);
            return this;
        }

        public b u(gn2 gn2Var) {
            l();
            ((bn2) this.e).f0(gn2Var);
            return this;
        }
        ...
        public b() {
            super(bn2.DEFAULT_INSTANCE);
        }
    }

    static {
        bn2 bn2Var = new bn2();
        DEFAULT_INSTANCE = bn2Var;
        ri2.Q(bn2.class, bn2Var);
    }
    ...
    public static bn2 d0(s80 s80Var, g72 g72Var) {
        return (bn2) ri2.K(DEFAULT_INSTANCE, s80Var, g72Var);
    }
