...
class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
    ...
    public static final Path copyToRecursively(Path path, Path target, Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> onError, final boolean z, boolean z2) {
        ...
        return z2 ? copyToRecursively(path, target, onError, z, new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.2
            ...
            public final CopyActionResult invoke(CopyActionContext copyToRecursively, Path src, Path dst) throws FileSystemException {
    ...
    */
    private static final java.util.List<java.lang.Exception> deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt(java.nio.file.Path r7) {
        /*
        ...
        L14:
            ...
            if (r6 == 0) goto L2f
            r0.setPath(r4)     // Catch: java.lang.Throwable -> L2d
            r2 = r5
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r4, r6)     // Catch: java.lang.Throwable -> L2d
            handleEntry$PathsKt__PathRecursiveFunctionsKt(r2, r4, r0)     // Catch: java.lang.Throwable -> L2d
            goto L30
        L2d:
            r7 = move-exception
            goto L38
        ...
        L41:
            java.util.List r7 = r0.getCollectedExceptions()
            return r7
        */
