...
public final class bq7 extends RecyclerView.h {
    ...
    public bq7(Context context, ArrayList searchList, wa3 langSess) {
    ...
    public static final void D(bq7 this$0, int i, View view) {
    ...
    public void p(a holder, final int i) {
        ...
        holder.Q().setText(this.f.b("label_challan_view_details", this.d.getString(R.string.view_Details)));
        holder.Q().setOnClickListener(new View.OnClickListener() { // from class: com.zepto.aq7
