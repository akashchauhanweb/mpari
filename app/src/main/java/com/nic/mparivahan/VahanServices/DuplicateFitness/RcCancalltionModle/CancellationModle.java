...
public final /* data */ class CancellationModle {
    ...
    public CancellationModle(String str, int i, int i2, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, String str18) {
        this.applNo = str;
        this.offCd = i;
        this.purCd = i2;
        this.regnNo = str2;
    ...
    public final CancellationModle copy(String applNo, int offCd, int purCd, String regnNo, String stateCd, String surrDt, String fileRefNo, String approvedBy, String reasonval, String rcval, String rcSnoval, String permitval, String permitSnoval, String fcval, String fcSnoval, String taxexemval, String releaseDt, String relFileRefNo, String relApprovedBy, String cancelDt) {
        return new CancellationModle(applNo, offCd, purCd, regnNo, stateCd, surrDt, fileRefNo, approvedBy, reasonval, rcval, rcSnoval, permitval, permitSnoval, fcval, fcSnoval, taxexemval, releaseDt, relFileRefNo, relApprovedBy, cancelDt);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof CancellationModle)) {
            return false;
        }
        CancellationModle cancellationModle = (CancellationModle) other;
        return Intrinsics.areEqual(this.applNo, cancellationModle.applNo) && this.offCd == cancellationModle.offCd && this.purCd == cancellationModle.purCd && Intrinsics.areEqual(this.regnNo, cancellationModle.regnNo) && Intrinsics.areEqual(this.stateCd, cancellationModle.stateCd) && Intrinsics.areEqual(this.surrDt, cancellationModle.surrDt) && Intrinsics.areEqual(this.fileRefNo, cancellationModle.fileRefNo) && Intrinsics.areEqual(this.approvedBy, cancellationModle.approvedBy) && Intrinsics.areEqual(this.reasonval, cancellationModle.reasonval) && Intrinsics.areEqual(this.rcval, cancellationModle.rcval) && Intrinsics.areEqual(this.rcSnoval, cancellationModle.rcSnoval) && Intrinsics.areEqual(this.permitval, cancellationModle.permitval) && Intrinsics.areEqual(this.permitSnoval, cancellationModle.permitSnoval) && Intrinsics.areEqual(this.fcval, cancellationModle.fcval) && Intrinsics.areEqual(this.fcSnoval, cancellationModle.fcSnoval) && Intrinsics.areEqual(this.taxexemval, cancellationModle.taxexemval) && Intrinsics.areEqual(this.releaseDt, cancellationModle.releaseDt) && Intrinsics.areEqual(this.relFileRefNo, cancellationModle.relFileRefNo) && Intrinsics.areEqual(this.relApprovedBy, cancellationModle.relApprovedBy) && Intrinsics.areEqual(this.cancelDt, cancellationModle.cancelDt);
    }
