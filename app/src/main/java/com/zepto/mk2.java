...
public final class mk2 extends ArrayAdapter {
    public final List a;
    ...
    public mk2(Context context, List monthlyDates, Calendar currentDate, List allSlots) {
    ...
    public View getView(int i, View view, ViewGroup parent) {
        ...
        for (int i7 = 0; i7 < size; i7++) {
            calendar2.setTime(((b46) this.c.get(i7)).b());
            Log.d("tag-g1", "convert-t: " + calendar2.getTime() + " slots-t: " + ((b46) this.c.get(i7)).b());
            Log.d("tag-g2", "convert-t: " + i2 + " slots-t: " + i3);
            if (i2 == calendar2.get(5) && i3 == calendar2.get(2) + 1) {
                textView.setTextColor(getContext().getResources().getColor(R.color.white));
                textView.setBackground(((b46) this.c.get(i7)).a());
            }
        }
        return view;
    }
