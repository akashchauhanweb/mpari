...
abstract class HttpServiceMethod<ResponseT, ReturnT> extends ServiceMethod<ReturnT> {
    ...
    private final Converter<nd5, ResponseT> responseConverter;

    public static final class CallAdapted<ResponseT, ReturnT> extends HttpServiceMethod<ResponseT, ReturnT> {
        private final CallAdapter<ResponseT, ReturnT> callAdapter;

        public CallAdapted(RequestFactory requestFactory, da0.a aVar, Converter<nd5, ResponseT> converter, CallAdapter<ResponseT, ReturnT> callAdapter) {
    ...
    public static final class SuspendForBody<ResponseT> extends HttpServiceMethod<ResponseT, Object> {
        ...
        public SuspendForBody(RequestFactory requestFactory, da0.a aVar, Converter<nd5, ResponseT> converter, CallAdapter<ResponseT, Call<ResponseT>> callAdapter, boolean z) {
            super(requestFactory, aVar, converter);
            this.callAdapter = callAdapter;
            this.isNullable = z;
        }
    ...
    public static final class SuspendForResponse<ResponseT> extends HttpServiceMethod<ResponseT, Object> {
        ...
        public SuspendForResponse(RequestFactory requestFactory, da0.a aVar, Converter<nd5, ResponseT> converter, CallAdapter<ResponseT, Call<ResponseT>> callAdapter) {
            super(requestFactory, aVar, converter);
            this.callAdapter = callAdapter;
        }
    ...
    public HttpServiceMethod(RequestFactory requestFactory, da0.a aVar, Converter<nd5, ResponseT> converter) {
    ...
    private static <ResponseT> Converter<nd5, ResponseT> createResponseConverter(Retrofit retrofit, Method method, Type type) {
        try {
    ...
    public static <ResponseT, ReturnT> HttpServiceMethod<ResponseT, ReturnT> parseAnnotations(Retrofit retrofit, Method method, RequestFactory requestFactory) {
        ...
        da0.a aVar = retrofit.callFactory;
