...
public class TextInputEditText extends AppCompatEditText {
    ...
    public TextInputEditText(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, xy4.n);
    }
    ...
    public void onAttachedToWindow() {
        ...
        TextInputLayout textInputLayout = getTextInputLayout();
        if (textInputLayout != null && textInputLayout.R() && super.getHint() == null && ip3.b()) {
            setHint("");
        }
    }
    ...
    public TextInputEditText(Context context, AttributeSet attributeSet, int i) {
        ...
        this.g = new Rect();
        TypedArray typedArrayI = if6.i(context, attributeSet, m15.E6, i, g15.j, new int[0]);
        setTextInputLayoutFocusedRectEnabled(typedArrayI.getBoolean(m15.F6, false));
        typedArrayI.recycle();
    }
}
