...
public final class sq5 {
                                                ...
                                                if (appCompatTextView5 != null) {
                                                    ...
                                                    if (viewA != null) {
                                                        ...
                                                        if (appCompatTextView6 != null) {
                                                            return new sq5((RelativeLayout) view, appCompatTextView, recyclerView, appCompatTextView2, nestedScrollView, appCompatTextView3, appCompatEditText, appCompatTextView4, progressBar, myTextView, linearLayout, appCompatTextView5, d47VarA, appCompatTextView6);
                                                        }
                                                    }
                                                }
                                            }
    ...
    public static sq5 c(LayoutInflater layoutInflater) {
        return d(layoutInflater, null, false);
    }

    public static sq5 d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.search_challan_status_layout, viewGroup, false);
        if (z) {
