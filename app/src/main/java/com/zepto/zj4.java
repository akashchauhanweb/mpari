...
public final class zj4 extends BaseAdapter {
    public Context a;
    public ArrayList b;

    public zj4(Context context, ArrayList owner) {
    ...
    public View getView(int i, View view, ViewGroup parent) {
        ...
        textView.setText(((OwnerShipType) this.b.get(i)).getCodeDescription().toString());
        return view;
    }
}
